...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DENNODES Core dennodes-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dennodes-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dennodes transaction") + "\n" +
                               "  dennodes-tx [options] -create [commands]   " + _("Create hex-encoded dennodes transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dennodes transaction
