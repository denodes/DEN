...
pkgdatadir = $(datadir)/dennodes
pkgincludedir = $(includedir)/dennodes
pkglibdir = $(libdir)/dennodes
pkglibexecdir = $(libexecdir)/dennodes
...
noinst_PROGRAMS =
TESTS = $(am__EXEEXT_5)
am__append_1 = dennodesd
am__append_2 = dennodes-cli dennodes-tx
am__append_3 = libzerocoin/bignum_gmp.cpp
#am__append_4 = libzerocoin/bignum_openssl.cpp
#am__append_5 = compat/glibc_compat.cpp
#am__append_6 = $(COMPAT_LDFLAGS)
#am__append_7 = dennodesd-res.rc
#am__append_8 = dennodes-cli-res.rc
#am__append_9 = dennodes-tx-res.rc
##am__append_10 = compat/glibc_compat.cpp
am__append_11 = $(LIBLEVELDB_INT) \
	$(LIBMEMENV_INT) \
	$(LIBLEVELDB_SSE42_INT)
am__append_12 = $(LIBLEVELDB_INT)
am__append_13 = $(LIBMEMENV_INT)
am__append_14 = -I$(srcdir)/leveldb/include \
	-I$(srcdir)/leveldb/helpers/memenv
#am__append_15 = -DLEVELDB_PLATFORM_WINDOWS -DWINVER=0x0500 -D__USE_MINGW_ANSI_STDIO=1
am__append_16 = -DLEVELDB_PLATFORM_POSIX
#am__append_17 = leveldb/util/env_win.cc \
#	leveldb/port/port_win.cc
am__append_18 = leveldb/port/port_posix.cc
am__append_19 = -DLEVELDB_PLATFORM_POSIX_SSE
am__append_20 = $(SSE42_CXXFLAGS)
#am__append_21 = test/test_dennodes
#am__append_22 = \
#  test/accounting_tests.cpp \
#  wallet/test/wallet_tests.cpp \
#  test/rpc_wallet_tests.cpp

#am__append_23 = $(LIBBITCOIN_WALLET)
#am__append_24 = $(ZMQ_LIBS)
#am__append_25 = $(CLEAN_BITCOIN_TEST)
am__append_26 = qt/dennodes-qt
am__append_27 = qt/libbitcoinqt.a
#am__append_28 = $(BITCOIN_QT_WINDOWS_CPP)
am__append_29 = $(BITCOIN_QT_WALLET_CPP)
#am__append_30 = $(BITCOIN_MM)
#am__append_31 = $(BITCOIN_RC)
am__append_32 = $(LIBBITCOIN_UTIL) $(LIBBITCOIN_WALLET)
am__append_33 = $(LIBBITCOIN_ZMQ) $(ZMQ_LIBS)
am__append_34 = $(CLEAN_QT)

# Copyright (c) 2013-2016 The Bitcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
#am__append_35 = qt/test/test_dennodes-qt
#am__append_36 = qt/test/test_dennodes-qt
#am__append_37 = qt/test/moc_paymentservertests.cpp
#am__append_38 = \
#  qt/test/paymentservertests.cpp

#am__append_39 = $(LIBBITCOIN_UTIL) $(LIBBITCOIN_WALLET)
#am__append_40 = $(LIBBITCOIN_ZMQ) $(ZMQ_LIBS)
#am__append_41 = $(CLEAN_BITCOIN_QT_TEST)
subdir = src
SUBDIRS =
...
CONFIG_HEADER = $(top_builddir)/src/config/dennodes-config.h
CONFIG_CLEAN_FILES =
...
#am__objects_1 = leveldb/util/leveldb_libleveldb_a-env_win.$(OBJEXT) \
#	leveldb/port/leveldb_libleveldb_a-port_win.$(OBJEXT)
am__objects_2 = leveldb/port/leveldb_libleveldb_a-port_posix.$(OBJEXT)
...
am_libbitcoin_common_a_OBJECTS =  \
	zden/libbitcoin_common_a-accumulators.$(OBJEXT) \
	zden/libbitcoin_common_a-accumulatorcheckpoints.$(OBJEXT) \
	zden/libbitcoin_common_a-accumulatormap.$(OBJEXT) \
	...
	libbitcoin_common_a-sporkdb.$(OBJEXT) $(am__objects_3)
...
am_libbitcoin_server_a_OBJECTS =  \
	...
	libbitcoin_server_a-blocksignature.$(OBJEXT) \
	...
	rpc/libbitcoin_server_a-masternode.$(OBJEXT) \
	rpc/libbitcoin_server_a-budget.$(OBJEXT) \
...
am__libbitcoin_util_a_SOURCES_DIST = allocators.cpp \
	...
	activemasternode.h addrman.h alert.h allocators.h amount.h \
	base58.h bip38.h bloom.h blocksignature.h chain.h \
	...
	primitives/transaction.h core_io.h crypter.h \
	denomination_functions.h obfuscation.h obfuscation-relay.h \
	wallet/db.h hash.h httprpc.h httpserver.h init.h invalid.h \
	invalid_outpoints.json.h invalid_serials.json.h kernel.h \
	...
	protocol.h pubkey.h random.h reverselock.h reverse_iterate.h \
	rpc/client.h rpc/protocol.h rpc/server.h scheduler.h \
	script/interpreter.h script/script.h script/sigcache.h \
	script/sign.h script/standard.h script/script_error.h \
	serialize.h spork.h sporkdb.h stakeinput.h streams.h \
	support/cleanse.h sync.h threadsafety.h timedata.h \
	tinyformat.h torcontrol.h txdb.h txmempool.h guiinterface.h \
	uint256.h undo.h util.h utilstrencodings.h utilmoneystr.h \
	utiltime.h validationinterface.h version.h wallet/wallet.h \
	wallet/wallet_ismine.h wallet/walletdb.h zdenchain.h \
	zden/accumulators.h zden/accumulatorcheckpoints.h \
	zden/accumulatorcheckpoints.json.h zden/accumulatormap.h \
	zden/deterministicmint.h zden/mintpool.h zden/witness.h \
	zden/zerocoin.h zden/zdentracker.h zden/zdenwallet.h \
	zden/zdenmodule.h genwit.h concurrentqueue.h lightzdenthread.h \
...
am_libbitcoin_util_a_OBJECTS = libbitcoin_util_a-allocators.$(OBJEXT) \
	...
	libbitcoin_util_a-utiltime.$(OBJEXT) $(am__objects_3) \
	$(am__objects_4)
...
am_libbitcoin_wallet_a_OBJECTS =  \
	...
	zden/libbitcoin_wallet_a-deterministicmint.$(OBJEXT) \
	zden/libbitcoin_wallet_a-zerocoin.$(OBJEXT) \
	zden/libbitcoin_wallet_a-accumulators.$(OBJEXT) \
	zden/libbitcoin_wallet_a-mintpool.$(OBJEXT) \
	zden/libbitcoin_wallet_a-witness.$(OBJEXT) \
	zden/libbitcoin_wallet_a-zdenwallet.$(OBJEXT) \
	zden/libbitcoin_wallet_a-zdentracker.$(OBJEXT) \
	libbitcoin_wallet_a-stakeinput.$(OBJEXT) \
	libbitcoin_wallet_a-genwit.$(OBJEXT) \
	zden/libbitcoin_wallet_a-zdenmodule.$(OBJEXT) \
	libbitcoin_wallet_a-lightzdenthread.$(OBJEXT) $(am__objects_3)
...
am__libzerocoin_libbitcoin_zerocoin_a_SOURCES_DIST =  \
	libzerocoin/Accumulator.h \
	libzerocoin/AccumulatorProofOfKnowledge.h libzerocoin/bignum.h \
	libzerocoin/Coin.h libzerocoin/CoinSpend.h \
	libzerocoin/Commitment.h libzerocoin/Denominations.h \
	libzerocoin/ParamGeneration.h libzerocoin/Params.h \
	libzerocoin/SerialNumberSignatureOfKnowledge.h \
	libzerocoin/SpendType.h libzerocoin/ZerocoinDefines.h \
	libzerocoin/bignum.cpp libzerocoin/Accumulator.cpp \
	libzerocoin/AccumulatorProofOfKnowledge.cpp \
	libzerocoin/Coin.cpp libzerocoin/Denominations.cpp \
	libzerocoin/CoinSpend.cpp libzerocoin/Commitment.cpp \
	libzerocoin/ParamGeneration.cpp libzerocoin/Params.cpp \
	libzerocoin/SerialNumberSignatureOfKnowledge.cpp \
	libzerocoin/bignum_gmp.cpp libzerocoin/bignum_openssl.cpp
am__objects_5 = libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.$(OBJEXT)
#am__objects_6 = libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.$(OBJEXT)
am_libzerocoin_libbitcoin_zerocoin_a_OBJECTS = libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.$(OBJEXT) \
	libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.$(OBJEXT) \
	libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.$(OBJEXT) \
	libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.$(OBJEXT) \
	libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.$(OBJEXT) \
	libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.$(OBJEXT) \
	libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.$(OBJEXT) \
	libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.$(OBJEXT) \
	libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.$(OBJEXT) \
	libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.$(OBJEXT) \
...
am__qt_libbitcoinqt_a_SOURCES_DIST = qt/bantablemodel.cpp \
	...
	qt/bitcoingui.cpp qt/bitcoinunits.cpp qt/blockexplorer.cpp \
	qt/clientmodel.cpp qt/csvmodelwriter.cpp qt/guiutil.cpp \
	qt/intro.cpp qt/masternodelist.cpp qt/networkstyle.cpp \
	qt/notificator.cpp qt/optionsdialog.cpp qt/optionsmodel.cpp \
	qt/peertablemodel.cpp qt/platformstyle.cpp \
	...
	qt/governancepage.cpp qt/multisenddialog.cpp \
	...
	qt/proposalframe.cpp qt/receiverequestdialog.cpp \
	...
	qt/zdencontroldialog.cpp qt/addressbookpage.h \
	qt/addresstablemodel.h qt/askpassphrasedialog.h \
	qt/bantablemodel.h qt/bip38tooldialog.h \
	qt/bitcoinaddressvalidator.h qt/bitcoinamountfield.h \
	qt/bitcoingui.h qt/bitcoinunits.h qt/blockexplorer.h \
	qt/clientmodel.h qt/coincontroldialog.h \
	qt/coincontroltreewidget.h qt/csvmodelwriter.h \
	qt/editaddressdialog.h qt/governancepage.h qt/guiconstants.h \
	qt/guiutil.h qt/intro.h qt/macdockiconhandler.h \
	qt/macnotificationhandler.h qt/masternodelist.h \
	qt/multisenddialog.h qt/multisigdialog.h qt/networkstyle.h \
	qt/notificator.h qt/openuridialog.h qt/optionsdialog.h \
	qt/optionsmodel.h qt/overviewpage.h qt/paymentrequestplus.h \
	qt/paymentserver.h qt/peertablemodel.h qt/platformstyle.h \
	qt/proposalframe.h qt/qvalidatedlineedit.h qt/qvaluecombobox.h \
	...
	qt/winshutdownmonitor.h qt/zdencontroldialog.h \
	qt/forms/addressbookpage.ui qt/forms/askpassphrasedialog.ui \
	qt/forms/bip38tooldialog.ui qt/forms/coincontroldialog.ui \
	qt/forms/blockexplorer.ui qt/forms/editaddressdialog.ui \
	qt/forms/governancepage.ui qt/forms/helpmessagedialog.ui \
	...
	qt/forms/zdencontroldialog.ui qt/dennodes.qrc \
	qt/dennodes_locale.qrc qt/locale/dennodes_bg.ts \
	qt/locale/dennodes_ca.ts qt/locale/dennodes_cs.ts \
	qt/locale/dennodes_da.ts qt/locale/dennodes_de.ts \
	qt/locale/dennodes_en.ts qt/locale/dennodes_en_GB.ts \
	qt/locale/dennodes_en_US.ts qt/locale/dennodes_eo.ts \
	qt/locale/dennodes_es.ts qt/locale/dennodes_es_ES.ts \
	qt/locale/dennodes_fi.ts qt/locale/dennodes_fr_FR.ts \
	qt/locale/dennodes_hi_IN.ts qt/locale/dennodes_hr.ts \
	qt/locale/dennodes_hr_HR.ts qt/locale/dennodes_it.ts \
	qt/locale/dennodes_ja.ts qt/locale/dennodes_ko_KR.ts \
	qt/locale/dennodes_lt_LT.ts qt/locale/dennodes_nl.ts \
	qt/locale/dennodes_pl.ts qt/locale/dennodes_pt.ts \
	qt/locale/dennodes_pt_BR.ts qt/locale/dennodes_ro_RO.ts \
	qt/locale/dennodes_ru.ts qt/locale/dennodes_sk.ts \
	qt/locale/dennodes_sv.ts qt/locale/dennodes_tr.ts \
	qt/locale/dennodes_uk.ts qt/locale/dennodes_vi.ts \
	qt/locale/dennodes_zh_CN.ts qt/locale/dennodes_zh_TW.ts \
	...
	qt/res/icons/bitcoin_regtest.png qt/res/icons/browse.png \
	...
	qt/res/icons/onion.png qt/res/icons/overview.png \
	qt/res/icons/qrcode.png qt/res/icons/quit.png \
	qt/res/icons/receive.png qt/res/icons/receive_dark.png \
	qt/res/icons/privacy.png qt/res/icons/remove.png \
	qt/res/icons/send.png qt/res/icons/send_dark.png \
	qt/res/icons/governance.png qt/res/icons/governance_dark.png \
	...
	qt/res/icons/unit_dennodes.png qt/res/icons/unit_mdennodes.png \
	qt/res/icons/unit_udennodes.png \
	qt/res/icons/unit_tdennodes.png \
	qt/res/icons/unit_tmdennodes.png \
	qt/res/icons/unit_tudennodes.png qt/res/icons/yesvote.png \
	qt/res/icons/novote.png qt/res/icons/abstainvote.png \
	qt/res/images/about.png qt/res/images/splash.png \
	qt/res/images/splash_testnet.png \
	qt/res/images/splash_regtest.png \
	qt/res/images/dennodes_logo_horizontal.png \
	...
	qt/res/images/qtreeview_selected.png qt/res/css/default.css \
	$(wildcard $(srcdir)/qt/res/movies/spinner-*.png)
am__objects_7 =  \
...
am__objects_8 = qt/qt_libbitcoinqt_a-winshutdownmonitor.$(OBJEXT)
#am__objects_9 = $(am__objects_8)
am__objects_10 = qt/qt_libbitcoinqt_a-addressbookpage.$(OBJEXT) \
	...
	qt/qt_libbitcoinqt_a-governancepage.$(OBJEXT) \
	qt/qt_libbitcoinqt_a-masternodelist.$(OBJEXT) \
	...
	qt/qt_libbitcoinqt_a-proposalframe.$(OBJEXT) \
	...
	qt/qt_libbitcoinqt_a-zdencontroldialog.$(OBJEXT)
am__objects_11 =  \
	$(am__objects_10)
am__objects_12 = $(am__objects_7) $(am__objects_9) \
	$(am__objects_11)
am_qt_libbitcoinqt_a_OBJECTS = $(am__objects_12) \
	$(am__objects_3) $(am__objects_3) \
	$(am__objects_3) $(am__objects_3) \
	$(am__objects_3) $(am__objects_3) \
	$(am__objects_3) $(am__objects_3) \
	$(am__objects_3) $(am__objects_3)
am__objects_13 = qt/qt_libbitcoinqt_a-moc_addressbookpage.$(OBJEXT) \
	...
	qt/qt_libbitcoinqt_a-moc_governancepage.$(OBJEXT) \
	...
	qt/qt_libbitcoinqt_a-moc_proposalframe.$(OBJEXT) \
	...
	qt/qt_libbitcoinqt_a-moc_zdencontroldialog.$(OBJEXT)
am__objects_14 = qt/qt_libbitcoinqt_a-paymentrequest.pb.$(OBJEXT)
am__objects_15 =  \
	qt/qt_libbitcoinqt_a-qrc_dennodes.$(OBJEXT)
am__objects_16 = qt/qt_libbitcoinqt_a-qrc_dennodes_locale.$(OBJEXT)
nodist_qt_libbitcoinqt_a_OBJECTS = $(am__objects_13) \
	$(am__objects_3) $(am__objects_14) \
	$(am__objects_3) $(am__objects_15) \
	$(am__objects_16)
...
am__libbitcoinconsensus_la_SOURCES_DIST = allocators.cpp \
	...
	crypto/sha512.cpp crypto/ripemd160.cpp hash.cpp pubkey.cpp \
	script/script.cpp script/interpreter.cpp \
	script/bitcoinconsensus.cpp uint256.cpp utilstrencodings.cpp \
	compat/glibc_compat.cpp
##am__objects_17 = compat/libbitcoinconsensus_la-glibc_compat.lo
...
#	$(libdir)
am__EXEEXT_1 = dennodesd$(EXEEXT)
am__EXEEXT_2 = dennodes-cli$(EXEEXT) \
	dennodes-tx$(EXEEXT)
#am__EXEEXT_3 = test/test_dennodes$(EXEEXT)
am__EXEEXT_4 = qt/dennodes-qt$(EXEEXT)
#am__EXEEXT_5 =  \
#	qt/test/test_dennodes-qt$(EXEEXT)
PROGRAMS = $(bin_PROGRAMS) $(noinst_PROGRAMS)
am__dennodes_cli_SOURCES_DIST = dennodes-cli.cpp dennodes-cli-res.rc
#am__objects_18 = dennodes-cli-res.$(OBJEXT)
am_dennodes_cli_OBJECTS = dennodes_cli-dennodes-cli.$(OBJEXT) \
	$(am__objects_18)
dennodes_cli_OBJECTS = $(am_dennodes_cli_OBJECTS)
am__DEPENDENCIES_1 =
#am__DEPENDENCIES_2 = $(am__DEPENDENCIES_1)
am__DEPENDENCIES_2 = univalue/libunivalue.la
dennodes_cli_DEPENDENCIES = $(LIBBITCOIN_CLI) $(am__DEPENDENCIES_2) \
	$(LIBBITCOIN_UTIL) $(LIBBITCOIN_CRYPTO) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1)
dennodes_cli_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CXXLD) $(dennodes_cli_CXXFLAGS) \
	$(CXXFLAGS) $(dennodes_cli_LDFLAGS) $(LDFLAGS) -o $@
am__dennodes_tx_SOURCES_DIST = dennodes-tx.cpp dennodes-tx-res.rc
#am__objects_19 = dennodes-tx-res.$(OBJEXT)
am_dennodes_tx_OBJECTS = dennodes_tx-dennodes-tx.$(OBJEXT) \
	$(am__objects_19)
dennodes_tx_OBJECTS = $(am_dennodes_tx_OBJECTS)
dennodes_tx_DEPENDENCIES = $(am__DEPENDENCIES_2) $(LIBBITCOIN_COMMON) \
	$(LIBBITCOIN_ZEROCOIN) $(LIBBITCOIN_UTIL) $(LIBBITCOIN_CRYPTO) \
	$(LIBSECP256K1) $(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1)
dennodes_tx_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CXXLD) $(dennodes_tx_CXXFLAGS) \
	$(CXXFLAGS) $(dennodes_tx_LDFLAGS) $(LDFLAGS) -o $@
am__dennodesd_SOURCES_DIST = dennodesd.cpp dennodesd-res.rc
#am__objects_20 = dennodesd-res.$(OBJEXT)
am_dennodesd_OBJECTS = dennodesd-dennodesd.$(OBJEXT) $(am__objects_20)
dennodesd_OBJECTS = $(am_dennodesd_OBJECTS)
am__DEPENDENCIES_3 = $(am__append_12)
am__DEPENDENCIES_4 = $(am__append_13)
dennodesd_DEPENDENCIES = $(LIBBITCOIN_SERVER) $(LIBBITCOIN_WALLET) \
	$(LIBBITCOIN_COMMON) $(am__DEPENDENCIES_2) \
	$(LIBBITCOIN_ZEROCOIN) $(LIBBITCOIN_UTIL) $(LIBBITCOIN_ZMQ) \
	$(LIBBITCOIN_CRYPTO) $(am__DEPENDENCIES_3) $(LIBLEVELDB_SSE42) \
	$(am__DEPENDENCIES_4) $(LIBSECP256K1) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1)
dennodesd_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CXXLD) $(dennodesd_CXXFLAGS) \
	$(CXXFLAGS) $(dennodesd_LDFLAGS) $(LDFLAGS) -o $@
am__qt_dennodes_qt_SOURCES_DIST = qt/dennodes.cpp \
	qt/macdockiconhandler.mm qt/macnotificationhandler.mm \
	qt/res/dennodes-qt-res.rc
am__objects_21 = qt/qt_dennodes_qt-macdockiconhandler.$(OBJEXT) \
	qt/qt_dennodes_qt-macnotificationhandler.$(OBJEXT)
#am__objects_22 =  \
#	$(am__objects_21)
am__objects_23 = qt/res/dennodes-qt-res.$(OBJEXT)
#am__objects_24 =  \
#	$(am__objects_23)
am_qt_dennodes_qt_OBJECTS =  \
	qt/qt_dennodes_qt-dennodes.$(OBJEXT) \
	$(am__objects_22) $(am__objects_24)
qt_dennodes_qt_OBJECTS = $(am_qt_dennodes_qt_OBJECTS)
am__DEPENDENCIES_5 =  \
	$(LIBBITCOIN_ZMQ) \
	$(am__DEPENDENCIES_1)
qt_dennodes_qt_DEPENDENCIES = qt/libbitcoinqt.a \
	$(LIBBITCOIN_SERVER) $(am__append_32) \
	$(am__DEPENDENCIES_5) $(LIBBITCOIN_CLI) \
	$(LIBBITCOIN_COMMON) $(LIBBITCOIN_UTIL) \
	$(LIBBITCOIN_CRYPTO) $(am__DEPENDENCIES_2) \
	$(LIBBITCOIN_ZEROCOIN) $(am__DEPENDENCIES_3) \
	$(LIBLEVELDB_SSE42) $(am__DEPENDENCIES_4) \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
	...
	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1)
qt_dennodes_qt_LINK = $(LIBTOOL) $(AM_V_lt) \
	$(qt_dennodes_qt_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link \
	$(OBJCXXLD) $(AM_OBJCXXFLAGS) $(OBJCXXFLAGS) \
	$(qt_dennodes_qt_LDFLAGS) $(LDFLAGS) -o $@
am__qt_test_test_dennodes_qt_SOURCES_DIST = qt/test/test_main.cpp \
	qt/test/uritests.cpp qt/test/uritests.h \
	qt/test/paymentrequestdata.h qt/test/paymentservertests.h \
	qt/test/paymentservertests.cpp
#am__objects_25 = qt/test/qt_test_test_dennodes_qt-paymentservertests.$(OBJEXT)
#am_qt_test_test_dennodes_qt_OBJECTS = qt/test/qt_test_test_dennodes_qt-test_main.$(OBJEXT) \
#	qt/test/qt_test_test_dennodes_qt-uritests.$(OBJEXT) \
#	$(am__objects_3) $(am__objects_25)
#am__objects_26 = qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.$(OBJEXT)
#am__objects_27 = qt/test/qt_test_test_dennodes_qt-moc_uritests.$(OBJEXT) \
#	$(am__objects_26)
#nodist_qt_test_test_dennodes_qt_OBJECTS =  \
#	$(am__objects_27)
qt_test_test_dennodes_qt_OBJECTS =  \
	$(am_qt_test_test_dennodes_qt_OBJECTS) \
	$(nodist_qt_test_test_dennodes_qt_OBJECTS)
#am__DEPENDENCIES_6 =  \
#	$(LIBBITCOIN_ZMQ) \
#	$(am__DEPENDENCIES_1)
#qt_test_test_dennodes_qt_DEPENDENCIES =  \
#	$(LIBBITCOINQT) $(LIBBITCOIN_SERVER) \
#	$(am__append_39) $(am__DEPENDENCIES_6) \
...
#	$(am__DEPENDENCIES_1) \
#	$(am__DEPENDENCIES_1)
qt_test_test_dennodes_qt_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CXX \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CXXLD) \
	$(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) \
	$(qt_test_test_dennodes_qt_LDFLAGS) $(LDFLAGS) -o $@
am__test_test_dennodes_SOURCES_DIST = test/test_dennodes.h \
	test/test_dennodes.cpp test/zerocoin_implementation_tests.cpp \
	test/zerocoin_denomination_tests.cpp \
	test/zerocoin_transactions_tests.cpp \
	test/zerocoin_coinspend_tests.cpp \
	test/zerocoin_bignum_tests.cpp test/benchmark_zerocoin.cpp \
	test/tutorial_zerocoin.cpp test/libzerocoin_tests.cpp \
	test/addrman_tests.cpp test/allocator_tests.cpp \
	test/base32_tests.cpp test/base58_tests.cpp \
	test/base64_tests.cpp test/budget_tests.cpp \
	...
	test/mempool_tests.cpp test/mruset_tests.cpp \
	test/multisig_tests.cpp test/netbase_tests.cpp \
	test/pmt_tests.cpp test/reverselock_tests.cpp \
	...
	test/accounting_tests.cpp wallet/test/wallet_tests.cpp \
	test/rpc_wallet_tests.cpp test/data/script_valid.json \
...
#am__objects_28 = test/test_test_dennodes-test_dennodes.$(OBJEXT)
#am__objects_29 = test/test_test_dennodes-accounting_tests.$(OBJEXT) \
#	wallet/test/test_test_dennodes-wallet_tests.$(OBJEXT) \
#	test/test_test_dennodes-rpc_wallet_tests.$(OBJEXT)
#am__objects_30 = test/test_test_dennodes-zerocoin_implementation_tests.$(OBJEXT) \
#	test/test_test_dennodes-zerocoin_denomination_tests.$(OBJEXT) \
#	test/test_test_dennodes-zerocoin_transactions_tests.$(OBJEXT) \
#	test/test_test_dennodes-zerocoin_coinspend_tests.$(OBJEXT) \
#	test/test_test_dennodes-zerocoin_bignum_tests.$(OBJEXT) \
#	test/test_test_dennodes-benchmark_zerocoin.$(OBJEXT) \
#	test/test_test_dennodes-tutorial_zerocoin.$(OBJEXT) \
#	test/test_test_dennodes-libzerocoin_tests.$(OBJEXT) \
#	test/test_test_dennodes-addrman_tests.$(OBJEXT) \
#	test/test_test_dennodes-allocator_tests.$(OBJEXT) \
#	test/test_test_dennodes-base32_tests.$(OBJEXT) \
#	test/test_test_dennodes-base58_tests.$(OBJEXT) \
#	test/test_test_dennodes-base64_tests.$(OBJEXT) \
#	test/test_test_dennodes-budget_tests.$(OBJEXT) \
#	test/test_test_dennodes-checkblock_tests.$(OBJEXT) \
#	test/test_test_dennodes-Checkpoints_tests.$(OBJEXT) \
#	test/test_test_dennodes-coins_tests.$(OBJEXT) \
#	test/test_test_dennodes-compress_tests.$(OBJEXT) \
#	test/test_test_dennodes-crypto_tests.$(OBJEXT) \
#	test/test_test_dennodes-DoS_tests.$(OBJEXT) \
#	test/test_test_dennodes-getarg_tests.$(OBJEXT) \
#	test/test_test_dennodes-hash_tests.$(OBJEXT) \
#	test/test_test_dennodes-key_tests.$(OBJEXT) \
#	test/test_test_dennodes-main_tests.$(OBJEXT) \
#	test/test_test_dennodes-mempool_tests.$(OBJEXT) \
#	test/test_test_dennodes-mruset_tests.$(OBJEXT) \
#	test/test_test_dennodes-multisig_tests.$(OBJEXT) \
#	test/test_test_dennodes-netbase_tests.$(OBJEXT) \
#	test/test_test_dennodes-pmt_tests.$(OBJEXT) \
#	test/test_test_dennodes-reverselock_tests.$(OBJEXT) \
#	test/test_test_dennodes-rpc_tests.$(OBJEXT) \
#	test/test_test_dennodes-sanity_tests.$(OBJEXT) \
#	test/test_test_dennodes-scheduler_tests.$(OBJEXT) \
#	test/test_test_dennodes-script_P2SH_tests.$(OBJEXT) \
#	test/test_test_dennodes-script_tests.$(OBJEXT) \
#	test/test_test_dennodes-scriptnum_tests.$(OBJEXT) \
#	test/test_test_dennodes-serialize_tests.$(OBJEXT) \
#	test/test_test_dennodes-sighash_tests.$(OBJEXT) \
#	test/test_test_dennodes-sigopcount_tests.$(OBJEXT) \
#	test/test_test_dennodes-skiplist_tests.$(OBJEXT) \
#	test/test_test_dennodes-timedata_tests.$(OBJEXT) \
#	test/test_test_dennodes-torcontrol_tests.$(OBJEXT) \
#	test/test_test_dennodes-transaction_tests.$(OBJEXT) \
#	test/test_test_dennodes-uint256_tests.$(OBJEXT) \
#	test/test_test_dennodes-univalue_tests.$(OBJEXT) \
#	test/test_test_dennodes-util_tests.$(OBJEXT) \
#	$(am__objects_29)
#am_test_test_dennodes_OBJECTS = $(am__objects_28) \
#	$(am__objects_30) $(am__objects_3) \
#	$(am__objects_3)
#am__objects_31 = $(am__objects_3) $(am__objects_3)
#nodist_test_test_dennodes_OBJECTS =  \
#	$(am__objects_31)
test_test_dennodes_OBJECTS = $(am_test_test_dennodes_OBJECTS) \
	$(nodist_test_test_dennodes_OBJECTS)
#am__DEPENDENCIES_7 =  \
#	$(am__DEPENDENCIES_1)
#test_test_dennodes_DEPENDENCIES =  \
#	$(LIBBITCOIN_SERVER) $(LIBBITCOIN_CLI) \
#	$(LIBBITCOIN_COMMON) $(LIBBITCOIN_UTIL) \
#	$(LIBBITCOIN_CRYPTO) $(am__DEPENDENCIES_2) \
#	$(LIBBITCOIN_ZEROCOIN) \
#	$(am__DEPENDENCIES_3) $(LIBLEVELDB_SSE42) \
#	$(am__DEPENDENCIES_4) $(am__DEPENDENCIES_1) \
#	$(am__DEPENDENCIES_1) $(LIBSECP256K1) \
#	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
#	$(am__append_23) $(am__DEPENDENCIES_1) \
#	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
#	$(am__DEPENDENCIES_1) $(am__DEPENDENCIES_7)
test_test_dennodes_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CXX \
	$(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link $(CXXLD) \
	$(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) \
	$(test_test_dennodes_LDFLAGS) $(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
SOURCES = $(crypto_libbitcoin_crypto_a_SOURCES) \
	...
	$(leveldb_libmemenv_a_SOURCES) $(libbitcoin_cli_a_SOURCES) \
	...
	$(libbitcoinconsensus_la_SOURCES) $(dennodes_cli_SOURCES) \
	$(dennodes_tx_SOURCES) $(dennodesd_SOURCES) \
	$(qt_dennodes_qt_SOURCES) $(qt_test_test_dennodes_qt_SOURCES) \
	$(nodist_qt_test_test_dennodes_qt_SOURCES) \
	$(test_test_dennodes_SOURCES) \
	$(nodist_test_test_dennodes_SOURCES)
DIST_SOURCES = $(crypto_libbitcoin_crypto_a_SOURCES) \
	...
	$(am__dennodes_cli_SOURCES_DIST) \
	$(am__dennodes_tx_SOURCES_DIST) $(am__dennodesd_SOURCES_DIST) \
	$(am__qt_dennodes_qt_SOURCES_DIST) \
	$(am__qt_test_test_dennodes_qt_SOURCES_DIST) \
	$(am__test_test_dennodes_SOURCES_DIST)
...
am__relativize = \
  ...
  reldir="$$dir2"
ACLOCAL = ${SHELL} /tmp/upgrade-wallet/dennodes/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /tmp/upgrade-wallet/dennodes/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /tmp/upgrade-wallet/dennodes/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /tmp/upgrade-wallet/dennodes/build-aux/missing automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = dennodes-cli
BITCOIN_DAEMON_NAME = dennodesd
BITCOIN_GUI_NAME = dennodes-qt
BITCOIN_TX_NAME = dennodes-tx
...
LEVELDB_CPPFLAGS =  $(am__append_14)
LEVELDB_TARGET_FLAGS = -DOS_LINUX
LIBLEVELDB =  $(am__append_12)
LIBMEMENV =  $(am__append_13)
LIBOBJS = 
LIBS = -lcrypto  -lgmp
...
MAINT = 
MAKEINFO = ${SHELL} /tmp/upgrade-wallet/dennodes/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = dennodes
PACKAGE_BUGREPORT = www.dennodes.org
PACKAGE_NAME = DENNODES Core
PACKAGE_STRING = DENNODES Core 1.0.0
PACKAGE_TARNAME = dennodes
PACKAGE_URL = 
...
abs_builddir = /tmp/upgrade-wallet/dennodes/src
abs_srcdir = /tmp/upgrade-wallet/dennodes/src
abs_top_builddir = /tmp/upgrade-wallet/dennodes
abs_top_srcdir = /tmp/upgrade-wallet/dennodes
ac_ct_AR = 
ac_ct_CC = 
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /tmp/upgrade-wallet/dennodes/build-aux/install-sh
...
AM_LDFLAGS = $(PTHREAD_CFLAGS) $(LIBTOOL_LDFLAGS) $(HARDENED_LDFLAGS) \
	$(GPROF_LDFLAGS) $(SANITIZER_LDFLAGS) $(am__append_6)
...
EXTRA_LIBRARIES = $(LIBBITCOIN_CRYPTO) $(LIBBITCOIN_UTIL) \
	...
	$(LIBBITCOIN_ZMQ) $(am__append_11) $(am__append_27)
#LIBUNIVALUE = $(UNIVALUE_LIBS)
LIBUNIVALUE = univalue/libunivalue.la
BITCOIN_INCLUDES = -I$(builddir) $(BDB_CPPFLAGS) $(BOOST_CPPFLAGS) \
...
BITCOIN_CORE_H = \
  ...
  zdenchain.h \
  zden/accumulators.h \
  zden/accumulatorcheckpoints.h \
  zden/accumulatorcheckpoints.json.h \
  zden/accumulatormap.h \
  zden/deterministicmint.h \
  zden/mintpool.h \
  zden/witness.h \
  zden/zerocoin.h \
  zden/zdentracker.h \
...
# server: shared between dennodesd and dennodes-qt
...
# wallet: shared between dennodesd and dennodes-qt, but only linked
# when wallet enabled
...
libbitcoin_wallet_a_SOURCES = \
  ...
  wallet/walletdb.cpp \
  zden/deterministicmint.cpp \
  zden/zerocoin.cpp \
  zden/accumulators.cpp \
  zden/mintpool.cpp \
  zden/witness.cpp \
  zden/zdenwallet.cpp \
  zden/zdentracker.cpp \
  stakeinput.cpp \
  genwit.cpp \
  zden/zdenmodule.cpp \
  lightzdenthread.cpp \
...
libzerocoin_libbitcoin_zerocoin_a_SOURCES = libzerocoin/Accumulator.h \
	libzerocoin/AccumulatorProofOfKnowledge.h libzerocoin/bignum.h \
	libzerocoin/Coin.h libzerocoin/CoinSpend.h \
	libzerocoin/Commitment.h libzerocoin/Denominations.h \
	libzerocoin/ParamGeneration.h libzerocoin/Params.h \
...
# common: shared between dennodesd, and dennodes-qt and non-server tools
libbitcoin_common_a_CPPFLAGS = $(AM_CPPFLAGS) $(BITCOIN_INCLUDES)
libbitcoin_common_a_CXXFLAGS = $(AM_CXXFLAGS) $(PIE_FLAGS)
libbitcoin_common_a_SOURCES = \
  zden/accumulators.cpp \
  zden/accumulatorcheckpoints.cpp \
  zden/accumulatormap.cpp \
  allocators.cpp \
  amount.cpp \
  base58.cpp \
  bip38.cpp \
...
libbitcoin_util_a_SOURCES = allocators.cpp chainparamsbase.cpp \
	clientversion.cpp compat/glibc_sanity.cpp \
	compat/glibcxx_sanity.cpp compat/strnlen.cpp random.cpp \
	rpc/protocol.cpp support/cleanse.cpp sync.cpp uint256.cpp \
	util.cpp utilmoneystr.cpp utilstrencodings.cpp utiltime.cpp \
	$(BITCOIN_CORE_H) $(am__append_5)

# cli: shared between dennodes-cli and dennodes-qt
...
# dennodesd binary #
dennodesd_SOURCES = dennodesd.cpp $(am__append_7)
dennodesd_CPPFLAGS = $(AM_CPPFLAGS) $(BITCOIN_INCLUDES)
dennodesd_CXXFLAGS = $(AM_CXXFLAGS) $(PIE_FLAGS)
dennodesd_LDFLAGS = $(RELDFLAGS) $(AM_LDFLAGS) $(LIBTOOL_APP_LDFLAGS)
dennodesd_LDADD = $(LIBBITCOIN_SERVER) $(LIBBITCOIN_WALLET) \
	$(LIBBITCOIN_COMMON) $(LIBUNIVALUE) $(LIBBITCOIN_ZEROCOIN) \
	$(LIBBITCOIN_UTIL) $(LIBBITCOIN_ZMQ) $(LIBBITCOIN_CRYPTO) \
	$(LIBLEVELDB) $(LIBLEVELDB_SSE42) $(LIBMEMENV) $(LIBSECP256K1) \
	$(BOOST_LIBS) $(BDB_LIBS) $(SSL_LIBS) $(CRYPTO_LIBS) \
	$(MINIUPNPC_LIBS) $(EVENT_PTHREADS_LIBS) $(EVENT_LIBS) \
	$(ZMQ_LIBS)

# dennodes-cli binary #
dennodes_cli_SOURCES = dennodes-cli.cpp $(am__append_8)
dennodes_cli_CPPFLAGS = $(AM_CPPFLAGS) $(BITCOIN_INCLUDES) $(EVENT_CFLAGS)
dennodes_cli_CXXFLAGS = $(AM_CXXFLAGS) $(PIE_FLAGS)
dennodes_cli_LDFLAGS = $(RELDFLAGS) $(AM_LDFLAGS) $(LIBTOOL_APP_LDFLAGS)
dennodes_cli_LDADD = $(LIBBITCOIN_CLI) $(LIBUNIVALUE) \
	$(LIBBITCOIN_UTIL) $(LIBBITCOIN_CRYPTO) $(BOOST_LIBS) \
	$(SSL_LIBS) $(CRYPTO_LIBS) $(EVENT_LIBS)
#

# dennodes-tx binary #
dennodes_tx_SOURCES = dennodes-tx.cpp $(am__append_9)
dennodes_tx_CPPFLAGS = $(AM_CPPFLAGS) $(BITCOIN_INCLUDES)
dennodes_tx_CXXFLAGS = $(AM_CXXFLAGS) $(PIE_FLAGS)
dennodes_tx_LDFLAGS = $(RELDFLAGS) $(AM_LDFLAGS) $(LIBTOOL_APP_LDFLAGS)
dennodes_tx_LDADD = $(LIBUNIVALUE) $(LIBBITCOIN_COMMON) \
	$(LIBBITCOIN_ZEROCOIN) $(LIBBITCOIN_UTIL) $(LIBBITCOIN_CRYPTO) \
	$(LIBSECP256K1) $(BOOST_LIBS) $(CRYPTO_LIBS)
#
...
#	crypto/ripemd160.cpp hash.cpp \
#	pubkey.cpp script/script.cpp \
#	script/interpreter.cpp \
...
CLEANFILES = $(EXTRA_LIBRARIES) *.gcda *.gcno compat/*.gcda \
	compat/*.gcno crypto/*.gcda crypto/*.gcno libzerocoin/*.gcda \
	libzerocoin/*.gcno primitives/*.gcda primitives/*.gcno \
	rpc/*.gcda rpc/*.gcno script/*.gcda script/*.gcno \
	support/*.gcda support/*.gcno univalue/*.gcda univalue/*.gcno \
	wallet/*.gcda wallet/*.gcno wallet/test/*.gcda \
	wallet/test/*.gcno zmq/*.gcda zmq/*.gcno zden/*.gcda \
	zden/*.gcno obj/build.h $(am__append_25) $(am__append_34) \
	$(am__append_41)
EXTRA_DIST = 
...
LEVELDB_CPPFLAGS_INT = -I$(srcdir)/leveldb \
	...
	-D__STDC_LIMIT_MACROS $(am__append_15) \
	$(am__append_16)
...
leveldb_libleveldb_a_SOURCES =  \
	...
	leveldb/util/status.cc $(am__append_17) \
	$(am__append_18)
...
#TEST_SRCDIR = test
#TEST_BINARY = test/test_dennodes$(EXEEXT)
#JSON_TEST_FILES = \
...
#BITCOIN_TEST_SUITE = \
#  test/test_dennodes.h \
#  test/test_dennodes.cpp

# test_dennodes binary #
#BITCOIN_TESTS =  \
...
#	test/univalue_tests.cpp test/util_tests.cpp \
#	$(am__append_22)
#test_test_dennodes_SOURCES = $(BITCOIN_TEST_SUITE) $(BITCOIN_TESTS) $(JSON_TEST_FILES) $(RAW_TEST_FILES)
#test_test_dennodes_CPPFLAGS = $(AM_CPPFLAGS) $(BITCOIN_INCLUDES) -I$(builddir)/test/ $(TESTDEFS) $(EVENT_FLAGS)
#test_test_dennodes_LDADD = $(LIBBITCOIN_SERVER) \
#	$(LIBBITCOIN_CLI) $(LIBBITCOIN_COMMON) \
#	$(LIBBITCOIN_UTIL) $(LIBBITCOIN_CRYPTO) \
#	$(LIBUNIVALUE) $(LIBBITCOIN_ZEROCOIN) \
#	$(LIBLEVELDB) $(LIBLEVELDB_SSE42) \
#	$(LIBMEMENV) $(BOOST_LIBS) \
#	$(BOOST_UNIT_TEST_FRAMEWORK_LIB) \
#	$(LIBSECP256K1) $(EVENT_LIBS) \
#	$(EVENT_PTHREADS_LIBS) $(am__append_23) \
#	$(LIBBITCOIN_CONSENSUS) $(BDB_LIBS) \
#	$(SSL_LIBS) $(CRYPTO_LIBS) \
#	$(MINIUPNPC_LIBS) $(am__append_24)
#test_test_dennodes_CXXFLAGS = $(AM_CXXFLAGS) $(PIE_FLAGS)
#test_test_dennodes_LDFLAGS = $(RELDFLAGS) $(AM_LDFLAGS) $(LIBTOOL_APP_LDFLAGS) -static
#
#nodist_test_test_dennodes_SOURCES = $(GENERATED_TEST_FILES)
#CLEAN_BITCOIN_TEST = test/*.gcda test/*.gcno $(GENERATED_TEST_FILES)

# dennodes qt core #
QT_TS = \
  qt/locale/dennodes_bg.ts \
  qt/locale/dennodes_ca.ts \
  qt/locale/dennodes_cs.ts \
  qt/locale/dennodes_da.ts \
  qt/locale/dennodes_de.ts \
  qt/locale/dennodes_en.ts \
  qt/locale/dennodes_en_GB.ts \
  qt/locale/dennodes_en_US.ts \
  qt/locale/dennodes_eo.ts \
  qt/locale/dennodes_es.ts \
  qt/locale/dennodes_es_ES.ts \
  qt/locale/dennodes_fi.ts \
  qt/locale/dennodes_fr_FR.ts \
  qt/locale/dennodes_hi_IN.ts \
  qt/locale/dennodes_hr.ts \
  qt/locale/dennodes_hr_HR.ts \
  qt/locale/dennodes_it.ts \
  qt/locale/dennodes_ja.ts \
  qt/locale/dennodes_ko_KR.ts \
  qt/locale/dennodes_lt_LT.ts \
  qt/locale/dennodes_nl.ts \
  qt/locale/dennodes_pl.ts \
  qt/locale/dennodes_pt.ts \
  qt/locale/dennodes_pt_BR.ts \
  qt/locale/dennodes_ro_RO.ts \
  qt/locale/dennodes_ru.ts \
  qt/locale/dennodes_sk.ts \
  qt/locale/dennodes_sv.ts \
  qt/locale/dennodes_tr.ts \
  qt/locale/dennodes_uk.ts \
  qt/locale/dennodes_vi.ts \
  qt/locale/dennodes_zh_CN.ts \
  qt/locale/dennodes_zh_TW.ts
...
QT_QRC_CPP = qt/qrc_dennodes.cpp
QT_QRC = qt/dennodes.qrc
QT_QRC_LOCALE_CPP = qt/qrc_dennodes_locale.cpp
QT_QRC_LOCALE = qt/dennodes_locale.qrc
...
RES_ICONS = \
  ...
  qt/res/icons/unit_dennodes.png \
  qt/res/icons/unit_mdennodes.png \
  qt/res/icons/unit_udennodes.png \
  qt/res/icons/unit_tdennodes.png \
  qt/res/icons/unit_tmdennodes.png \
  qt/res/icons/unit_tudennodes.png \
...
BITCOIN_RC = qt/res/dennodes-qt-res.rc
...
# dennodes-qt binary #
qt_dennodes_qt_CPPFLAGS = $(AM_CPPFLAGS) $(BITCOIN_INCLUDES) $(BITCOIN_QT_INCLUDES) \
  $(QT_INCLUDES) $(PROTOBUF_CFLAGS) $(QR_CFLAGS)

qt_dennodes_qt_CXXFLAGS = $(AM_CXXFLAGS) $(QT_PIE_FLAGS)
qt_dennodes_qt_SOURCES = qt/dennodes.cpp \
	$(am__append_30) $(am__append_31)
qt_dennodes_qt_LDADD = qt/libbitcoinqt.a \
	$(LIBBITCOIN_SERVER) $(am__append_32) \
	$(am__append_33) $(LIBBITCOIN_CLI) \
	$(LIBBITCOIN_COMMON) $(LIBBITCOIN_UTIL) \
	$(LIBBITCOIN_CRYPTO) $(LIBUNIVALUE) \
	$(LIBBITCOIN_ZEROCOIN) $(LIBLEVELDB) \
	$(LIBLEVELDB_SSE42) $(LIBMEMENV) $(BOOST_LIBS) \
	$(QT_LIBS) $(QT_DBUS_LIBS) $(QR_LIBS) \
	$(PROTOBUF_LIBS) $(BDB_LIBS) $(SSL_LIBS) \
	$(CRYPTO_LIBS) $(MINIUPNPC_LIBS) \
	$(LIBSECP256K1) $(EVENT_PTHREADS_LIBS) \
	$(EVENT_LIBS)
qt_dennodes_qt_LDFLAGS = $(RELDFLAGS) $(AM_LDFLAGS) $(QT_LDFLAGS) $(LIBTOOL_APP_LDFLAGS)
qt_dennodes_qt_LIBTOOLFLAGS = $(AM_LIBTOOLFLAGS) --tag CXX

#locale/foo.ts -> locale/foo.qm
QT_QM = $(QT_TS:.ts=.qm)
CLEAN_QT = $(nodist_qt_libbitcoinqt_a_SOURCES) $(QT_QM) $(QT_FORMS_H) qt/*.gcda qt/*.gcno qt/temp_dennodes_locale.qrc
...
#qt_test_test_dennodes_qt_CPPFLAGS = $(AM_CPPFLAGS) $(BITCOIN_INCLUDES) $(BITCOIN_QT_INCLUDES) \
#  $(QT_INCLUDES) $(QT_TEST_INCLUDES) $(PROTOBUF_CFLAGS)

#qt_test_test_dennodes_qt_SOURCES =  \
#	qt/test/test_main.cpp \
#	qt/test/uritests.cpp $(TEST_QT_H) \
#	$(am__append_38)
#nodist_qt_test_test_dennodes_qt_SOURCES = $(TEST_QT_MOC_CPP)
#qt_test_test_dennodes_qt_LDADD =  \
#	$(LIBBITCOINQT) $(LIBBITCOIN_SERVER) \
...
#qt_test_test_dennodes_qt_LDFLAGS = $(RELDFLAGS) $(AM_LDFLAGS) $(QT_LDFLAGS) $(LIBTOOL_APP_LDFLAGS)
#qt_test_test_dennodes_qt_CXXFLAGS = $(AM_CXXFLAGS) $(QT_PIE_FLAGS)
#CLEAN_BITCOIN_QT_TEST = $(TEST_QT_MOC_CPP) qt/test/*.gcda qt/test/*.gcno
all: all-recursive

.SUFFIXES:
.SUFFIXES: .c .cc .cpp .lo .log .mm .o .obj .rc .test .test$(EXEEXT) .trs
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(srcdir)/Makefile.leveldb.include $(srcdir)/Makefile.test.include $(srcdir)/Makefile.qt.include $(srcdir)/Makefile.qttest.include $(am__configure_deps)
	@for dep in $?; do \
...
$(srcdir)/Makefile.leveldb.include $(srcdir)/Makefile.test.include $(srcdir)/Makefile.qt.include $(srcdir)/Makefile.qttest.include $(am__empty):
...
zden/$(am__dirstamp):
	@$(MKDIR_P) zden
	@: > zden/$(am__dirstamp)
zden/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) zden/$(DEPDIR)
	@: > zden/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_common_a-accumulators.$(OBJEXT): zden/$(am__dirstamp) \
	zden/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_common_a-accumulatorcheckpoints.$(OBJEXT):  \
	zden/$(am__dirstamp) zden/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_common_a-accumulatormap.$(OBJEXT):  \
	zden/$(am__dirstamp) zden/$(DEPDIR)/$(am__dirstamp)
...
primitives/libbitcoin_common_a-transaction.$(OBJEXT):  \
	primitives/$(am__dirstamp) \
	primitives/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_common_a-zerocoin.$(OBJEXT): zden/$(am__dirstamp) \
	zden/$(DEPDIR)/$(am__dirstamp)
script/$(am__dirstamp):
	@$(MKDIR_P) script
	@: > script/$(am__dirstamp)
...
rpc/libbitcoin_server_a-blockchain.$(OBJEXT): rpc/$(am__dirstamp) \
	rpc/$(DEPDIR)/$(am__dirstamp)
rpc/libbitcoin_server_a-masternode.$(OBJEXT): rpc/$(am__dirstamp) \
	rpc/$(DEPDIR)/$(am__dirstamp)
rpc/libbitcoin_server_a-budget.$(OBJEXT): rpc/$(am__dirstamp) \
	rpc/$(DEPDIR)/$(am__dirstamp)
...
zden/libbitcoin_wallet_a-deterministicmint.$(OBJEXT):  \
	zden/$(am__dirstamp) zden/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_wallet_a-zerocoin.$(OBJEXT): zden/$(am__dirstamp) \
	zden/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_wallet_a-accumulators.$(OBJEXT): zden/$(am__dirstamp) \
	zden/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_wallet_a-mintpool.$(OBJEXT): zden/$(am__dirstamp) \
	zden/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_wallet_a-witness.$(OBJEXT): zden/$(am__dirstamp) \
	zden/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_wallet_a-zdenwallet.$(OBJEXT): zden/$(am__dirstamp) \
	zden/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_wallet_a-zdentracker.$(OBJEXT): zden/$(am__dirstamp) \
	zden/$(DEPDIR)/$(am__dirstamp)
zden/libbitcoin_wallet_a-zdenmodule.$(OBJEXT): zden/$(am__dirstamp) \
	zden/$(DEPDIR)/$(am__dirstamp)
...
libzerocoin/$(DEPDIR)/$(am__dirstamp):
	...
	@: > libzerocoin/$(DEPDIR)/$(am__dirstamp)
libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.$(OBJEXT):  \
	libzerocoin/$(am__dirstamp) \
	libzerocoin/$(DEPDIR)/$(am__dirstamp)
libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.$(OBJEXT):  \
	libzerocoin/$(am__dirstamp) \
...
libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.$(OBJEXT):  \
	libzerocoin/$(am__dirstamp) \
	libzerocoin/$(DEPDIR)/$(am__dirstamp)
libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.$(OBJEXT):  \
	libzerocoin/$(am__dirstamp) \
	libzerocoin/$(DEPDIR)/$(am__dirstamp)
libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.$(OBJEXT):  \
	libzerocoin/$(am__dirstamp) \
	libzerocoin/$(DEPDIR)/$(am__dirstamp)
...
qt/qt_libbitcoinqt_a-editaddressdialog.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-governancepage.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
...
qt/qt_libbitcoinqt_a-privacydialog.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-proposalframe.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-receiverequestdialog.$(OBJEXT):  \
	qt/$(am__dirstamp) qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-recentrequeststablemodel.$(OBJEXT):  \
...
qt/qt_libbitcoinqt_a-walletview.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-zdencontroldialog.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
...
qt/qt_libbitcoinqt_a-moc_editaddressdialog.$(OBJEXT):  \
	qt/$(am__dirstamp) qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-moc_governancepage.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
...
qt/qt_libbitcoinqt_a-moc_privacydialog.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-moc_proposalframe.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-moc_receiverequestdialog.$(OBJEXT):  \
	qt/$(am__dirstamp) qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-moc_recentrequeststablemodel.$(OBJEXT):  \
...
qt/qt_libbitcoinqt_a-paymentrequest.pb.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-qrc_dennodes.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_libbitcoinqt_a-qrc_dennodes_locale.$(OBJEXT):  \
	qt/$(am__dirstamp) qt/$(DEPDIR)/$(am__dirstamp)
...
dennodes-cli$(EXEEXT): $(dennodes_cli_OBJECTS) $(dennodes_cli_DEPENDENCIES) $(EXTRA_dennodes_cli_DEPENDENCIES) 
	@rm -f dennodes-cli$(EXEEXT)
	$(AM_V_CXXLD)$(dennodes_cli_LINK) $(dennodes_cli_OBJECTS) $(dennodes_cli_LDADD) $(LIBS)

dennodes-tx$(EXEEXT): $(dennodes_tx_OBJECTS) $(dennodes_tx_DEPENDENCIES) $(EXTRA_dennodes_tx_DEPENDENCIES) 
	@rm -f dennodes-tx$(EXEEXT)
	$(AM_V_CXXLD)$(dennodes_tx_LINK) $(dennodes_tx_OBJECTS) $(dennodes_tx_LDADD) $(LIBS)

dennodesd$(EXEEXT): $(dennodesd_OBJECTS) $(dennodesd_DEPENDENCIES) $(EXTRA_dennodesd_DEPENDENCIES) 
	@rm -f dennodesd$(EXEEXT)
	$(AM_V_CXXLD)$(dennodesd_LINK) $(dennodesd_OBJECTS) $(dennodesd_LDADD) $(LIBS)
qt/qt_dennodes_qt-dennodes.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_dennodes_qt-macdockiconhandler.$(OBJEXT): qt/$(am__dirstamp) \
	qt/$(DEPDIR)/$(am__dirstamp)
qt/qt_dennodes_qt-macnotificationhandler.$(OBJEXT):  \
	qt/$(am__dirstamp) qt/$(DEPDIR)/$(am__dirstamp)
qt/res/$(am__dirstamp):
...
qt/res/$(DEPDIR)/$(am__dirstamp):
	...
	@: > qt/res/$(DEPDIR)/$(am__dirstamp)
qt/res/dennodes-qt-res.$(OBJEXT): qt/res/$(am__dirstamp) \
	qt/res/$(DEPDIR)/$(am__dirstamp)

qt/dennodes-qt$(EXEEXT): $(qt_dennodes_qt_OBJECTS) $(qt_dennodes_qt_DEPENDENCIES) $(EXTRA_qt_dennodes_qt_DEPENDENCIES) qt/$(am__dirstamp)
	@rm -f qt/dennodes-qt$(EXEEXT)
	$(AM_V_OBJCXXLD)$(qt_dennodes_qt_LINK) $(qt_dennodes_qt_OBJECTS) $(qt_dennodes_qt_LDADD) $(LIBS)
...
qt/test/$(DEPDIR)/$(am__dirstamp):
	...
	@: > qt/test/$(DEPDIR)/$(am__dirstamp)
qt/test/qt_test_test_dennodes_qt-test_main.$(OBJEXT):  \
	qt/test/$(am__dirstamp) qt/test/$(DEPDIR)/$(am__dirstamp)
qt/test/qt_test_test_dennodes_qt-uritests.$(OBJEXT):  \
	qt/test/$(am__dirstamp) qt/test/$(DEPDIR)/$(am__dirstamp)
qt/test/qt_test_test_dennodes_qt-paymentservertests.$(OBJEXT):  \
	qt/test/$(am__dirstamp) qt/test/$(DEPDIR)/$(am__dirstamp)
qt/test/qt_test_test_dennodes_qt-moc_uritests.$(OBJEXT):  \
	qt/test/$(am__dirstamp) qt/test/$(DEPDIR)/$(am__dirstamp)
qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.$(OBJEXT):  \
	qt/test/$(am__dirstamp) qt/test/$(DEPDIR)/$(am__dirstamp)

qt/test/test_dennodes-qt$(EXEEXT): $(qt_test_test_dennodes_qt_OBJECTS) $(qt_test_test_dennodes_qt_DEPENDENCIES) $(EXTRA_qt_test_test_dennodes_qt_DEPENDENCIES) qt/test/$(am__dirstamp)
	@rm -f qt/test/test_dennodes-qt$(EXEEXT)
	$(AM_V_CXXLD)$(qt_test_test_dennodes_qt_LINK) $(qt_test_test_dennodes_qt_OBJECTS) $(qt_test_test_dennodes_qt_LDADD) $(LIBS)
test/$(am__dirstamp):
	@$(MKDIR_P) test
	@: > test/$(am__dirstamp)
test/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) test/$(DEPDIR)
	@: > test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-test_dennodes.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-zerocoin_implementation_tests.$(OBJEXT):  \
...
test/test_test_dennodes-libzerocoin_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-addrman_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-allocator_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-base32_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-base58_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-base64_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-budget_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-checkblock_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-Checkpoints_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-coins_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-compress_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-crypto_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-DoS_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-getarg_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-hash_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-key_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-main_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-mempool_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-mruset_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-multisig_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-netbase_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-pmt_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-reverselock_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-rpc_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-sanity_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-scheduler_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-script_P2SH_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-script_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-scriptnum_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-serialize_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-sighash_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-sigopcount_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-skiplist_tests.$(OBJEXT):  \
...
test/test_test_dennodes-transaction_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-uint256_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-univalue_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-util_tests.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
test/test_test_dennodes-accounting_tests.$(OBJEXT):  \
	test/$(am__dirstamp) test/$(DEPDIR)/$(am__dirstamp)
...
test/test_dennodes$(EXEEXT): $(test_test_dennodes_OBJECTS) $(test_test_dennodes_DEPENDENCIES) $(EXTRA_test_test_dennodes_DEPENDENCIES) test/$(am__dirstamp)
	@rm -f test/test_dennodes$(EXEEXT)
	$(AM_V_CXXLD)$(test_test_dennodes_LINK) $(test_test_dennodes_OBJECTS) $(test_test_dennodes_LDADD) $(LIBS)
...
include ./$(DEPDIR)/dennodes_cli-dennodes-cli.Po
include ./$(DEPDIR)/dennodes_tx-dennodes-tx.Po
include ./$(DEPDIR)/dennodesd-dennodesd.Po
...
include ./$(DEPDIR)/libbitcoin_common_a-invalid.Po
...
include ./$(DEPDIR)/libbitcoin_server_a-blocksignature.Po
...
include ./$(DEPDIR)/libbitcoin_server_a-zdenchain.Po
...
include ./$(DEPDIR)/libbitcoin_wallet_a-genwit.Po
include ./$(DEPDIR)/libbitcoin_wallet_a-kernel.Po
include ./$(DEPDIR)/libbitcoin_wallet_a-lightzdenthread.Po
...
include ./$(DEPDIR)/libbitcoin_wallet_a-stakeinput.Po
...
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Accumulator.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Coin.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Commitment.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Denominations.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Params.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.Po
include libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.Po
...
include qt/$(DEPDIR)/qt_dennodes_qt-dennodes.Po
include qt/$(DEPDIR)/qt_dennodes_qt-macdockiconhandler.Po
include qt/$(DEPDIR)/qt_dennodes_qt-macnotificationhandler.Po
...
include qt/$(DEPDIR)/qt_libbitcoinqt_a-governancepage.Po
...
include qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_governancepage.Po
...
include qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_proposalframe.Po
...
include qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_zdencontroldialog.Po
...
include qt/$(DEPDIR)/qt_libbitcoinqt_a-proposalframe.Po
include qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes.Po
include qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes_locale.Po
...
include qt/$(DEPDIR)/qt_libbitcoinqt_a-zdencontroldialog.Po
include qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_paymentservertests.Po
include qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_uritests.Po
include qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-paymentservertests.Po
include qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-test_main.Po
include qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-uritests.Po
include rpc/$(DEPDIR)/libbitcoin_cli_a-client.Po
include rpc/$(DEPDIR)/libbitcoin_server_a-blockchain.Po
include rpc/$(DEPDIR)/libbitcoin_server_a-budget.Po
include rpc/$(DEPDIR)/libbitcoin_server_a-masternode.Po
include rpc/$(DEPDIR)/libbitcoin_server_a-mining.Po
include rpc/$(DEPDIR)/libbitcoin_server_a-misc.Po
include rpc/$(DEPDIR)/libbitcoin_server_a-net.Po
include rpc/$(DEPDIR)/libbitcoin_server_a-rawtransaction.Po
include rpc/$(DEPDIR)/libbitcoin_server_a-server.Po
include rpc/$(DEPDIR)/libbitcoin_util_a-protocol.Po
...
include test/$(DEPDIR)/test_test_dennodes-Checkpoints_tests.Po
include test/$(DEPDIR)/test_test_dennodes-DoS_tests.Po
include test/$(DEPDIR)/test_test_dennodes-accounting_tests.Po
include test/$(DEPDIR)/test_test_dennodes-addrman_tests.Po
include test/$(DEPDIR)/test_test_dennodes-allocator_tests.Po
include test/$(DEPDIR)/test_test_dennodes-base32_tests.Po
include test/$(DEPDIR)/test_test_dennodes-base58_tests.Po
include test/$(DEPDIR)/test_test_dennodes-base64_tests.Po
include test/$(DEPDIR)/test_test_dennodes-benchmark_zerocoin.Po
include test/$(DEPDIR)/test_test_dennodes-budget_tests.Po
include test/$(DEPDIR)/test_test_dennodes-checkblock_tests.Po
include test/$(DEPDIR)/test_test_dennodes-coins_tests.Po
include test/$(DEPDIR)/test_test_dennodes-compress_tests.Po
include test/$(DEPDIR)/test_test_dennodes-crypto_tests.Po
include test/$(DEPDIR)/test_test_dennodes-getarg_tests.Po
include test/$(DEPDIR)/test_test_dennodes-hash_tests.Po
include test/$(DEPDIR)/test_test_dennodes-key_tests.Po
include test/$(DEPDIR)/test_test_dennodes-libzerocoin_tests.Po
include test/$(DEPDIR)/test_test_dennodes-main_tests.Po
include test/$(DEPDIR)/test_test_dennodes-mempool_tests.Po
include test/$(DEPDIR)/test_test_dennodes-mruset_tests.Po
include test/$(DEPDIR)/test_test_dennodes-multisig_tests.Po
include test/$(DEPDIR)/test_test_dennodes-netbase_tests.Po
include test/$(DEPDIR)/test_test_dennodes-pmt_tests.Po
include test/$(DEPDIR)/test_test_dennodes-reverselock_tests.Po
include test/$(DEPDIR)/test_test_dennodes-rpc_tests.Po
include test/$(DEPDIR)/test_test_dennodes-rpc_wallet_tests.Po
include test/$(DEPDIR)/test_test_dennodes-sanity_tests.Po
include test/$(DEPDIR)/test_test_dennodes-scheduler_tests.Po
include test/$(DEPDIR)/test_test_dennodes-script_P2SH_tests.Po
include test/$(DEPDIR)/test_test_dennodes-script_tests.Po
include test/$(DEPDIR)/test_test_dennodes-scriptnum_tests.Po
include test/$(DEPDIR)/test_test_dennodes-serialize_tests.Po
include test/$(DEPDIR)/test_test_dennodes-sighash_tests.Po
include test/$(DEPDIR)/test_test_dennodes-sigopcount_tests.Po
include test/$(DEPDIR)/test_test_dennodes-skiplist_tests.Po
include test/$(DEPDIR)/test_test_dennodes-test_dennodes.Po
include test/$(DEPDIR)/test_test_dennodes-timedata_tests.Po
include test/$(DEPDIR)/test_test_dennodes-torcontrol_tests.Po
include test/$(DEPDIR)/test_test_dennodes-transaction_tests.Po
include test/$(DEPDIR)/test_test_dennodes-tutorial_zerocoin.Po
include test/$(DEPDIR)/test_test_dennodes-uint256_tests.Po
include test/$(DEPDIR)/test_test_dennodes-univalue_tests.Po
include test/$(DEPDIR)/test_test_dennodes-util_tests.Po
include test/$(DEPDIR)/test_test_dennodes-zerocoin_bignum_tests.Po
include test/$(DEPDIR)/test_test_dennodes-zerocoin_coinspend_tests.Po
include test/$(DEPDIR)/test_test_dennodes-zerocoin_denomination_tests.Po
include test/$(DEPDIR)/test_test_dennodes-zerocoin_implementation_tests.Po
include test/$(DEPDIR)/test_test_dennodes-zerocoin_transactions_tests.Po
...
include wallet/test/$(DEPDIR)/test_test_dennodes-wallet_tests.Po
include zden/$(DEPDIR)/libbitcoin_common_a-accumulatorcheckpoints.Po
include zden/$(DEPDIR)/libbitcoin_common_a-accumulatormap.Po
include zden/$(DEPDIR)/libbitcoin_common_a-accumulators.Po
include zden/$(DEPDIR)/libbitcoin_common_a-deterministicmint.Po
include zden/$(DEPDIR)/libbitcoin_common_a-zerocoin.Po
include zden/$(DEPDIR)/libbitcoin_wallet_a-accumulators.Po
include zden/$(DEPDIR)/libbitcoin_wallet_a-deterministicmint.Po
include zden/$(DEPDIR)/libbitcoin_wallet_a-mintpool.Po
include zden/$(DEPDIR)/libbitcoin_wallet_a-witness.Po
include zden/$(DEPDIR)/libbitcoin_wallet_a-zdenmodule.Po
include zden/$(DEPDIR)/libbitcoin_wallet_a-zdentracker.Po
include zden/$(DEPDIR)/libbitcoin_wallet_a-zdenwallet.Po
include zden/$(DEPDIR)/libbitcoin_wallet_a-zerocoin.Po
...
crypto/crypto_libbitcoin_crypto_a-aes_helper.o: crypto/aes_helper.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-aes_helper.o -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-aes_helper.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-aes_helper.o `test -f 'crypto/aes_helper.c' || echo '$(srcdir)/'`crypto/aes_helper.c
...
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-aes_helper.o `test -f 'crypto/aes_helper.c' || echo '$(srcdir)/'`crypto/aes_helper.c

crypto/crypto_libbitcoin_crypto_a-aes_helper.obj: crypto/aes_helper.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-aes_helper.obj -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-aes_helper.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-aes_helper.obj `if test -f 'crypto/aes_helper.c'; then $(CYGPATH_W) 'crypto/aes_helper.c'; else $(CYGPATH_W) '$(srcdir)/crypto/aes_helper.c'; fi`
	$(AM_V_at)$(am__mv) crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-aes_helper.Tpo crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-aes_helper.Po
#	$(AM_V_CC)source='crypto/aes_helper.c' object='crypto/crypto_libbitcoin_crypto_a-aes_helper.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-aes_helper.obj `if test -f 'crypto/aes_helper.c'; then $(CYGPATH_W) 'crypto/aes_helper.c'; else $(CYGPATH_W) '$(srcdir)/crypto/aes_helper.c'; fi`

crypto/crypto_libbitcoin_crypto_a-blake.o: crypto/blake.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-blake.o -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-blake.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-blake.o `test -f 'crypto/blake.c' || echo '$(srcdir)/'`crypto/blake.c
...
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-blake.o `test -f 'crypto/blake.c' || echo '$(srcdir)/'`crypto/blake.c

crypto/crypto_libbitcoin_crypto_a-blake.obj: crypto/blake.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-blake.obj -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-blake.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-blake.obj `if test -f 'crypto/blake.c'; then $(CYGPATH_W) 'crypto/blake.c'; else $(CYGPATH_W) '$(srcdir)/crypto/blake.c'; fi`
	$(AM_V_at)$(am__mv) crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-blake.Tpo crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-blake.Po
#	$(AM_V_CC)source='crypto/blake.c' object='crypto/crypto_libbitcoin_crypto_a-blake.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-blake.obj `if test -f 'crypto/blake.c'; then $(CYGPATH_W) 'crypto/blake.c'; else $(CYGPATH_W) '$(srcdir)/crypto/blake.c'; fi`

crypto/crypto_libbitcoin_crypto_a-bmw.o: crypto/bmw.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-bmw.o -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-bmw.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-bmw.o `test -f 'crypto/bmw.c' || echo '$(srcdir)/'`crypto/bmw.c
...
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-bmw.o `test -f 'crypto/bmw.c' || echo '$(srcdir)/'`crypto/bmw.c

crypto/crypto_libbitcoin_crypto_a-bmw.obj: crypto/bmw.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-bmw.obj -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-bmw.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-bmw.obj `if test -f 'crypto/bmw.c'; then $(CYGPATH_W) 'crypto/bmw.c'; else $(CYGPATH_W) '$(srcdir)/crypto/bmw.c'; fi`
	$(AM_V_at)$(am__mv) crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-bmw.Tpo crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-bmw.Po
#	$(AM_V_CC)source='crypto/bmw.c' object='crypto/crypto_libbitcoin_crypto_a-bmw.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-bmw.obj `if test -f 'crypto/bmw.c'; then $(CYGPATH_W) 'crypto/bmw.c'; else $(CYGPATH_W) '$(srcdir)/crypto/bmw.c'; fi`

crypto/crypto_libbitcoin_crypto_a-groestl.o: crypto/groestl.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-groestl.o -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-groestl.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-groestl.o `test -f 'crypto/groestl.c' || echo '$(srcdir)/'`crypto/groestl.c
...
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-groestl.o `test -f 'crypto/groestl.c' || echo '$(srcdir)/'`crypto/groestl.c

crypto/crypto_libbitcoin_crypto_a-groestl.obj: crypto/groestl.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-groestl.obj -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-groestl.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-groestl.obj `if test -f 'crypto/groestl.c'; then $(CYGPATH_W) 'crypto/groestl.c'; else $(CYGPATH_W) '$(srcdir)/crypto/groestl.c'; fi`
	$(AM_V_at)$(am__mv) crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-groestl.Tpo crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-groestl.Po
#	$(AM_V_CC)source='crypto/groestl.c' object='crypto/crypto_libbitcoin_crypto_a-groestl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-groestl.obj `if test -f 'crypto/groestl.c'; then $(CYGPATH_W) 'crypto/groestl.c'; else $(CYGPATH_W) '$(srcdir)/crypto/groestl.c'; fi`

crypto/crypto_libbitcoin_crypto_a-jh.o: crypto/jh.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-jh.o -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-jh.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-jh.o `test -f 'crypto/jh.c' || echo '$(srcdir)/'`crypto/jh.c
...
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-jh.o `test -f 'crypto/jh.c' || echo '$(srcdir)/'`crypto/jh.c

crypto/crypto_libbitcoin_crypto_a-jh.obj: crypto/jh.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-jh.obj -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-jh.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-jh.obj `if test -f 'crypto/jh.c'; then $(CYGPATH_W) 'crypto/jh.c'; else $(CYGPATH_W) '$(srcdir)/crypto/jh.c'; fi`
	$(AM_V_at)$(am__mv) crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-jh.Tpo crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-jh.Po
#	$(AM_V_CC)source='crypto/jh.c' object='crypto/crypto_libbitcoin_crypto_a-jh.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-jh.obj `if test -f 'crypto/jh.c'; then $(CYGPATH_W) 'crypto/jh.c'; else $(CYGPATH_W) '$(srcdir)/crypto/jh.c'; fi`

crypto/crypto_libbitcoin_crypto_a-keccak.o: crypto/keccak.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-keccak.o -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-keccak.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-keccak.o `test -f 'crypto/keccak.c' || echo '$(srcdir)/'`crypto/keccak.c
...
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-keccak.o `test -f 'crypto/keccak.c' || echo '$(srcdir)/'`crypto/keccak.c

crypto/crypto_libbitcoin_crypto_a-keccak.obj: crypto/keccak.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-keccak.obj -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-keccak.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-keccak.obj `if test -f 'crypto/keccak.c'; then $(CYGPATH_W) 'crypto/keccak.c'; else $(CYGPATH_W) '$(srcdir)/crypto/keccak.c'; fi`
	$(AM_V_at)$(am__mv) crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-keccak.Tpo crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-keccak.Po
#	$(AM_V_CC)source='crypto/keccak.c' object='crypto/crypto_libbitcoin_crypto_a-keccak.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-keccak.obj `if test -f 'crypto/keccak.c'; then $(CYGPATH_W) 'crypto/keccak.c'; else $(CYGPATH_W) '$(srcdir)/crypto/keccak.c'; fi`

crypto/crypto_libbitcoin_crypto_a-skein.o: crypto/skein.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-skein.o -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-skein.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-skein.o `test -f 'crypto/skein.c' || echo '$(srcdir)/'`crypto/skein.c
...
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-skein.o `test -f 'crypto/skein.c' || echo '$(srcdir)/'`crypto/skein.c

crypto/crypto_libbitcoin_crypto_a-skein.obj: crypto/skein.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-skein.obj -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-skein.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-skein.obj `if test -f 'crypto/skein.c'; then $(CYGPATH_W) 'crypto/skein.c'; else $(CYGPATH_W) '$(srcdir)/crypto/skein.c'; fi`
	$(AM_V_at)$(am__mv) crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-skein.Tpo crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-skein.Po
#	$(AM_V_CC)source='crypto/skein.c' object='crypto/crypto_libbitcoin_crypto_a-skein.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-skein.obj `if test -f 'crypto/skein.c'; then $(CYGPATH_W) 'crypto/skein.c'; else $(CYGPATH_W) '$(srcdir)/crypto/skein.c'; fi`
...
crypto/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.o: crypto/rfc6979_hmac_sha256.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(crypto_libbitcoin_crypto_a_CXXFLAGS) $(CXXFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.o -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.o `test -f 'crypto/rfc6979_hmac_sha256.cpp' || echo '$(srcdir)/'`crypto/rfc6979_hmac_sha256.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(crypto_libbitcoin_crypto_a_CXXFLAGS) $(CXXFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.o `test -f 'crypto/rfc6979_hmac_sha256.cpp' || echo '$(srcdir)/'`crypto/rfc6979_hmac_sha256.cpp

crypto/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.obj: crypto/rfc6979_hmac_sha256.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(crypto_libbitcoin_crypto_a_CXXFLAGS) $(CXXFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.obj -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.obj `if test -f 'crypto/rfc6979_hmac_sha256.cpp'; then $(CYGPATH_W) 'crypto/rfc6979_hmac_sha256.cpp'; else $(CYGPATH_W) '$(srcdir)/crypto/rfc6979_hmac_sha256.cpp'; fi`
	$(AM_V_at)$(am__mv) crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.Tpo crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.Po
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(crypto_libbitcoin_crypto_a_CXXFLAGS) $(CXXFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-rfc6979_hmac_sha256.obj `if test -f 'crypto/rfc6979_hmac_sha256.cpp'; then $(CYGPATH_W) 'crypto/rfc6979_hmac_sha256.cpp'; else $(CYGPATH_W) '$(srcdir)/crypto/rfc6979_hmac_sha256.cpp'; fi`
...
crypto/crypto_libbitcoin_crypto_a-scrypt.o: crypto/scrypt.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(crypto_libbitcoin_crypto_a_CXXFLAGS) $(CXXFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-scrypt.o -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-scrypt.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-scrypt.o `test -f 'crypto/scrypt.cpp' || echo '$(srcdir)/'`crypto/scrypt.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(crypto_libbitcoin_crypto_a_CXXFLAGS) $(CXXFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-scrypt.o `test -f 'crypto/scrypt.cpp' || echo '$(srcdir)/'`crypto/scrypt.cpp

crypto/crypto_libbitcoin_crypto_a-scrypt.obj: crypto/scrypt.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(crypto_libbitcoin_crypto_a_CXXFLAGS) $(CXXFLAGS) -MT crypto/crypto_libbitcoin_crypto_a-scrypt.obj -MD -MP -MF crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-scrypt.Tpo -c -o crypto/crypto_libbitcoin_crypto_a-scrypt.obj `if test -f 'crypto/scrypt.cpp'; then $(CYGPATH_W) 'crypto/scrypt.cpp'; else $(CYGPATH_W) '$(srcdir)/crypto/scrypt.cpp'; fi`
	$(AM_V_at)$(am__mv) crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-scrypt.Tpo crypto/$(DEPDIR)/crypto_libbitcoin_crypto_a-scrypt.Po
#	$(AM_V_CXX)source='crypto/scrypt.cpp' object='crypto/crypto_libbitcoin_crypto_a-scrypt.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(crypto_libbitcoin_crypto_a_CPPFLAGS) $(CPPFLAGS) $(crypto_libbitcoin_crypto_a_CXXFLAGS) $(CXXFLAGS) -c -o crypto/crypto_libbitcoin_crypto_a-scrypt.obj `if test -f 'crypto/scrypt.cpp'; then $(CYGPATH_W) 'crypto/scrypt.cpp'; else $(CYGPATH_W) '$(srcdir)/crypto/scrypt.cpp'; fi`
...
zden/libbitcoin_common_a-accumulators.o: zden/accumulators.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_common_a-accumulators.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_common_a-accumulators.Tpo -c -o zden/libbitcoin_common_a-accumulators.o `test -f 'zden/accumulators.cpp' || echo '$(srcdir)/'`zden/accumulators.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_common_a-accumulators.Tpo zden/$(DEPDIR)/libbitcoin_common_a-accumulators.Po
#	$(AM_V_CXX)source='zden/accumulators.cpp' object='zden/libbitcoin_common_a-accumulators.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_common_a-accumulators.o `test -f 'zden/accumulators.cpp' || echo '$(srcdir)/'`zden/accumulators.cpp

zden/libbitcoin_common_a-accumulators.obj: zden/accumulators.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_common_a-accumulators.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_common_a-accumulators.Tpo -c -o zden/libbitcoin_common_a-accumulators.obj `if test -f 'zden/accumulators.cpp'; then $(CYGPATH_W) 'zden/accumulators.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/accumulators.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_common_a-accumulators.Tpo zden/$(DEPDIR)/libbitcoin_common_a-accumulators.Po
#	$(AM_V_CXX)source='zden/accumulators.cpp' object='zden/libbitcoin_common_a-accumulators.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_common_a-accumulators.obj `if test -f 'zden/accumulators.cpp'; then $(CYGPATH_W) 'zden/accumulators.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/accumulators.cpp'; fi`

zden/libbitcoin_common_a-accumulatorcheckpoints.o: zden/accumulatorcheckpoints.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_common_a-accumulatorcheckpoints.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_common_a-accumulatorcheckpoints.Tpo -c -o zden/libbitcoin_common_a-accumulatorcheckpoints.o `test -f 'zden/accumulatorcheckpoints.cpp' || echo '$(srcdir)/'`zden/accumulatorcheckpoints.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_common_a-accumulatorcheckpoints.Tpo zden/$(DEPDIR)/libbitcoin_common_a-accumulatorcheckpoints.Po
#	$(AM_V_CXX)source='zden/accumulatorcheckpoints.cpp' object='zden/libbitcoin_common_a-accumulatorcheckpoints.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_common_a-accumulatorcheckpoints.o `test -f 'zden/accumulatorcheckpoints.cpp' || echo '$(srcdir)/'`zden/accumulatorcheckpoints.cpp

zden/libbitcoin_common_a-accumulatorcheckpoints.obj: zden/accumulatorcheckpoints.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_common_a-accumulatorcheckpoints.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_common_a-accumulatorcheckpoints.Tpo -c -o zden/libbitcoin_common_a-accumulatorcheckpoints.obj `if test -f 'zden/accumulatorcheckpoints.cpp'; then $(CYGPATH_W) 'zden/accumulatorcheckpoints.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/accumulatorcheckpoints.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_common_a-accumulatorcheckpoints.Tpo zden/$(DEPDIR)/libbitcoin_common_a-accumulatorcheckpoints.Po
#	$(AM_V_CXX)source='zden/accumulatorcheckpoints.cpp' object='zden/libbitcoin_common_a-accumulatorcheckpoints.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_common_a-accumulatorcheckpoints.obj `if test -f 'zden/accumulatorcheckpoints.cpp'; then $(CYGPATH_W) 'zden/accumulatorcheckpoints.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/accumulatorcheckpoints.cpp'; fi`

zden/libbitcoin_common_a-accumulatormap.o: zden/accumulatormap.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_common_a-accumulatormap.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_common_a-accumulatormap.Tpo -c -o zden/libbitcoin_common_a-accumulatormap.o `test -f 'zden/accumulatormap.cpp' || echo '$(srcdir)/'`zden/accumulatormap.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_common_a-accumulatormap.Tpo zden/$(DEPDIR)/libbitcoin_common_a-accumulatormap.Po
#	$(AM_V_CXX)source='zden/accumulatormap.cpp' object='zden/libbitcoin_common_a-accumulatormap.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_common_a-accumulatormap.o `test -f 'zden/accumulatormap.cpp' || echo '$(srcdir)/'`zden/accumulatormap.cpp

zden/libbitcoin_common_a-accumulatormap.obj: zden/accumulatormap.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_common_a-accumulatormap.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_common_a-accumulatormap.Tpo -c -o zden/libbitcoin_common_a-accumulatormap.obj `if test -f 'zden/accumulatormap.cpp'; then $(CYGPATH_W) 'zden/accumulatormap.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/accumulatormap.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_common_a-accumulatormap.Tpo zden/$(DEPDIR)/libbitcoin_common_a-accumulatormap.Po
#	$(AM_V_CXX)source='zden/accumulatormap.cpp' object='zden/libbitcoin_common_a-accumulatormap.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_common_a-accumulatormap.obj `if test -f 'zden/accumulatormap.cpp'; then $(CYGPATH_W) 'zden/accumulatormap.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/accumulatormap.cpp'; fi`

libbitcoin_common_a-allocators.o: allocators.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_common_a-allocators.o -MD -MP -MF $(DEPDIR)/libbitcoin_common_a-allocators.Tpo -c -o libbitcoin_common_a-allocators.o `test -f 'allocators.cpp' || echo '$(srcdir)/'`allocators.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_common_a-allocators.o `test -f 'allocators.cpp' || echo '$(srcdir)/'`allocators.cpp

libbitcoin_common_a-allocators.obj: allocators.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_common_a-allocators.obj -MD -MP -MF $(DEPDIR)/libbitcoin_common_a-allocators.Tpo -c -o libbitcoin_common_a-allocators.obj `if test -f 'allocators.cpp'; then $(CYGPATH_W) 'allocators.cpp'; else $(CYGPATH_W) '$(srcdir)/allocators.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_common_a-allocators.Tpo $(DEPDIR)/libbitcoin_common_a-allocators.Po
#	$(AM_V_CXX)source='allocators.cpp' object='libbitcoin_common_a-allocators.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_common_a-allocators.obj `if test -f 'allocators.cpp'; then $(CYGPATH_W) 'allocators.cpp'; else $(CYGPATH_W) '$(srcdir)/allocators.cpp'; fi`
...
libbitcoin_common_a-bip38.o: bip38.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_common_a-bip38.o -MD -MP -MF $(DEPDIR)/libbitcoin_common_a-bip38.Tpo -c -o libbitcoin_common_a-bip38.o `test -f 'bip38.cpp' || echo '$(srcdir)/'`bip38.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_common_a-bip38.o `test -f 'bip38.cpp' || echo '$(srcdir)/'`bip38.cpp

libbitcoin_common_a-bip38.obj: bip38.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_common_a-bip38.obj -MD -MP -MF $(DEPDIR)/libbitcoin_common_a-bip38.Tpo -c -o libbitcoin_common_a-bip38.obj `if test -f 'bip38.cpp'; then $(CYGPATH_W) 'bip38.cpp'; else $(CYGPATH_W) '$(srcdir)/bip38.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_common_a-bip38.Tpo $(DEPDIR)/libbitcoin_common_a-bip38.Po
#	$(AM_V_CXX)source='bip38.cpp' object='libbitcoin_common_a-bip38.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_common_a-bip38.obj `if test -f 'bip38.cpp'; then $(CYGPATH_W) 'bip38.cpp'; else $(CYGPATH_W) '$(srcdir)/bip38.cpp'; fi`
...
zden/libbitcoin_common_a-deterministicmint.o: zden/deterministicmint.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_common_a-deterministicmint.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_common_a-deterministicmint.Tpo -c -o zden/libbitcoin_common_a-deterministicmint.o `test -f 'zden/deterministicmint.cpp' || echo '$(srcdir)/'`zden/deterministicmint.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_common_a-deterministicmint.Tpo zden/$(DEPDIR)/libbitcoin_common_a-deterministicmint.Po
#	$(AM_V_CXX)source='zden/deterministicmint.cpp' object='zden/libbitcoin_common_a-deterministicmint.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_common_a-deterministicmint.o `test -f 'zden/deterministicmint.cpp' || echo '$(srcdir)/'`zden/deterministicmint.cpp

zden/libbitcoin_common_a-deterministicmint.obj: zden/deterministicmint.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_common_a-deterministicmint.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_common_a-deterministicmint.Tpo -c -o zden/libbitcoin_common_a-deterministicmint.obj `if test -f 'zden/deterministicmint.cpp'; then $(CYGPATH_W) 'zden/deterministicmint.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/deterministicmint.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_common_a-deterministicmint.Tpo zden/$(DEPDIR)/libbitcoin_common_a-deterministicmint.Po
#	$(AM_V_CXX)source='zden/deterministicmint.cpp' object='zden/libbitcoin_common_a-deterministicmint.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_common_a-deterministicmint.obj `if test -f 'zden/deterministicmint.cpp'; then $(CYGPATH_W) 'zden/deterministicmint.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/deterministicmint.cpp'; fi`
...
zden/libbitcoin_common_a-zerocoin.o: zden/zerocoin.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_common_a-zerocoin.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_common_a-zerocoin.Tpo -c -o zden/libbitcoin_common_a-zerocoin.o `test -f 'zden/zerocoin.cpp' || echo '$(srcdir)/'`zden/zerocoin.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_common_a-zerocoin.Tpo zden/$(DEPDIR)/libbitcoin_common_a-zerocoin.Po
#	$(AM_V_CXX)source='zden/zerocoin.cpp' object='zden/libbitcoin_common_a-zerocoin.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_common_a-zerocoin.o `test -f 'zden/zerocoin.cpp' || echo '$(srcdir)/'`zden/zerocoin.cpp

zden/libbitcoin_common_a-zerocoin.obj: zden/zerocoin.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_common_a-zerocoin.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_common_a-zerocoin.Tpo -c -o zden/libbitcoin_common_a-zerocoin.obj `if test -f 'zden/zerocoin.cpp'; then $(CYGPATH_W) 'zden/zerocoin.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/zerocoin.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_common_a-zerocoin.Tpo zden/$(DEPDIR)/libbitcoin_common_a-zerocoin.Po
#	$(AM_V_CXX)source='zden/zerocoin.cpp' object='zden/libbitcoin_common_a-zerocoin.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_common_a-zerocoin.obj `if test -f 'zden/zerocoin.cpp'; then $(CYGPATH_W) 'zden/zerocoin.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/zerocoin.cpp'; fi`
...
libbitcoin_common_a-invalid.o: invalid.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_common_a-invalid.o -MD -MP -MF $(DEPDIR)/libbitcoin_common_a-invalid.Tpo -c -o libbitcoin_common_a-invalid.o `test -f 'invalid.cpp' || echo '$(srcdir)/'`invalid.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_common_a-invalid.Tpo $(DEPDIR)/libbitcoin_common_a-invalid.Po
#	$(AM_V_CXX)source='invalid.cpp' object='libbitcoin_common_a-invalid.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_common_a-invalid.o `test -f 'invalid.cpp' || echo '$(srcdir)/'`invalid.cpp

libbitcoin_common_a-invalid.obj: invalid.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_common_a-invalid.obj -MD -MP -MF $(DEPDIR)/libbitcoin_common_a-invalid.Tpo -c -o libbitcoin_common_a-invalid.obj `if test -f 'invalid.cpp'; then $(CYGPATH_W) 'invalid.cpp'; else $(CYGPATH_W) '$(srcdir)/invalid.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_common_a-invalid.Tpo $(DEPDIR)/libbitcoin_common_a-invalid.Po
#	$(AM_V_CXX)source='invalid.cpp' object='libbitcoin_common_a-invalid.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_common_a-invalid.obj `if test -f 'invalid.cpp'; then $(CYGPATH_W) 'invalid.cpp'; else $(CYGPATH_W) '$(srcdir)/invalid.cpp'; fi`
...
libbitcoin_common_a-spork.o: spork.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_common_a-spork.o -MD -MP -MF $(DEPDIR)/libbitcoin_common_a-spork.Tpo -c -o libbitcoin_common_a-spork.o `test -f 'spork.cpp' || echo '$(srcdir)/'`spork.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_common_a-spork.o `test -f 'spork.cpp' || echo '$(srcdir)/'`spork.cpp

libbitcoin_common_a-spork.obj: spork.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_common_a-spork.obj -MD -MP -MF $(DEPDIR)/libbitcoin_common_a-spork.Tpo -c -o libbitcoin_common_a-spork.obj `if test -f 'spork.cpp'; then $(CYGPATH_W) 'spork.cpp'; else $(CYGPATH_W) '$(srcdir)/spork.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_common_a-spork.Tpo $(DEPDIR)/libbitcoin_common_a-spork.Po
#	$(AM_V_CXX)source='spork.cpp' object='libbitcoin_common_a-spork.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_common_a-spork.obj `if test -f 'spork.cpp'; then $(CYGPATH_W) 'spork.cpp'; else $(CYGPATH_W) '$(srcdir)/spork.cpp'; fi`

libbitcoin_common_a-sporkdb.o: sporkdb.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_common_a-sporkdb.o -MD -MP -MF $(DEPDIR)/libbitcoin_common_a-sporkdb.Tpo -c -o libbitcoin_common_a-sporkdb.o `test -f 'sporkdb.cpp' || echo '$(srcdir)/'`sporkdb.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_common_a-sporkdb.o `test -f 'sporkdb.cpp' || echo '$(srcdir)/'`sporkdb.cpp

libbitcoin_common_a-sporkdb.obj: sporkdb.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_common_a-sporkdb.obj -MD -MP -MF $(DEPDIR)/libbitcoin_common_a-sporkdb.Tpo -c -o libbitcoin_common_a-sporkdb.obj `if test -f 'sporkdb.cpp'; then $(CYGPATH_W) 'sporkdb.cpp'; else $(CYGPATH_W) '$(srcdir)/sporkdb.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_common_a-sporkdb.Tpo $(DEPDIR)/libbitcoin_common_a-sporkdb.Po
#	$(AM_V_CXX)source='sporkdb.cpp' object='libbitcoin_common_a-sporkdb.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_common_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_common_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_common_a-sporkdb.obj `if test -f 'sporkdb.cpp'; then $(CYGPATH_W) 'sporkdb.cpp'; else $(CYGPATH_W) '$(srcdir)/sporkdb.cpp'; fi`
...
libbitcoin_server_a-blocksignature.o: blocksignature.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_server_a-blocksignature.o -MD -MP -MF $(DEPDIR)/libbitcoin_server_a-blocksignature.Tpo -c -o libbitcoin_server_a-blocksignature.o `test -f 'blocksignature.cpp' || echo '$(srcdir)/'`blocksignature.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_server_a-blocksignature.Tpo $(DEPDIR)/libbitcoin_server_a-blocksignature.Po
#	$(AM_V_CXX)source='blocksignature.cpp' object='libbitcoin_server_a-blocksignature.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_server_a-blocksignature.o `test -f 'blocksignature.cpp' || echo '$(srcdir)/'`blocksignature.cpp

libbitcoin_server_a-blocksignature.obj: blocksignature.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_server_a-blocksignature.obj -MD -MP -MF $(DEPDIR)/libbitcoin_server_a-blocksignature.Tpo -c -o libbitcoin_server_a-blocksignature.obj `if test -f 'blocksignature.cpp'; then $(CYGPATH_W) 'blocksignature.cpp'; else $(CYGPATH_W) '$(srcdir)/blocksignature.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_server_a-blocksignature.Tpo $(DEPDIR)/libbitcoin_server_a-blocksignature.Po
#	$(AM_V_CXX)source='blocksignature.cpp' object='libbitcoin_server_a-blocksignature.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_server_a-blocksignature.obj `if test -f 'blocksignature.cpp'; then $(CYGPATH_W) 'blocksignature.cpp'; else $(CYGPATH_W) '$(srcdir)/blocksignature.cpp'; fi`
...
rpc/libbitcoin_server_a-masternode.o: rpc/masternode.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -MT rpc/libbitcoin_server_a-masternode.o -MD -MP -MF rpc/$(DEPDIR)/libbitcoin_server_a-masternode.Tpo -c -o rpc/libbitcoin_server_a-masternode.o `test -f 'rpc/masternode.cpp' || echo '$(srcdir)/'`rpc/masternode.cpp
	$(AM_V_at)$(am__mv) rpc/$(DEPDIR)/libbitcoin_server_a-masternode.Tpo rpc/$(DEPDIR)/libbitcoin_server_a-masternode.Po
#	$(AM_V_CXX)source='rpc/masternode.cpp' object='rpc/libbitcoin_server_a-masternode.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -c -o rpc/libbitcoin_server_a-masternode.o `test -f 'rpc/masternode.cpp' || echo '$(srcdir)/'`rpc/masternode.cpp

rpc/libbitcoin_server_a-masternode.obj: rpc/masternode.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -MT rpc/libbitcoin_server_a-masternode.obj -MD -MP -MF rpc/$(DEPDIR)/libbitcoin_server_a-masternode.Tpo -c -o rpc/libbitcoin_server_a-masternode.obj `if test -f 'rpc/masternode.cpp'; then $(CYGPATH_W) 'rpc/masternode.cpp'; else $(CYGPATH_W) '$(srcdir)/rpc/masternode.cpp'; fi`
	$(AM_V_at)$(am__mv) rpc/$(DEPDIR)/libbitcoin_server_a-masternode.Tpo rpc/$(DEPDIR)/libbitcoin_server_a-masternode.Po
#	$(AM_V_CXX)source='rpc/masternode.cpp' object='rpc/libbitcoin_server_a-masternode.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -c -o rpc/libbitcoin_server_a-masternode.obj `if test -f 'rpc/masternode.cpp'; then $(CYGPATH_W) 'rpc/masternode.cpp'; else $(CYGPATH_W) '$(srcdir)/rpc/masternode.cpp'; fi`

rpc/libbitcoin_server_a-budget.o: rpc/budget.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -MT rpc/libbitcoin_server_a-budget.o -MD -MP -MF rpc/$(DEPDIR)/libbitcoin_server_a-budget.Tpo -c -o rpc/libbitcoin_server_a-budget.o `test -f 'rpc/budget.cpp' || echo '$(srcdir)/'`rpc/budget.cpp
	$(AM_V_at)$(am__mv) rpc/$(DEPDIR)/libbitcoin_server_a-budget.Tpo rpc/$(DEPDIR)/libbitcoin_server_a-budget.Po
#	$(AM_V_CXX)source='rpc/budget.cpp' object='rpc/libbitcoin_server_a-budget.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -c -o rpc/libbitcoin_server_a-budget.o `test -f 'rpc/budget.cpp' || echo '$(srcdir)/'`rpc/budget.cpp

rpc/libbitcoin_server_a-budget.obj: rpc/budget.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -MT rpc/libbitcoin_server_a-budget.obj -MD -MP -MF rpc/$(DEPDIR)/libbitcoin_server_a-budget.Tpo -c -o rpc/libbitcoin_server_a-budget.obj `if test -f 'rpc/budget.cpp'; then $(CYGPATH_W) 'rpc/budget.cpp'; else $(CYGPATH_W) '$(srcdir)/rpc/budget.cpp'; fi`
	$(AM_V_at)$(am__mv) rpc/$(DEPDIR)/libbitcoin_server_a-budget.Tpo rpc/$(DEPDIR)/libbitcoin_server_a-budget.Po
#	$(AM_V_CXX)source='rpc/budget.cpp' object='rpc/libbitcoin_server_a-budget.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -c -o rpc/libbitcoin_server_a-budget.obj `if test -f 'rpc/budget.cpp'; then $(CYGPATH_W) 'rpc/budget.cpp'; else $(CYGPATH_W) '$(srcdir)/rpc/budget.cpp'; fi`
...
libbitcoin_server_a-sporkdb.o: sporkdb.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_server_a-sporkdb.o -MD -MP -MF $(DEPDIR)/libbitcoin_server_a-sporkdb.Tpo -c -o libbitcoin_server_a-sporkdb.o `test -f 'sporkdb.cpp' || echo '$(srcdir)/'`sporkdb.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_server_a-sporkdb.o `test -f 'sporkdb.cpp' || echo '$(srcdir)/'`sporkdb.cpp

libbitcoin_server_a-sporkdb.obj: sporkdb.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_server_a-sporkdb.obj -MD -MP -MF $(DEPDIR)/libbitcoin_server_a-sporkdb.Tpo -c -o libbitcoin_server_a-sporkdb.obj `if test -f 'sporkdb.cpp'; then $(CYGPATH_W) 'sporkdb.cpp'; else $(CYGPATH_W) '$(srcdir)/sporkdb.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_server_a-sporkdb.Tpo $(DEPDIR)/libbitcoin_server_a-sporkdb.Po
#	$(AM_V_CXX)source='sporkdb.cpp' object='libbitcoin_server_a-sporkdb.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_server_a-sporkdb.obj `if test -f 'sporkdb.cpp'; then $(CYGPATH_W) 'sporkdb.cpp'; else $(CYGPATH_W) '$(srcdir)/sporkdb.cpp'; fi`
...
libbitcoin_server_a-zdenchain.o: zdenchain.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_server_a-zdenchain.o -MD -MP -MF $(DEPDIR)/libbitcoin_server_a-zdenchain.Tpo -c -o libbitcoin_server_a-zdenchain.o `test -f 'zdenchain.cpp' || echo '$(srcdir)/'`zdenchain.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_server_a-zdenchain.Tpo $(DEPDIR)/libbitcoin_server_a-zdenchain.Po
#	$(AM_V_CXX)source='zdenchain.cpp' object='libbitcoin_server_a-zdenchain.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_server_a-zdenchain.o `test -f 'zdenchain.cpp' || echo '$(srcdir)/'`zdenchain.cpp

libbitcoin_server_a-zdenchain.obj: zdenchain.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_server_a-zdenchain.obj -MD -MP -MF $(DEPDIR)/libbitcoin_server_a-zdenchain.Tpo -c -o libbitcoin_server_a-zdenchain.obj `if test -f 'zdenchain.cpp'; then $(CYGPATH_W) 'zdenchain.cpp'; else $(CYGPATH_W) '$(srcdir)/zdenchain.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_server_a-zdenchain.Tpo $(DEPDIR)/libbitcoin_server_a-zdenchain.Po
#	$(AM_V_CXX)source='zdenchain.cpp' object='libbitcoin_server_a-zdenchain.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_server_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_server_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_server_a-zdenchain.obj `if test -f 'zdenchain.cpp'; then $(CYGPATH_W) 'zdenchain.cpp'; else $(CYGPATH_W) '$(srcdir)/zdenchain.cpp'; fi`

libbitcoin_util_a-allocators.o: allocators.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_util_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_util_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_util_a-allocators.o -MD -MP -MF $(DEPDIR)/libbitcoin_util_a-allocators.Tpo -c -o libbitcoin_util_a-allocators.o `test -f 'allocators.cpp' || echo '$(srcdir)/'`allocators.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_util_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_util_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_util_a-allocators.o `test -f 'allocators.cpp' || echo '$(srcdir)/'`allocators.cpp

libbitcoin_util_a-allocators.obj: allocators.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_util_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_util_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_util_a-allocators.obj -MD -MP -MF $(DEPDIR)/libbitcoin_util_a-allocators.Tpo -c -o libbitcoin_util_a-allocators.obj `if test -f 'allocators.cpp'; then $(CYGPATH_W) 'allocators.cpp'; else $(CYGPATH_W) '$(srcdir)/allocators.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_util_a-allocators.Tpo $(DEPDIR)/libbitcoin_util_a-allocators.Po
#	$(AM_V_CXX)source='allocators.cpp' object='libbitcoin_util_a-allocators.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_util_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_util_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_util_a-allocators.obj `if test -f 'allocators.cpp'; then $(CYGPATH_W) 'allocators.cpp'; else $(CYGPATH_W) '$(srcdir)/allocators.cpp'; fi`
...
libbitcoin_wallet_a-activemasternode.o: activemasternode.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-activemasternode.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-activemasternode.Tpo -c -o libbitcoin_wallet_a-activemasternode.o `test -f 'activemasternode.cpp' || echo '$(srcdir)/'`activemasternode.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-activemasternode.o `test -f 'activemasternode.cpp' || echo '$(srcdir)/'`activemasternode.cpp

libbitcoin_wallet_a-activemasternode.obj: activemasternode.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-activemasternode.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-activemasternode.Tpo -c -o libbitcoin_wallet_a-activemasternode.obj `if test -f 'activemasternode.cpp'; then $(CYGPATH_W) 'activemasternode.cpp'; else $(CYGPATH_W) '$(srcdir)/activemasternode.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-activemasternode.Tpo $(DEPDIR)/libbitcoin_wallet_a-activemasternode.Po
#	$(AM_V_CXX)source='activemasternode.cpp' object='libbitcoin_wallet_a-activemasternode.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-activemasternode.obj `if test -f 'activemasternode.cpp'; then $(CYGPATH_W) 'activemasternode.cpp'; else $(CYGPATH_W) '$(srcdir)/activemasternode.cpp'; fi`

libbitcoin_wallet_a-bip38.o: bip38.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-bip38.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-bip38.Tpo -c -o libbitcoin_wallet_a-bip38.o `test -f 'bip38.cpp' || echo '$(srcdir)/'`bip38.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-bip38.o `test -f 'bip38.cpp' || echo '$(srcdir)/'`bip38.cpp

libbitcoin_wallet_a-bip38.obj: bip38.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-bip38.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-bip38.Tpo -c -o libbitcoin_wallet_a-bip38.obj `if test -f 'bip38.cpp'; then $(CYGPATH_W) 'bip38.cpp'; else $(CYGPATH_W) '$(srcdir)/bip38.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-bip38.Tpo $(DEPDIR)/libbitcoin_wallet_a-bip38.Po
#	$(AM_V_CXX)source='bip38.cpp' object='libbitcoin_wallet_a-bip38.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-bip38.obj `if test -f 'bip38.cpp'; then $(CYGPATH_W) 'bip38.cpp'; else $(CYGPATH_W) '$(srcdir)/bip38.cpp'; fi`

libbitcoin_wallet_a-denomination_functions.o: denomination_functions.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-denomination_functions.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-denomination_functions.Tpo -c -o libbitcoin_wallet_a-denomination_functions.o `test -f 'denomination_functions.cpp' || echo '$(srcdir)/'`denomination_functions.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-denomination_functions.o `test -f 'denomination_functions.cpp' || echo '$(srcdir)/'`denomination_functions.cpp

libbitcoin_wallet_a-denomination_functions.obj: denomination_functions.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-denomination_functions.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-denomination_functions.Tpo -c -o libbitcoin_wallet_a-denomination_functions.obj `if test -f 'denomination_functions.cpp'; then $(CYGPATH_W) 'denomination_functions.cpp'; else $(CYGPATH_W) '$(srcdir)/denomination_functions.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-denomination_functions.Tpo $(DEPDIR)/libbitcoin_wallet_a-denomination_functions.Po
#	$(AM_V_CXX)source='denomination_functions.cpp' object='libbitcoin_wallet_a-denomination_functions.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-denomination_functions.obj `if test -f 'denomination_functions.cpp'; then $(CYGPATH_W) 'denomination_functions.cpp'; else $(CYGPATH_W) '$(srcdir)/denomination_functions.cpp'; fi`

libbitcoin_wallet_a-obfuscation.o: obfuscation.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-obfuscation.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-obfuscation.Tpo -c -o libbitcoin_wallet_a-obfuscation.o `test -f 'obfuscation.cpp' || echo '$(srcdir)/'`obfuscation.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-obfuscation.o `test -f 'obfuscation.cpp' || echo '$(srcdir)/'`obfuscation.cpp

libbitcoin_wallet_a-obfuscation.obj: obfuscation.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-obfuscation.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-obfuscation.Tpo -c -o libbitcoin_wallet_a-obfuscation.obj `if test -f 'obfuscation.cpp'; then $(CYGPATH_W) 'obfuscation.cpp'; else $(CYGPATH_W) '$(srcdir)/obfuscation.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-obfuscation.Tpo $(DEPDIR)/libbitcoin_wallet_a-obfuscation.Po
#	$(AM_V_CXX)source='obfuscation.cpp' object='libbitcoin_wallet_a-obfuscation.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-obfuscation.obj `if test -f 'obfuscation.cpp'; then $(CYGPATH_W) 'obfuscation.cpp'; else $(CYGPATH_W) '$(srcdir)/obfuscation.cpp'; fi`

libbitcoin_wallet_a-obfuscation-relay.o: obfuscation-relay.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-obfuscation-relay.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-obfuscation-relay.Tpo -c -o libbitcoin_wallet_a-obfuscation-relay.o `test -f 'obfuscation-relay.cpp' || echo '$(srcdir)/'`obfuscation-relay.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-obfuscation-relay.o `test -f 'obfuscation-relay.cpp' || echo '$(srcdir)/'`obfuscation-relay.cpp

libbitcoin_wallet_a-obfuscation-relay.obj: obfuscation-relay.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-obfuscation-relay.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-obfuscation-relay.Tpo -c -o libbitcoin_wallet_a-obfuscation-relay.obj `if test -f 'obfuscation-relay.cpp'; then $(CYGPATH_W) 'obfuscation-relay.cpp'; else $(CYGPATH_W) '$(srcdir)/obfuscation-relay.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-obfuscation-relay.Tpo $(DEPDIR)/libbitcoin_wallet_a-obfuscation-relay.Po
#	$(AM_V_CXX)source='obfuscation-relay.cpp' object='libbitcoin_wallet_a-obfuscation-relay.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-obfuscation-relay.obj `if test -f 'obfuscation-relay.cpp'; then $(CYGPATH_W) 'obfuscation-relay.cpp'; else $(CYGPATH_W) '$(srcdir)/obfuscation-relay.cpp'; fi`
...
libbitcoin_wallet_a-crypter.o: crypter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-crypter.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-crypter.Tpo -c -o libbitcoin_wallet_a-crypter.o `test -f 'crypter.cpp' || echo '$(srcdir)/'`crypter.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-crypter.o `test -f 'crypter.cpp' || echo '$(srcdir)/'`crypter.cpp

libbitcoin_wallet_a-crypter.obj: crypter.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-crypter.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-crypter.Tpo -c -o libbitcoin_wallet_a-crypter.obj `if test -f 'crypter.cpp'; then $(CYGPATH_W) 'crypter.cpp'; else $(CYGPATH_W) '$(srcdir)/crypter.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-crypter.Tpo $(DEPDIR)/libbitcoin_wallet_a-crypter.Po
#	$(AM_V_CXX)source='crypter.cpp' object='libbitcoin_wallet_a-crypter.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-crypter.obj `if test -f 'crypter.cpp'; then $(CYGPATH_W) 'crypter.cpp'; else $(CYGPATH_W) '$(srcdir)/crypter.cpp'; fi`

libbitcoin_wallet_a-swifttx.o: swifttx.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-swifttx.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-swifttx.Tpo -c -o libbitcoin_wallet_a-swifttx.o `test -f 'swifttx.cpp' || echo '$(srcdir)/'`swifttx.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-swifttx.o `test -f 'swifttx.cpp' || echo '$(srcdir)/'`swifttx.cpp

libbitcoin_wallet_a-swifttx.obj: swifttx.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-swifttx.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-swifttx.Tpo -c -o libbitcoin_wallet_a-swifttx.obj `if test -f 'swifttx.cpp'; then $(CYGPATH_W) 'swifttx.cpp'; else $(CYGPATH_W) '$(srcdir)/swifttx.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-swifttx.Tpo $(DEPDIR)/libbitcoin_wallet_a-swifttx.Po
#	$(AM_V_CXX)source='swifttx.cpp' object='libbitcoin_wallet_a-swifttx.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-swifttx.obj `if test -f 'swifttx.cpp'; then $(CYGPATH_W) 'swifttx.cpp'; else $(CYGPATH_W) '$(srcdir)/swifttx.cpp'; fi`

libbitcoin_wallet_a-masternode.o: masternode.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternode.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternode.Tpo -c -o libbitcoin_wallet_a-masternode.o `test -f 'masternode.cpp' || echo '$(srcdir)/'`masternode.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternode.o `test -f 'masternode.cpp' || echo '$(srcdir)/'`masternode.cpp

libbitcoin_wallet_a-masternode.obj: masternode.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternode.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternode.Tpo -c -o libbitcoin_wallet_a-masternode.obj `if test -f 'masternode.cpp'; then $(CYGPATH_W) 'masternode.cpp'; else $(CYGPATH_W) '$(srcdir)/masternode.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-masternode.Tpo $(DEPDIR)/libbitcoin_wallet_a-masternode.Po
#	$(AM_V_CXX)source='masternode.cpp' object='libbitcoin_wallet_a-masternode.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternode.obj `if test -f 'masternode.cpp'; then $(CYGPATH_W) 'masternode.cpp'; else $(CYGPATH_W) '$(srcdir)/masternode.cpp'; fi`

libbitcoin_wallet_a-masternode-budget.o: masternode-budget.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternode-budget.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternode-budget.Tpo -c -o libbitcoin_wallet_a-masternode-budget.o `test -f 'masternode-budget.cpp' || echo '$(srcdir)/'`masternode-budget.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternode-budget.o `test -f 'masternode-budget.cpp' || echo '$(srcdir)/'`masternode-budget.cpp

libbitcoin_wallet_a-masternode-budget.obj: masternode-budget.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternode-budget.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternode-budget.Tpo -c -o libbitcoin_wallet_a-masternode-budget.obj `if test -f 'masternode-budget.cpp'; then $(CYGPATH_W) 'masternode-budget.cpp'; else $(CYGPATH_W) '$(srcdir)/masternode-budget.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-masternode-budget.Tpo $(DEPDIR)/libbitcoin_wallet_a-masternode-budget.Po
#	$(AM_V_CXX)source='masternode-budget.cpp' object='libbitcoin_wallet_a-masternode-budget.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternode-budget.obj `if test -f 'masternode-budget.cpp'; then $(CYGPATH_W) 'masternode-budget.cpp'; else $(CYGPATH_W) '$(srcdir)/masternode-budget.cpp'; fi`

libbitcoin_wallet_a-masternode-payments.o: masternode-payments.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternode-payments.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternode-payments.Tpo -c -o libbitcoin_wallet_a-masternode-payments.o `test -f 'masternode-payments.cpp' || echo '$(srcdir)/'`masternode-payments.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternode-payments.o `test -f 'masternode-payments.cpp' || echo '$(srcdir)/'`masternode-payments.cpp

libbitcoin_wallet_a-masternode-payments.obj: masternode-payments.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternode-payments.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternode-payments.Tpo -c -o libbitcoin_wallet_a-masternode-payments.obj `if test -f 'masternode-payments.cpp'; then $(CYGPATH_W) 'masternode-payments.cpp'; else $(CYGPATH_W) '$(srcdir)/masternode-payments.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-masternode-payments.Tpo $(DEPDIR)/libbitcoin_wallet_a-masternode-payments.Po
#	$(AM_V_CXX)source='masternode-payments.cpp' object='libbitcoin_wallet_a-masternode-payments.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternode-payments.obj `if test -f 'masternode-payments.cpp'; then $(CYGPATH_W) 'masternode-payments.cpp'; else $(CYGPATH_W) '$(srcdir)/masternode-payments.cpp'; fi`

libbitcoin_wallet_a-masternode-sync.o: masternode-sync.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternode-sync.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternode-sync.Tpo -c -o libbitcoin_wallet_a-masternode-sync.o `test -f 'masternode-sync.cpp' || echo '$(srcdir)/'`masternode-sync.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternode-sync.o `test -f 'masternode-sync.cpp' || echo '$(srcdir)/'`masternode-sync.cpp

libbitcoin_wallet_a-masternode-sync.obj: masternode-sync.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternode-sync.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternode-sync.Tpo -c -o libbitcoin_wallet_a-masternode-sync.obj `if test -f 'masternode-sync.cpp'; then $(CYGPATH_W) 'masternode-sync.cpp'; else $(CYGPATH_W) '$(srcdir)/masternode-sync.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-masternode-sync.Tpo $(DEPDIR)/libbitcoin_wallet_a-masternode-sync.Po
#	$(AM_V_CXX)source='masternode-sync.cpp' object='libbitcoin_wallet_a-masternode-sync.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternode-sync.obj `if test -f 'masternode-sync.cpp'; then $(CYGPATH_W) 'masternode-sync.cpp'; else $(CYGPATH_W) '$(srcdir)/masternode-sync.cpp'; fi`

libbitcoin_wallet_a-masternodeconfig.o: masternodeconfig.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternodeconfig.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternodeconfig.Tpo -c -o libbitcoin_wallet_a-masternodeconfig.o `test -f 'masternodeconfig.cpp' || echo '$(srcdir)/'`masternodeconfig.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternodeconfig.o `test -f 'masternodeconfig.cpp' || echo '$(srcdir)/'`masternodeconfig.cpp

libbitcoin_wallet_a-masternodeconfig.obj: masternodeconfig.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternodeconfig.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternodeconfig.Tpo -c -o libbitcoin_wallet_a-masternodeconfig.obj `if test -f 'masternodeconfig.cpp'; then $(CYGPATH_W) 'masternodeconfig.cpp'; else $(CYGPATH_W) '$(srcdir)/masternodeconfig.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-masternodeconfig.Tpo $(DEPDIR)/libbitcoin_wallet_a-masternodeconfig.Po
#	$(AM_V_CXX)source='masternodeconfig.cpp' object='libbitcoin_wallet_a-masternodeconfig.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternodeconfig.obj `if test -f 'masternodeconfig.cpp'; then $(CYGPATH_W) 'masternodeconfig.cpp'; else $(CYGPATH_W) '$(srcdir)/masternodeconfig.cpp'; fi`

libbitcoin_wallet_a-masternodeman.o: masternodeman.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternodeman.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternodeman.Tpo -c -o libbitcoin_wallet_a-masternodeman.o `test -f 'masternodeman.cpp' || echo '$(srcdir)/'`masternodeman.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternodeman.o `test -f 'masternodeman.cpp' || echo '$(srcdir)/'`masternodeman.cpp

libbitcoin_wallet_a-masternodeman.obj: masternodeman.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-masternodeman.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-masternodeman.Tpo -c -o libbitcoin_wallet_a-masternodeman.obj `if test -f 'masternodeman.cpp'; then $(CYGPATH_W) 'masternodeman.cpp'; else $(CYGPATH_W) '$(srcdir)/masternodeman.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-masternodeman.Tpo $(DEPDIR)/libbitcoin_wallet_a-masternodeman.Po
#	$(AM_V_CXX)source='masternodeman.cpp' object='libbitcoin_wallet_a-masternodeman.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-masternodeman.obj `if test -f 'masternodeman.cpp'; then $(CYGPATH_W) 'masternodeman.cpp'; else $(CYGPATH_W) '$(srcdir)/masternodeman.cpp'; fi`
...
libbitcoin_wallet_a-kernel.o: kernel.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-kernel.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-kernel.Tpo -c -o libbitcoin_wallet_a-kernel.o `test -f 'kernel.cpp' || echo '$(srcdir)/'`kernel.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-kernel.o `test -f 'kernel.cpp' || echo '$(srcdir)/'`kernel.cpp

libbitcoin_wallet_a-kernel.obj: kernel.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-kernel.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-kernel.Tpo -c -o libbitcoin_wallet_a-kernel.obj `if test -f 'kernel.cpp'; then $(CYGPATH_W) 'kernel.cpp'; else $(CYGPATH_W) '$(srcdir)/kernel.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-kernel.Tpo $(DEPDIR)/libbitcoin_wallet_a-kernel.Po
#	$(AM_V_CXX)source='kernel.cpp' object='libbitcoin_wallet_a-kernel.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-kernel.obj `if test -f 'kernel.cpp'; then $(CYGPATH_W) 'kernel.cpp'; else $(CYGPATH_W) '$(srcdir)/kernel.cpp'; fi`
...
zden/libbitcoin_wallet_a-deterministicmint.o: zden/deterministicmint.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-deterministicmint.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-deterministicmint.Tpo -c -o zden/libbitcoin_wallet_a-deterministicmint.o `test -f 'zden/deterministicmint.cpp' || echo '$(srcdir)/'`zden/deterministicmint.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-deterministicmint.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-deterministicmint.Po
#	$(AM_V_CXX)source='zden/deterministicmint.cpp' object='zden/libbitcoin_wallet_a-deterministicmint.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-deterministicmint.o `test -f 'zden/deterministicmint.cpp' || echo '$(srcdir)/'`zden/deterministicmint.cpp

zden/libbitcoin_wallet_a-deterministicmint.obj: zden/deterministicmint.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-deterministicmint.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-deterministicmint.Tpo -c -o zden/libbitcoin_wallet_a-deterministicmint.obj `if test -f 'zden/deterministicmint.cpp'; then $(CYGPATH_W) 'zden/deterministicmint.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/deterministicmint.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-deterministicmint.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-deterministicmint.Po
#	$(AM_V_CXX)source='zden/deterministicmint.cpp' object='zden/libbitcoin_wallet_a-deterministicmint.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-deterministicmint.obj `if test -f 'zden/deterministicmint.cpp'; then $(CYGPATH_W) 'zden/deterministicmint.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/deterministicmint.cpp'; fi`

zden/libbitcoin_wallet_a-zerocoin.o: zden/zerocoin.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-zerocoin.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-zerocoin.Tpo -c -o zden/libbitcoin_wallet_a-zerocoin.o `test -f 'zden/zerocoin.cpp' || echo '$(srcdir)/'`zden/zerocoin.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-zerocoin.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-zerocoin.Po
#	$(AM_V_CXX)source='zden/zerocoin.cpp' object='zden/libbitcoin_wallet_a-zerocoin.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-zerocoin.o `test -f 'zden/zerocoin.cpp' || echo '$(srcdir)/'`zden/zerocoin.cpp

zden/libbitcoin_wallet_a-zerocoin.obj: zden/zerocoin.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-zerocoin.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-zerocoin.Tpo -c -o zden/libbitcoin_wallet_a-zerocoin.obj `if test -f 'zden/zerocoin.cpp'; then $(CYGPATH_W) 'zden/zerocoin.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/zerocoin.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-zerocoin.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-zerocoin.Po
#	$(AM_V_CXX)source='zden/zerocoin.cpp' object='zden/libbitcoin_wallet_a-zerocoin.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-zerocoin.obj `if test -f 'zden/zerocoin.cpp'; then $(CYGPATH_W) 'zden/zerocoin.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/zerocoin.cpp'; fi`

zden/libbitcoin_wallet_a-accumulators.o: zden/accumulators.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-accumulators.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-accumulators.Tpo -c -o zden/libbitcoin_wallet_a-accumulators.o `test -f 'zden/accumulators.cpp' || echo '$(srcdir)/'`zden/accumulators.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-accumulators.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-accumulators.Po
#	$(AM_V_CXX)source='zden/accumulators.cpp' object='zden/libbitcoin_wallet_a-accumulators.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-accumulators.o `test -f 'zden/accumulators.cpp' || echo '$(srcdir)/'`zden/accumulators.cpp

zden/libbitcoin_wallet_a-accumulators.obj: zden/accumulators.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-accumulators.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-accumulators.Tpo -c -o zden/libbitcoin_wallet_a-accumulators.obj `if test -f 'zden/accumulators.cpp'; then $(CYGPATH_W) 'zden/accumulators.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/accumulators.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-accumulators.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-accumulators.Po
#	$(AM_V_CXX)source='zden/accumulators.cpp' object='zden/libbitcoin_wallet_a-accumulators.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-accumulators.obj `if test -f 'zden/accumulators.cpp'; then $(CYGPATH_W) 'zden/accumulators.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/accumulators.cpp'; fi`

zden/libbitcoin_wallet_a-mintpool.o: zden/mintpool.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-mintpool.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-mintpool.Tpo -c -o zden/libbitcoin_wallet_a-mintpool.o `test -f 'zden/mintpool.cpp' || echo '$(srcdir)/'`zden/mintpool.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-mintpool.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-mintpool.Po
#	$(AM_V_CXX)source='zden/mintpool.cpp' object='zden/libbitcoin_wallet_a-mintpool.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-mintpool.o `test -f 'zden/mintpool.cpp' || echo '$(srcdir)/'`zden/mintpool.cpp

zden/libbitcoin_wallet_a-mintpool.obj: zden/mintpool.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-mintpool.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-mintpool.Tpo -c -o zden/libbitcoin_wallet_a-mintpool.obj `if test -f 'zden/mintpool.cpp'; then $(CYGPATH_W) 'zden/mintpool.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/mintpool.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-mintpool.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-mintpool.Po
#	$(AM_V_CXX)source='zden/mintpool.cpp' object='zden/libbitcoin_wallet_a-mintpool.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-mintpool.obj `if test -f 'zden/mintpool.cpp'; then $(CYGPATH_W) 'zden/mintpool.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/mintpool.cpp'; fi`

zden/libbitcoin_wallet_a-witness.o: zden/witness.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-witness.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-witness.Tpo -c -o zden/libbitcoin_wallet_a-witness.o `test -f 'zden/witness.cpp' || echo '$(srcdir)/'`zden/witness.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-witness.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-witness.Po
#	$(AM_V_CXX)source='zden/witness.cpp' object='zden/libbitcoin_wallet_a-witness.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-witness.o `test -f 'zden/witness.cpp' || echo '$(srcdir)/'`zden/witness.cpp

zden/libbitcoin_wallet_a-witness.obj: zden/witness.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-witness.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-witness.Tpo -c -o zden/libbitcoin_wallet_a-witness.obj `if test -f 'zden/witness.cpp'; then $(CYGPATH_W) 'zden/witness.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/witness.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-witness.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-witness.Po
#	$(AM_V_CXX)source='zden/witness.cpp' object='zden/libbitcoin_wallet_a-witness.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-witness.obj `if test -f 'zden/witness.cpp'; then $(CYGPATH_W) 'zden/witness.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/witness.cpp'; fi`

zden/libbitcoin_wallet_a-zdenwallet.o: zden/zdenwallet.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-zdenwallet.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-zdenwallet.Tpo -c -o zden/libbitcoin_wallet_a-zdenwallet.o `test -f 'zden/zdenwallet.cpp' || echo '$(srcdir)/'`zden/zdenwallet.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-zdenwallet.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-zdenwallet.Po
#	$(AM_V_CXX)source='zden/zdenwallet.cpp' object='zden/libbitcoin_wallet_a-zdenwallet.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-zdenwallet.o `test -f 'zden/zdenwallet.cpp' || echo '$(srcdir)/'`zden/zdenwallet.cpp

zden/libbitcoin_wallet_a-zdenwallet.obj: zden/zdenwallet.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-zdenwallet.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-zdenwallet.Tpo -c -o zden/libbitcoin_wallet_a-zdenwallet.obj `if test -f 'zden/zdenwallet.cpp'; then $(CYGPATH_W) 'zden/zdenwallet.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/zdenwallet.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-zdenwallet.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-zdenwallet.Po
#	$(AM_V_CXX)source='zden/zdenwallet.cpp' object='zden/libbitcoin_wallet_a-zdenwallet.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-zdenwallet.obj `if test -f 'zden/zdenwallet.cpp'; then $(CYGPATH_W) 'zden/zdenwallet.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/zdenwallet.cpp'; fi`

zden/libbitcoin_wallet_a-zdentracker.o: zden/zdentracker.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-zdentracker.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-zdentracker.Tpo -c -o zden/libbitcoin_wallet_a-zdentracker.o `test -f 'zden/zdentracker.cpp' || echo '$(srcdir)/'`zden/zdentracker.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-zdentracker.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-zdentracker.Po
#	$(AM_V_CXX)source='zden/zdentracker.cpp' object='zden/libbitcoin_wallet_a-zdentracker.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-zdentracker.o `test -f 'zden/zdentracker.cpp' || echo '$(srcdir)/'`zden/zdentracker.cpp

zden/libbitcoin_wallet_a-zdentracker.obj: zden/zdentracker.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-zdentracker.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-zdentracker.Tpo -c -o zden/libbitcoin_wallet_a-zdentracker.obj `if test -f 'zden/zdentracker.cpp'; then $(CYGPATH_W) 'zden/zdentracker.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/zdentracker.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-zdentracker.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-zdentracker.Po
#	$(AM_V_CXX)source='zden/zdentracker.cpp' object='zden/libbitcoin_wallet_a-zdentracker.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-zdentracker.obj `if test -f 'zden/zdentracker.cpp'; then $(CYGPATH_W) 'zden/zdentracker.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/zdentracker.cpp'; fi`

libbitcoin_wallet_a-stakeinput.o: stakeinput.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-stakeinput.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-stakeinput.Tpo -c -o libbitcoin_wallet_a-stakeinput.o `test -f 'stakeinput.cpp' || echo '$(srcdir)/'`stakeinput.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-stakeinput.Tpo $(DEPDIR)/libbitcoin_wallet_a-stakeinput.Po
#	$(AM_V_CXX)source='stakeinput.cpp' object='libbitcoin_wallet_a-stakeinput.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-stakeinput.o `test -f 'stakeinput.cpp' || echo '$(srcdir)/'`stakeinput.cpp

libbitcoin_wallet_a-stakeinput.obj: stakeinput.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-stakeinput.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-stakeinput.Tpo -c -o libbitcoin_wallet_a-stakeinput.obj `if test -f 'stakeinput.cpp'; then $(CYGPATH_W) 'stakeinput.cpp'; else $(CYGPATH_W) '$(srcdir)/stakeinput.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-stakeinput.Tpo $(DEPDIR)/libbitcoin_wallet_a-stakeinput.Po
#	$(AM_V_CXX)source='stakeinput.cpp' object='libbitcoin_wallet_a-stakeinput.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-stakeinput.obj `if test -f 'stakeinput.cpp'; then $(CYGPATH_W) 'stakeinput.cpp'; else $(CYGPATH_W) '$(srcdir)/stakeinput.cpp'; fi`

libbitcoin_wallet_a-genwit.o: genwit.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-genwit.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-genwit.Tpo -c -o libbitcoin_wallet_a-genwit.o `test -f 'genwit.cpp' || echo '$(srcdir)/'`genwit.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-genwit.Tpo $(DEPDIR)/libbitcoin_wallet_a-genwit.Po
#	$(AM_V_CXX)source='genwit.cpp' object='libbitcoin_wallet_a-genwit.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-genwit.o `test -f 'genwit.cpp' || echo '$(srcdir)/'`genwit.cpp

libbitcoin_wallet_a-genwit.obj: genwit.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-genwit.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-genwit.Tpo -c -o libbitcoin_wallet_a-genwit.obj `if test -f 'genwit.cpp'; then $(CYGPATH_W) 'genwit.cpp'; else $(CYGPATH_W) '$(srcdir)/genwit.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-genwit.Tpo $(DEPDIR)/libbitcoin_wallet_a-genwit.Po
#	$(AM_V_CXX)source='genwit.cpp' object='libbitcoin_wallet_a-genwit.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-genwit.obj `if test -f 'genwit.cpp'; then $(CYGPATH_W) 'genwit.cpp'; else $(CYGPATH_W) '$(srcdir)/genwit.cpp'; fi`

zden/libbitcoin_wallet_a-zdenmodule.o: zden/zdenmodule.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-zdenmodule.o -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-zdenmodule.Tpo -c -o zden/libbitcoin_wallet_a-zdenmodule.o `test -f 'zden/zdenmodule.cpp' || echo '$(srcdir)/'`zden/zdenmodule.cpp
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-zdenmodule.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-zdenmodule.Po
#	$(AM_V_CXX)source='zden/zdenmodule.cpp' object='zden/libbitcoin_wallet_a-zdenmodule.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-zdenmodule.o `test -f 'zden/zdenmodule.cpp' || echo '$(srcdir)/'`zden/zdenmodule.cpp

zden/libbitcoin_wallet_a-zdenmodule.obj: zden/zdenmodule.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT zden/libbitcoin_wallet_a-zdenmodule.obj -MD -MP -MF zden/$(DEPDIR)/libbitcoin_wallet_a-zdenmodule.Tpo -c -o zden/libbitcoin_wallet_a-zdenmodule.obj `if test -f 'zden/zdenmodule.cpp'; then $(CYGPATH_W) 'zden/zdenmodule.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/zdenmodule.cpp'; fi`
	$(AM_V_at)$(am__mv) zden/$(DEPDIR)/libbitcoin_wallet_a-zdenmodule.Tpo zden/$(DEPDIR)/libbitcoin_wallet_a-zdenmodule.Po
#	$(AM_V_CXX)source='zden/zdenmodule.cpp' object='zden/libbitcoin_wallet_a-zdenmodule.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o zden/libbitcoin_wallet_a-zdenmodule.obj `if test -f 'zden/zdenmodule.cpp'; then $(CYGPATH_W) 'zden/zdenmodule.cpp'; else $(CYGPATH_W) '$(srcdir)/zden/zdenmodule.cpp'; fi`

libbitcoin_wallet_a-lightzdenthread.o: lightzdenthread.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-lightzdenthread.o -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-lightzdenthread.Tpo -c -o libbitcoin_wallet_a-lightzdenthread.o `test -f 'lightzdenthread.cpp' || echo '$(srcdir)/'`lightzdenthread.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-lightzdenthread.Tpo $(DEPDIR)/libbitcoin_wallet_a-lightzdenthread.Po
#	$(AM_V_CXX)source='lightzdenthread.cpp' object='libbitcoin_wallet_a-lightzdenthread.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-lightzdenthread.o `test -f 'lightzdenthread.cpp' || echo '$(srcdir)/'`lightzdenthread.cpp

libbitcoin_wallet_a-lightzdenthread.obj: lightzdenthread.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -MT libbitcoin_wallet_a-lightzdenthread.obj -MD -MP -MF $(DEPDIR)/libbitcoin_wallet_a-lightzdenthread.Tpo -c -o libbitcoin_wallet_a-lightzdenthread.obj `if test -f 'lightzdenthread.cpp'; then $(CYGPATH_W) 'lightzdenthread.cpp'; else $(CYGPATH_W) '$(srcdir)/lightzdenthread.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/libbitcoin_wallet_a-lightzdenthread.Tpo $(DEPDIR)/libbitcoin_wallet_a-lightzdenthread.Po
#	$(AM_V_CXX)source='lightzdenthread.cpp' object='libbitcoin_wallet_a-lightzdenthread.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoin_wallet_a_CPPFLAGS) $(CPPFLAGS) $(libbitcoin_wallet_a_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoin_wallet_a-lightzdenthread.obj `if test -f 'lightzdenthread.cpp'; then $(CYGPATH_W) 'lightzdenthread.cpp'; else $(CYGPATH_W) '$(srcdir)/lightzdenthread.cpp'; fi`
...
libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.o: libzerocoin/bignum.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.o `test -f 'libzerocoin/bignum.cpp' || echo '$(srcdir)/'`libzerocoin/bignum.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum.Po
#	$(AM_V_CXX)source='libzerocoin/bignum.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.o `test -f 'libzerocoin/bignum.cpp' || echo '$(srcdir)/'`libzerocoin/bignum.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.obj: libzerocoin/bignum.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.obj `if test -f 'libzerocoin/bignum.cpp'; then $(CYGPATH_W) 'libzerocoin/bignum.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/bignum.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum.Po
#	$(AM_V_CXX)source='libzerocoin/bignum.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum.obj `if test -f 'libzerocoin/bignum.cpp'; then $(CYGPATH_W) 'libzerocoin/bignum.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/bignum.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.o: libzerocoin/Accumulator.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Accumulator.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.o `test -f 'libzerocoin/Accumulator.cpp' || echo '$(srcdir)/'`libzerocoin/Accumulator.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Accumulator.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Accumulator.Po
#	$(AM_V_CXX)source='libzerocoin/Accumulator.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.o `test -f 'libzerocoin/Accumulator.cpp' || echo '$(srcdir)/'`libzerocoin/Accumulator.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.obj: libzerocoin/Accumulator.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Accumulator.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.obj `if test -f 'libzerocoin/Accumulator.cpp'; then $(CYGPATH_W) 'libzerocoin/Accumulator.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/Accumulator.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Accumulator.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Accumulator.Po
#	$(AM_V_CXX)source='libzerocoin/Accumulator.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Accumulator.obj `if test -f 'libzerocoin/Accumulator.cpp'; then $(CYGPATH_W) 'libzerocoin/Accumulator.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/Accumulator.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.o: libzerocoin/AccumulatorProofOfKnowledge.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.o `test -f 'libzerocoin/AccumulatorProofOfKnowledge.cpp' || echo '$(srcdir)/'`libzerocoin/AccumulatorProofOfKnowledge.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.Po
#	$(AM_V_CXX)source='libzerocoin/AccumulatorProofOfKnowledge.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.o `test -f 'libzerocoin/AccumulatorProofOfKnowledge.cpp' || echo '$(srcdir)/'`libzerocoin/AccumulatorProofOfKnowledge.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.obj: libzerocoin/AccumulatorProofOfKnowledge.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.obj `if test -f 'libzerocoin/AccumulatorProofOfKnowledge.cpp'; then $(CYGPATH_W) 'libzerocoin/AccumulatorProofOfKnowledge.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/AccumulatorProofOfKnowledge.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.Po
#	$(AM_V_CXX)source='libzerocoin/AccumulatorProofOfKnowledge.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-AccumulatorProofOfKnowledge.obj `if test -f 'libzerocoin/AccumulatorProofOfKnowledge.cpp'; then $(CYGPATH_W) 'libzerocoin/AccumulatorProofOfKnowledge.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/AccumulatorProofOfKnowledge.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.o: libzerocoin/Coin.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Coin.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.o `test -f 'libzerocoin/Coin.cpp' || echo '$(srcdir)/'`libzerocoin/Coin.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Coin.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Coin.Po
#	$(AM_V_CXX)source='libzerocoin/Coin.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.o `test -f 'libzerocoin/Coin.cpp' || echo '$(srcdir)/'`libzerocoin/Coin.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.obj: libzerocoin/Coin.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Coin.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.obj `if test -f 'libzerocoin/Coin.cpp'; then $(CYGPATH_W) 'libzerocoin/Coin.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/Coin.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Coin.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Coin.Po
#	$(AM_V_CXX)source='libzerocoin/Coin.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Coin.obj `if test -f 'libzerocoin/Coin.cpp'; then $(CYGPATH_W) 'libzerocoin/Coin.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/Coin.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.o: libzerocoin/Denominations.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Denominations.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.o `test -f 'libzerocoin/Denominations.cpp' || echo '$(srcdir)/'`libzerocoin/Denominations.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Denominations.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Denominations.Po
#	$(AM_V_CXX)source='libzerocoin/Denominations.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.o `test -f 'libzerocoin/Denominations.cpp' || echo '$(srcdir)/'`libzerocoin/Denominations.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.obj: libzerocoin/Denominations.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Denominations.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.obj `if test -f 'libzerocoin/Denominations.cpp'; then $(CYGPATH_W) 'libzerocoin/Denominations.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/Denominations.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Denominations.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Denominations.Po
#	$(AM_V_CXX)source='libzerocoin/Denominations.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Denominations.obj `if test -f 'libzerocoin/Denominations.cpp'; then $(CYGPATH_W) 'libzerocoin/Denominations.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/Denominations.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.o: libzerocoin/CoinSpend.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.o `test -f 'libzerocoin/CoinSpend.cpp' || echo '$(srcdir)/'`libzerocoin/CoinSpend.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.Po
#	$(AM_V_CXX)source='libzerocoin/CoinSpend.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.o `test -f 'libzerocoin/CoinSpend.cpp' || echo '$(srcdir)/'`libzerocoin/CoinSpend.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.obj: libzerocoin/CoinSpend.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.obj `if test -f 'libzerocoin/CoinSpend.cpp'; then $(CYGPATH_W) 'libzerocoin/CoinSpend.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/CoinSpend.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.Po
#	$(AM_V_CXX)source='libzerocoin/CoinSpend.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-CoinSpend.obj `if test -f 'libzerocoin/CoinSpend.cpp'; then $(CYGPATH_W) 'libzerocoin/CoinSpend.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/CoinSpend.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.o: libzerocoin/Commitment.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Commitment.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.o `test -f 'libzerocoin/Commitment.cpp' || echo '$(srcdir)/'`libzerocoin/Commitment.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Commitment.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Commitment.Po
#	$(AM_V_CXX)source='libzerocoin/Commitment.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.o `test -f 'libzerocoin/Commitment.cpp' || echo '$(srcdir)/'`libzerocoin/Commitment.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.obj: libzerocoin/Commitment.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Commitment.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.obj `if test -f 'libzerocoin/Commitment.cpp'; then $(CYGPATH_W) 'libzerocoin/Commitment.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/Commitment.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Commitment.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Commitment.Po
#	$(AM_V_CXX)source='libzerocoin/Commitment.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Commitment.obj `if test -f 'libzerocoin/Commitment.cpp'; then $(CYGPATH_W) 'libzerocoin/Commitment.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/Commitment.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.o: libzerocoin/ParamGeneration.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.o `test -f 'libzerocoin/ParamGeneration.cpp' || echo '$(srcdir)/'`libzerocoin/ParamGeneration.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.Po
#	$(AM_V_CXX)source='libzerocoin/ParamGeneration.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.o `test -f 'libzerocoin/ParamGeneration.cpp' || echo '$(srcdir)/'`libzerocoin/ParamGeneration.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.obj: libzerocoin/ParamGeneration.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.obj `if test -f 'libzerocoin/ParamGeneration.cpp'; then $(CYGPATH_W) 'libzerocoin/ParamGeneration.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/ParamGeneration.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.Po
#	$(AM_V_CXX)source='libzerocoin/ParamGeneration.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-ParamGeneration.obj `if test -f 'libzerocoin/ParamGeneration.cpp'; then $(CYGPATH_W) 'libzerocoin/ParamGeneration.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/ParamGeneration.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.o: libzerocoin/Params.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Params.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.o `test -f 'libzerocoin/Params.cpp' || echo '$(srcdir)/'`libzerocoin/Params.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Params.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Params.Po
#	$(AM_V_CXX)source='libzerocoin/Params.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.o `test -f 'libzerocoin/Params.cpp' || echo '$(srcdir)/'`libzerocoin/Params.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.obj: libzerocoin/Params.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Params.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.obj `if test -f 'libzerocoin/Params.cpp'; then $(CYGPATH_W) 'libzerocoin/Params.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/Params.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Params.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-Params.Po
#	$(AM_V_CXX)source='libzerocoin/Params.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-Params.obj `if test -f 'libzerocoin/Params.cpp'; then $(CYGPATH_W) 'libzerocoin/Params.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/Params.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.o: libzerocoin/SerialNumberSignatureOfKnowledge.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.o `test -f 'libzerocoin/SerialNumberSignatureOfKnowledge.cpp' || echo '$(srcdir)/'`libzerocoin/SerialNumberSignatureOfKnowledge.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.Po
#	$(AM_V_CXX)source='libzerocoin/SerialNumberSignatureOfKnowledge.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.o `test -f 'libzerocoin/SerialNumberSignatureOfKnowledge.cpp' || echo '$(srcdir)/'`libzerocoin/SerialNumberSignatureOfKnowledge.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.obj: libzerocoin/SerialNumberSignatureOfKnowledge.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.obj `if test -f 'libzerocoin/SerialNumberSignatureOfKnowledge.cpp'; then $(CYGPATH_W) 'libzerocoin/SerialNumberSignatureOfKnowledge.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/SerialNumberSignatureOfKnowledge.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.Po
#	$(AM_V_CXX)source='libzerocoin/SerialNumberSignatureOfKnowledge.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-SerialNumberSignatureOfKnowledge.obj `if test -f 'libzerocoin/SerialNumberSignatureOfKnowledge.cpp'; then $(CYGPATH_W) 'libzerocoin/SerialNumberSignatureOfKnowledge.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/SerialNumberSignatureOfKnowledge.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.o: libzerocoin/bignum_gmp.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.o `test -f 'libzerocoin/bignum_gmp.cpp' || echo '$(srcdir)/'`libzerocoin/bignum_gmp.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.Po
#	$(AM_V_CXX)source='libzerocoin/bignum_gmp.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.o `test -f 'libzerocoin/bignum_gmp.cpp' || echo '$(srcdir)/'`libzerocoin/bignum_gmp.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.obj: libzerocoin/bignum_gmp.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.obj `if test -f 'libzerocoin/bignum_gmp.cpp'; then $(CYGPATH_W) 'libzerocoin/bignum_gmp.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/bignum_gmp.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.Po
#	$(AM_V_CXX)source='libzerocoin/bignum_gmp.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_gmp.obj `if test -f 'libzerocoin/bignum_gmp.cpp'; then $(CYGPATH_W) 'libzerocoin/bignum_gmp.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/bignum_gmp.cpp'; fi`

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.o: libzerocoin/bignum_openssl.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.o -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.o `test -f 'libzerocoin/bignum_openssl.cpp' || echo '$(srcdir)/'`libzerocoin/bignum_openssl.cpp
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.Po
#	$(AM_V_CXX)source='libzerocoin/bignum_openssl.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.o `test -f 'libzerocoin/bignum_openssl.cpp' || echo '$(srcdir)/'`libzerocoin/bignum_openssl.cpp

libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.obj: libzerocoin/bignum_openssl.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -MT libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.obj -MD -MP -MF libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.Tpo -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.obj `if test -f 'libzerocoin/bignum_openssl.cpp'; then $(CYGPATH_W) 'libzerocoin/bignum_openssl.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/bignum_openssl.cpp'; fi`
	$(AM_V_at)$(am__mv) libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.Tpo libzerocoin/$(DEPDIR)/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.Po
#	$(AM_V_CXX)source='libzerocoin/bignum_openssl.cpp' object='libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libzerocoin_libbitcoin_zerocoin_a_CPPFLAGS) $(CPPFLAGS) $(libzerocoin_libbitcoin_zerocoin_a_CXXFLAGS) $(CXXFLAGS) -c -o libzerocoin/libzerocoin_libbitcoin_zerocoin_a-bignum_openssl.obj `if test -f 'libzerocoin/bignum_openssl.cpp'; then $(CYGPATH_W) 'libzerocoin/bignum_openssl.cpp'; else $(CYGPATH_W) '$(srcdir)/libzerocoin/bignum_openssl.cpp'; fi`
...
qt/qt_libbitcoinqt_a-blockexplorer.o: qt/blockexplorer.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-blockexplorer.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-blockexplorer.Tpo -c -o qt/qt_libbitcoinqt_a-blockexplorer.o `test -f 'qt/blockexplorer.cpp' || echo '$(srcdir)/'`qt/blockexplorer.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-blockexplorer.o `test -f 'qt/blockexplorer.cpp' || echo '$(srcdir)/'`qt/blockexplorer.cpp

qt/qt_libbitcoinqt_a-blockexplorer.obj: qt/blockexplorer.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-blockexplorer.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-blockexplorer.Tpo -c -o qt/qt_libbitcoinqt_a-blockexplorer.obj `if test -f 'qt/blockexplorer.cpp'; then $(CYGPATH_W) 'qt/blockexplorer.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/blockexplorer.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-blockexplorer.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-blockexplorer.Po
#	$(AM_V_CXX)source='qt/blockexplorer.cpp' object='qt/qt_libbitcoinqt_a-blockexplorer.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-blockexplorer.obj `if test -f 'qt/blockexplorer.cpp'; then $(CYGPATH_W) 'qt/blockexplorer.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/blockexplorer.cpp'; fi`
...
qt/qt_libbitcoinqt_a-masternodelist.o: qt/masternodelist.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-masternodelist.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-masternodelist.Tpo -c -o qt/qt_libbitcoinqt_a-masternodelist.o `test -f 'qt/masternodelist.cpp' || echo '$(srcdir)/'`qt/masternodelist.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-masternodelist.o `test -f 'qt/masternodelist.cpp' || echo '$(srcdir)/'`qt/masternodelist.cpp

qt/qt_libbitcoinqt_a-masternodelist.obj: qt/masternodelist.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-masternodelist.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-masternodelist.Tpo -c -o qt/qt_libbitcoinqt_a-masternodelist.obj `if test -f 'qt/masternodelist.cpp'; then $(CYGPATH_W) 'qt/masternodelist.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/masternodelist.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-masternodelist.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-masternodelist.Po
#	$(AM_V_CXX)source='qt/masternodelist.cpp' object='qt/qt_libbitcoinqt_a-masternodelist.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-masternodelist.obj `if test -f 'qt/masternodelist.cpp'; then $(CYGPATH_W) 'qt/masternodelist.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/masternodelist.cpp'; fi`
...
qt/qt_libbitcoinqt_a-bip38tooldialog.o: qt/bip38tooldialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-bip38tooldialog.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-bip38tooldialog.Tpo -c -o qt/qt_libbitcoinqt_a-bip38tooldialog.o `test -f 'qt/bip38tooldialog.cpp' || echo '$(srcdir)/'`qt/bip38tooldialog.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-bip38tooldialog.o `test -f 'qt/bip38tooldialog.cpp' || echo '$(srcdir)/'`qt/bip38tooldialog.cpp

qt/qt_libbitcoinqt_a-bip38tooldialog.obj: qt/bip38tooldialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-bip38tooldialog.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-bip38tooldialog.Tpo -c -o qt/qt_libbitcoinqt_a-bip38tooldialog.obj `if test -f 'qt/bip38tooldialog.cpp'; then $(CYGPATH_W) 'qt/bip38tooldialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/bip38tooldialog.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-bip38tooldialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-bip38tooldialog.Po
#	$(AM_V_CXX)source='qt/bip38tooldialog.cpp' object='qt/qt_libbitcoinqt_a-bip38tooldialog.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-bip38tooldialog.obj `if test -f 'qt/bip38tooldialog.cpp'; then $(CYGPATH_W) 'qt/bip38tooldialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/bip38tooldialog.cpp'; fi`
...
qt/qt_libbitcoinqt_a-governancepage.o: qt/governancepage.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-governancepage.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-governancepage.Tpo -c -o qt/qt_libbitcoinqt_a-governancepage.o `test -f 'qt/governancepage.cpp' || echo '$(srcdir)/'`qt/governancepage.cpp
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-governancepage.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-governancepage.Po
#	$(AM_V_CXX)source='qt/governancepage.cpp' object='qt/qt_libbitcoinqt_a-governancepage.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-governancepage.o `test -f 'qt/governancepage.cpp' || echo '$(srcdir)/'`qt/governancepage.cpp

qt/qt_libbitcoinqt_a-governancepage.obj: qt/governancepage.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-governancepage.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-governancepage.Tpo -c -o qt/qt_libbitcoinqt_a-governancepage.obj `if test -f 'qt/governancepage.cpp'; then $(CYGPATH_W) 'qt/governancepage.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/governancepage.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-governancepage.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-governancepage.Po
#	$(AM_V_CXX)source='qt/governancepage.cpp' object='qt/qt_libbitcoinqt_a-governancepage.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-governancepage.obj `if test -f 'qt/governancepage.cpp'; then $(CYGPATH_W) 'qt/governancepage.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/governancepage.cpp'; fi`

qt/qt_libbitcoinqt_a-multisenddialog.o: qt/multisenddialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-multisenddialog.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-multisenddialog.Tpo -c -o qt/qt_libbitcoinqt_a-multisenddialog.o `test -f 'qt/multisenddialog.cpp' || echo '$(srcdir)/'`qt/multisenddialog.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-multisenddialog.o `test -f 'qt/multisenddialog.cpp' || echo '$(srcdir)/'`qt/multisenddialog.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-multisenddialog.obj `if test -f 'qt/multisenddialog.cpp'; then $(CYGPATH_W) 'qt/multisenddialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/multisenddialog.cpp'; fi`

qt/qt_libbitcoinqt_a-multisigdialog.o: qt/multisigdialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-multisigdialog.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-multisigdialog.Tpo -c -o qt/qt_libbitcoinqt_a-multisigdialog.o `test -f 'qt/multisigdialog.cpp' || echo '$(srcdir)/'`qt/multisigdialog.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-multisigdialog.o `test -f 'qt/multisigdialog.cpp' || echo '$(srcdir)/'`qt/multisigdialog.cpp

qt/qt_libbitcoinqt_a-multisigdialog.obj: qt/multisigdialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-multisigdialog.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-multisigdialog.Tpo -c -o qt/qt_libbitcoinqt_a-multisigdialog.obj `if test -f 'qt/multisigdialog.cpp'; then $(CYGPATH_W) 'qt/multisigdialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/multisigdialog.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-multisigdialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-multisigdialog.Po
#	$(AM_V_CXX)source='qt/multisigdialog.cpp' object='qt/qt_libbitcoinqt_a-multisigdialog.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-multisigdialog.obj `if test -f 'qt/multisigdialog.cpp'; then $(CYGPATH_W) 'qt/multisigdialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/multisigdialog.cpp'; fi`
...
qt/qt_libbitcoinqt_a-privacydialog.o: qt/privacydialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-privacydialog.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-privacydialog.Tpo -c -o qt/qt_libbitcoinqt_a-privacydialog.o `test -f 'qt/privacydialog.cpp' || echo '$(srcdir)/'`qt/privacydialog.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-privacydialog.o `test -f 'qt/privacydialog.cpp' || echo '$(srcdir)/'`qt/privacydialog.cpp

qt/qt_libbitcoinqt_a-privacydialog.obj: qt/privacydialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-privacydialog.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-privacydialog.Tpo -c -o qt/qt_libbitcoinqt_a-privacydialog.obj `if test -f 'qt/privacydialog.cpp'; then $(CYGPATH_W) 'qt/privacydialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/privacydialog.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-privacydialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-privacydialog.Po
#	$(AM_V_CXX)source='qt/privacydialog.cpp' object='qt/qt_libbitcoinqt_a-privacydialog.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-privacydialog.obj `if test -f 'qt/privacydialog.cpp'; then $(CYGPATH_W) 'qt/privacydialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/privacydialog.cpp'; fi`

qt/qt_libbitcoinqt_a-proposalframe.o: qt/proposalframe.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-proposalframe.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-proposalframe.Tpo -c -o qt/qt_libbitcoinqt_a-proposalframe.o `test -f 'qt/proposalframe.cpp' || echo '$(srcdir)/'`qt/proposalframe.cpp
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-proposalframe.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-proposalframe.Po
#	$(AM_V_CXX)source='qt/proposalframe.cpp' object='qt/qt_libbitcoinqt_a-proposalframe.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-proposalframe.o `test -f 'qt/proposalframe.cpp' || echo '$(srcdir)/'`qt/proposalframe.cpp

qt/qt_libbitcoinqt_a-proposalframe.obj: qt/proposalframe.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-proposalframe.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-proposalframe.Tpo -c -o qt/qt_libbitcoinqt_a-proposalframe.obj `if test -f 'qt/proposalframe.cpp'; then $(CYGPATH_W) 'qt/proposalframe.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/proposalframe.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-proposalframe.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-proposalframe.Po
#	$(AM_V_CXX)source='qt/proposalframe.cpp' object='qt/qt_libbitcoinqt_a-proposalframe.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-proposalframe.obj `if test -f 'qt/proposalframe.cpp'; then $(CYGPATH_W) 'qt/proposalframe.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/proposalframe.cpp'; fi`
...
qt/qt_libbitcoinqt_a-zdencontroldialog.o: qt/zdencontroldialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-zdencontroldialog.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-zdencontroldialog.Tpo -c -o qt/qt_libbitcoinqt_a-zdencontroldialog.o `test -f 'qt/zdencontroldialog.cpp' || echo '$(srcdir)/'`qt/zdencontroldialog.cpp
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-zdencontroldialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-zdencontroldialog.Po
#	$(AM_V_CXX)source='qt/zdencontroldialog.cpp' object='qt/qt_libbitcoinqt_a-zdencontroldialog.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-zdencontroldialog.o `test -f 'qt/zdencontroldialog.cpp' || echo '$(srcdir)/'`qt/zdencontroldialog.cpp

qt/qt_libbitcoinqt_a-zdencontroldialog.obj: qt/zdencontroldialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-zdencontroldialog.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-zdencontroldialog.Tpo -c -o qt/qt_libbitcoinqt_a-zdencontroldialog.obj `if test -f 'qt/zdencontroldialog.cpp'; then $(CYGPATH_W) 'qt/zdencontroldialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/zdencontroldialog.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-zdencontroldialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-zdencontroldialog.Po
#	$(AM_V_CXX)source='qt/zdencontroldialog.cpp' object='qt/qt_libbitcoinqt_a-zdencontroldialog.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-zdencontroldialog.obj `if test -f 'qt/zdencontroldialog.cpp'; then $(CYGPATH_W) 'qt/zdencontroldialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/zdencontroldialog.cpp'; fi`
...
qt/qt_libbitcoinqt_a-moc_bip38tooldialog.o: qt/moc_bip38tooldialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_bip38tooldialog.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_bip38tooldialog.Tpo -c -o qt/qt_libbitcoinqt_a-moc_bip38tooldialog.o `test -f 'qt/moc_bip38tooldialog.cpp' || echo '$(srcdir)/'`qt/moc_bip38tooldialog.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_bip38tooldialog.o `test -f 'qt/moc_bip38tooldialog.cpp' || echo '$(srcdir)/'`qt/moc_bip38tooldialog.cpp

qt/qt_libbitcoinqt_a-moc_bip38tooldialog.obj: qt/moc_bip38tooldialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_bip38tooldialog.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_bip38tooldialog.Tpo -c -o qt/qt_libbitcoinqt_a-moc_bip38tooldialog.obj `if test -f 'qt/moc_bip38tooldialog.cpp'; then $(CYGPATH_W) 'qt/moc_bip38tooldialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_bip38tooldialog.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_bip38tooldialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_bip38tooldialog.Po
#	$(AM_V_CXX)source='qt/moc_bip38tooldialog.cpp' object='qt/qt_libbitcoinqt_a-moc_bip38tooldialog.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_bip38tooldialog.obj `if test -f 'qt/moc_bip38tooldialog.cpp'; then $(CYGPATH_W) 'qt/moc_bip38tooldialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_bip38tooldialog.cpp'; fi`
...
qt/qt_libbitcoinqt_a-moc_blockexplorer.o: qt/moc_blockexplorer.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_blockexplorer.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_blockexplorer.Tpo -c -o qt/qt_libbitcoinqt_a-moc_blockexplorer.o `test -f 'qt/moc_blockexplorer.cpp' || echo '$(srcdir)/'`qt/moc_blockexplorer.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_blockexplorer.o `test -f 'qt/moc_blockexplorer.cpp' || echo '$(srcdir)/'`qt/moc_blockexplorer.cpp

qt/qt_libbitcoinqt_a-moc_blockexplorer.obj: qt/moc_blockexplorer.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_blockexplorer.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_blockexplorer.Tpo -c -o qt/qt_libbitcoinqt_a-moc_blockexplorer.obj `if test -f 'qt/moc_blockexplorer.cpp'; then $(CYGPATH_W) 'qt/moc_blockexplorer.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_blockexplorer.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_blockexplorer.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_blockexplorer.Po
#	$(AM_V_CXX)source='qt/moc_blockexplorer.cpp' object='qt/qt_libbitcoinqt_a-moc_blockexplorer.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_blockexplorer.obj `if test -f 'qt/moc_blockexplorer.cpp'; then $(CYGPATH_W) 'qt/moc_blockexplorer.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_blockexplorer.cpp'; fi`
...
qt/qt_libbitcoinqt_a-moc_governancepage.o: qt/moc_governancepage.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_governancepage.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_governancepage.Tpo -c -o qt/qt_libbitcoinqt_a-moc_governancepage.o `test -f 'qt/moc_governancepage.cpp' || echo '$(srcdir)/'`qt/moc_governancepage.cpp
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_governancepage.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_governancepage.Po
#	$(AM_V_CXX)source='qt/moc_governancepage.cpp' object='qt/qt_libbitcoinqt_a-moc_governancepage.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_governancepage.o `test -f 'qt/moc_governancepage.cpp' || echo '$(srcdir)/'`qt/moc_governancepage.cpp

qt/qt_libbitcoinqt_a-moc_governancepage.obj: qt/moc_governancepage.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_governancepage.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_governancepage.Tpo -c -o qt/qt_libbitcoinqt_a-moc_governancepage.obj `if test -f 'qt/moc_governancepage.cpp'; then $(CYGPATH_W) 'qt/moc_governancepage.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_governancepage.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_governancepage.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_governancepage.Po
#	$(AM_V_CXX)source='qt/moc_governancepage.cpp' object='qt/qt_libbitcoinqt_a-moc_governancepage.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_governancepage.obj `if test -f 'qt/moc_governancepage.cpp'; then $(CYGPATH_W) 'qt/moc_governancepage.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_governancepage.cpp'; fi`
...
qt/qt_libbitcoinqt_a-moc_masternodelist.o: qt/moc_masternodelist.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_masternodelist.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_masternodelist.Tpo -c -o qt/qt_libbitcoinqt_a-moc_masternodelist.o `test -f 'qt/moc_masternodelist.cpp' || echo '$(srcdir)/'`qt/moc_masternodelist.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_masternodelist.o `test -f 'qt/moc_masternodelist.cpp' || echo '$(srcdir)/'`qt/moc_masternodelist.cpp

qt/qt_libbitcoinqt_a-moc_masternodelist.obj: qt/moc_masternodelist.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_masternodelist.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_masternodelist.Tpo -c -o qt/qt_libbitcoinqt_a-moc_masternodelist.obj `if test -f 'qt/moc_masternodelist.cpp'; then $(CYGPATH_W) 'qt/moc_masternodelist.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_masternodelist.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_masternodelist.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_masternodelist.Po
#	$(AM_V_CXX)source='qt/moc_masternodelist.cpp' object='qt/qt_libbitcoinqt_a-moc_masternodelist.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_masternodelist.obj `if test -f 'qt/moc_masternodelist.cpp'; then $(CYGPATH_W) 'qt/moc_masternodelist.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_masternodelist.cpp'; fi`

qt/qt_libbitcoinqt_a-moc_multisenddialog.o: qt/moc_multisenddialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_multisenddialog.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_multisenddialog.Tpo -c -o qt/qt_libbitcoinqt_a-moc_multisenddialog.o `test -f 'qt/moc_multisenddialog.cpp' || echo '$(srcdir)/'`qt/moc_multisenddialog.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_multisenddialog.o `test -f 'qt/moc_multisenddialog.cpp' || echo '$(srcdir)/'`qt/moc_multisenddialog.cpp

qt/qt_libbitcoinqt_a-moc_multisenddialog.obj: qt/moc_multisenddialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_multisenddialog.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_multisenddialog.Tpo -c -o qt/qt_libbitcoinqt_a-moc_multisenddialog.obj `if test -f 'qt/moc_multisenddialog.cpp'; then $(CYGPATH_W) 'qt/moc_multisenddialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_multisenddialog.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_multisenddialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_multisenddialog.Po
#	$(AM_V_CXX)source='qt/moc_multisenddialog.cpp' object='qt/qt_libbitcoinqt_a-moc_multisenddialog.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_multisenddialog.obj `if test -f 'qt/moc_multisenddialog.cpp'; then $(CYGPATH_W) 'qt/moc_multisenddialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_multisenddialog.cpp'; fi`

qt/qt_libbitcoinqt_a-moc_multisigdialog.o: qt/moc_multisigdialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_multisigdialog.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_multisigdialog.Tpo -c -o qt/qt_libbitcoinqt_a-moc_multisigdialog.o `test -f 'qt/moc_multisigdialog.cpp' || echo '$(srcdir)/'`qt/moc_multisigdialog.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_multisigdialog.o `test -f 'qt/moc_multisigdialog.cpp' || echo '$(srcdir)/'`qt/moc_multisigdialog.cpp

qt/qt_libbitcoinqt_a-moc_multisigdialog.obj: qt/moc_multisigdialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_multisigdialog.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_multisigdialog.Tpo -c -o qt/qt_libbitcoinqt_a-moc_multisigdialog.obj `if test -f 'qt/moc_multisigdialog.cpp'; then $(CYGPATH_W) 'qt/moc_multisigdialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_multisigdialog.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_multisigdialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_multisigdialog.Po
#	$(AM_V_CXX)source='qt/moc_multisigdialog.cpp' object='qt/qt_libbitcoinqt_a-moc_multisigdialog.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_multisigdialog.obj `if test -f 'qt/moc_multisigdialog.cpp'; then $(CYGPATH_W) 'qt/moc_multisigdialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_multisigdialog.cpp'; fi`
...
qt/qt_libbitcoinqt_a-moc_privacydialog.o: qt/moc_privacydialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_privacydialog.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_privacydialog.Tpo -c -o qt/qt_libbitcoinqt_a-moc_privacydialog.o `test -f 'qt/moc_privacydialog.cpp' || echo '$(srcdir)/'`qt/moc_privacydialog.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_privacydialog.o `test -f 'qt/moc_privacydialog.cpp' || echo '$(srcdir)/'`qt/moc_privacydialog.cpp

qt/qt_libbitcoinqt_a-moc_privacydialog.obj: qt/moc_privacydialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_privacydialog.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_privacydialog.Tpo -c -o qt/qt_libbitcoinqt_a-moc_privacydialog.obj `if test -f 'qt/moc_privacydialog.cpp'; then $(CYGPATH_W) 'qt/moc_privacydialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_privacydialog.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_privacydialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_privacydialog.Po
#	$(AM_V_CXX)source='qt/moc_privacydialog.cpp' object='qt/qt_libbitcoinqt_a-moc_privacydialog.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_privacydialog.obj `if test -f 'qt/moc_privacydialog.cpp'; then $(CYGPATH_W) 'qt/moc_privacydialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_privacydialog.cpp'; fi`

qt/qt_libbitcoinqt_a-moc_proposalframe.o: qt/moc_proposalframe.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_proposalframe.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_proposalframe.Tpo -c -o qt/qt_libbitcoinqt_a-moc_proposalframe.o `test -f 'qt/moc_proposalframe.cpp' || echo '$(srcdir)/'`qt/moc_proposalframe.cpp
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_proposalframe.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_proposalframe.Po
#	$(AM_V_CXX)source='qt/moc_proposalframe.cpp' object='qt/qt_libbitcoinqt_a-moc_proposalframe.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_proposalframe.o `test -f 'qt/moc_proposalframe.cpp' || echo '$(srcdir)/'`qt/moc_proposalframe.cpp

qt/qt_libbitcoinqt_a-moc_proposalframe.obj: qt/moc_proposalframe.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_proposalframe.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_proposalframe.Tpo -c -o qt/qt_libbitcoinqt_a-moc_proposalframe.obj `if test -f 'qt/moc_proposalframe.cpp'; then $(CYGPATH_W) 'qt/moc_proposalframe.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_proposalframe.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_proposalframe.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_proposalframe.Po
#	$(AM_V_CXX)source='qt/moc_proposalframe.cpp' object='qt/qt_libbitcoinqt_a-moc_proposalframe.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_proposalframe.obj `if test -f 'qt/moc_proposalframe.cpp'; then $(CYGPATH_W) 'qt/moc_proposalframe.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_proposalframe.cpp'; fi`
...
qt/qt_libbitcoinqt_a-moc_zdencontroldialog.o: qt/moc_zdencontroldialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_zdencontroldialog.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_zdencontroldialog.Tpo -c -o qt/qt_libbitcoinqt_a-moc_zdencontroldialog.o `test -f 'qt/moc_zdencontroldialog.cpp' || echo '$(srcdir)/'`qt/moc_zdencontroldialog.cpp
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_zdencontroldialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_zdencontroldialog.Po
#	$(AM_V_CXX)source='qt/moc_zdencontroldialog.cpp' object='qt/qt_libbitcoinqt_a-moc_zdencontroldialog.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_zdencontroldialog.o `test -f 'qt/moc_zdencontroldialog.cpp' || echo '$(srcdir)/'`qt/moc_zdencontroldialog.cpp

qt/qt_libbitcoinqt_a-moc_zdencontroldialog.obj: qt/moc_zdencontroldialog.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-moc_zdencontroldialog.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_zdencontroldialog.Tpo -c -o qt/qt_libbitcoinqt_a-moc_zdencontroldialog.obj `if test -f 'qt/moc_zdencontroldialog.cpp'; then $(CYGPATH_W) 'qt/moc_zdencontroldialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_zdencontroldialog.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_zdencontroldialog.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-moc_zdencontroldialog.Po
#	$(AM_V_CXX)source='qt/moc_zdencontroldialog.cpp' object='qt/qt_libbitcoinqt_a-moc_zdencontroldialog.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-moc_zdencontroldialog.obj `if test -f 'qt/moc_zdencontroldialog.cpp'; then $(CYGPATH_W) 'qt/moc_zdencontroldialog.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/moc_zdencontroldialog.cpp'; fi`
...
qt/qt_libbitcoinqt_a-qrc_dennodes.o: qt/qrc_dennodes.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-qrc_dennodes.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes.Tpo -c -o qt/qt_libbitcoinqt_a-qrc_dennodes.o `test -f 'qt/qrc_dennodes.cpp' || echo '$(srcdir)/'`qt/qrc_dennodes.cpp
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes.Po
#	$(AM_V_CXX)source='qt/qrc_dennodes.cpp' object='qt/qt_libbitcoinqt_a-qrc_dennodes.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-qrc_dennodes.o `test -f 'qt/qrc_dennodes.cpp' || echo '$(srcdir)/'`qt/qrc_dennodes.cpp

qt/qt_libbitcoinqt_a-qrc_dennodes.obj: qt/qrc_dennodes.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-qrc_dennodes.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes.Tpo -c -o qt/qt_libbitcoinqt_a-qrc_dennodes.obj `if test -f 'qt/qrc_dennodes.cpp'; then $(CYGPATH_W) 'qt/qrc_dennodes.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/qrc_dennodes.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes.Po
#	$(AM_V_CXX)source='qt/qrc_dennodes.cpp' object='qt/qt_libbitcoinqt_a-qrc_dennodes.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-qrc_dennodes.obj `if test -f 'qt/qrc_dennodes.cpp'; then $(CYGPATH_W) 'qt/qrc_dennodes.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/qrc_dennodes.cpp'; fi`

qt/qt_libbitcoinqt_a-qrc_dennodes_locale.o: qt/qrc_dennodes_locale.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-qrc_dennodes_locale.o -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes_locale.Tpo -c -o qt/qt_libbitcoinqt_a-qrc_dennodes_locale.o `test -f 'qt/qrc_dennodes_locale.cpp' || echo '$(srcdir)/'`qt/qrc_dennodes_locale.cpp
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes_locale.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes_locale.Po
#	$(AM_V_CXX)source='qt/qrc_dennodes_locale.cpp' object='qt/qt_libbitcoinqt_a-qrc_dennodes_locale.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-qrc_dennodes_locale.o `test -f 'qt/qrc_dennodes_locale.cpp' || echo '$(srcdir)/'`qt/qrc_dennodes_locale.cpp

qt/qt_libbitcoinqt_a-qrc_dennodes_locale.obj: qt/qrc_dennodes_locale.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_libbitcoinqt_a-qrc_dennodes_locale.obj -MD -MP -MF qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes_locale.Tpo -c -o qt/qt_libbitcoinqt_a-qrc_dennodes_locale.obj `if test -f 'qt/qrc_dennodes_locale.cpp'; then $(CYGPATH_W) 'qt/qrc_dennodes_locale.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/qrc_dennodes_locale.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes_locale.Tpo qt/$(DEPDIR)/qt_libbitcoinqt_a-qrc_dennodes_locale.Po
#	$(AM_V_CXX)source='qt/qrc_dennodes_locale.cpp' object='qt/qt_libbitcoinqt_a-qrc_dennodes_locale.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_libbitcoinqt_a_CPPFLAGS) $(CPPFLAGS) $(qt_libbitcoinqt_a_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_libbitcoinqt_a-qrc_dennodes_locale.obj `if test -f 'qt/qrc_dennodes_locale.cpp'; then $(CYGPATH_W) 'qt/qrc_dennodes_locale.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/qrc_dennodes_locale.cpp'; fi`

libbitcoinconsensus_la-allocators.lo: allocators.cpp
	$(AM_V_CXX)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoinconsensus_la_CPPFLAGS) $(CPPFLAGS) $(libbitcoinconsensus_la_CXXFLAGS) $(CXXFLAGS) -MT libbitcoinconsensus_la-allocators.lo -MD -MP -MF $(DEPDIR)/libbitcoinconsensus_la-allocators.Tpo -c -o libbitcoinconsensus_la-allocators.lo `test -f 'allocators.cpp' || echo '$(srcdir)/'`allocators.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoinconsensus_la_CPPFLAGS) $(CPPFLAGS) $(libbitcoinconsensus_la_CXXFLAGS) $(CXXFLAGS) -c -o libbitcoinconsensus_la-allocators.lo `test -f 'allocators.cpp' || echo '$(srcdir)/'`allocators.cpp
...
crypto/libbitcoinconsensus_la-scrypt.lo: crypto/scrypt.cpp
	$(AM_V_CXX)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoinconsensus_la_CPPFLAGS) $(CPPFLAGS) $(libbitcoinconsensus_la_CXXFLAGS) $(CXXFLAGS) -MT crypto/libbitcoinconsensus_la-scrypt.lo -MD -MP -MF crypto/$(DEPDIR)/libbitcoinconsensus_la-scrypt.Tpo -c -o crypto/libbitcoinconsensus_la-scrypt.lo `test -f 'crypto/scrypt.cpp' || echo '$(srcdir)/'`crypto/scrypt.cpp
...
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(LIBTOOL) $(AM_V_lt) --tag=CXX $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(libbitcoinconsensus_la_CPPFLAGS) $(CPPFLAGS) $(libbitcoinconsensus_la_CXXFLAGS) $(CXXFLAGS) -c -o crypto/libbitcoinconsensus_la-scrypt.lo `test -f 'crypto/scrypt.cpp' || echo '$(srcdir)/'`crypto/scrypt.cpp
...
dennodes_cli-dennodes-cli.o: dennodes-cli.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodes_cli_CPPFLAGS) $(CPPFLAGS) $(dennodes_cli_CXXFLAGS) $(CXXFLAGS) -MT dennodes_cli-dennodes-cli.o -MD -MP -MF $(DEPDIR)/dennodes_cli-dennodes-cli.Tpo -c -o dennodes_cli-dennodes-cli.o `test -f 'dennodes-cli.cpp' || echo '$(srcdir)/'`dennodes-cli.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/dennodes_cli-dennodes-cli.Tpo $(DEPDIR)/dennodes_cli-dennodes-cli.Po
#	$(AM_V_CXX)source='dennodes-cli.cpp' object='dennodes_cli-dennodes-cli.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodes_cli_CPPFLAGS) $(CPPFLAGS) $(dennodes_cli_CXXFLAGS) $(CXXFLAGS) -c -o dennodes_cli-dennodes-cli.o `test -f 'dennodes-cli.cpp' || echo '$(srcdir)/'`dennodes-cli.cpp

dennodes_cli-dennodes-cli.obj: dennodes-cli.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodes_cli_CPPFLAGS) $(CPPFLAGS) $(dennodes_cli_CXXFLAGS) $(CXXFLAGS) -MT dennodes_cli-dennodes-cli.obj -MD -MP -MF $(DEPDIR)/dennodes_cli-dennodes-cli.Tpo -c -o dennodes_cli-dennodes-cli.obj `if test -f 'dennodes-cli.cpp'; then $(CYGPATH_W) 'dennodes-cli.cpp'; else $(CYGPATH_W) '$(srcdir)/dennodes-cli.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/dennodes_cli-dennodes-cli.Tpo $(DEPDIR)/dennodes_cli-dennodes-cli.Po
#	$(AM_V_CXX)source='dennodes-cli.cpp' object='dennodes_cli-dennodes-cli.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodes_cli_CPPFLAGS) $(CPPFLAGS) $(dennodes_cli_CXXFLAGS) $(CXXFLAGS) -c -o dennodes_cli-dennodes-cli.obj `if test -f 'dennodes-cli.cpp'; then $(CYGPATH_W) 'dennodes-cli.cpp'; else $(CYGPATH_W) '$(srcdir)/dennodes-cli.cpp'; fi`

dennodes_tx-dennodes-tx.o: dennodes-tx.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodes_tx_CPPFLAGS) $(CPPFLAGS) $(dennodes_tx_CXXFLAGS) $(CXXFLAGS) -MT dennodes_tx-dennodes-tx.o -MD -MP -MF $(DEPDIR)/dennodes_tx-dennodes-tx.Tpo -c -o dennodes_tx-dennodes-tx.o `test -f 'dennodes-tx.cpp' || echo '$(srcdir)/'`dennodes-tx.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/dennodes_tx-dennodes-tx.Tpo $(DEPDIR)/dennodes_tx-dennodes-tx.Po
#	$(AM_V_CXX)source='dennodes-tx.cpp' object='dennodes_tx-dennodes-tx.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodes_tx_CPPFLAGS) $(CPPFLAGS) $(dennodes_tx_CXXFLAGS) $(CXXFLAGS) -c -o dennodes_tx-dennodes-tx.o `test -f 'dennodes-tx.cpp' || echo '$(srcdir)/'`dennodes-tx.cpp

dennodes_tx-dennodes-tx.obj: dennodes-tx.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodes_tx_CPPFLAGS) $(CPPFLAGS) $(dennodes_tx_CXXFLAGS) $(CXXFLAGS) -MT dennodes_tx-dennodes-tx.obj -MD -MP -MF $(DEPDIR)/dennodes_tx-dennodes-tx.Tpo -c -o dennodes_tx-dennodes-tx.obj `if test -f 'dennodes-tx.cpp'; then $(CYGPATH_W) 'dennodes-tx.cpp'; else $(CYGPATH_W) '$(srcdir)/dennodes-tx.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/dennodes_tx-dennodes-tx.Tpo $(DEPDIR)/dennodes_tx-dennodes-tx.Po
#	$(AM_V_CXX)source='dennodes-tx.cpp' object='dennodes_tx-dennodes-tx.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodes_tx_CPPFLAGS) $(CPPFLAGS) $(dennodes_tx_CXXFLAGS) $(CXXFLAGS) -c -o dennodes_tx-dennodes-tx.obj `if test -f 'dennodes-tx.cpp'; then $(CYGPATH_W) 'dennodes-tx.cpp'; else $(CYGPATH_W) '$(srcdir)/dennodes-tx.cpp'; fi`

dennodesd-dennodesd.o: dennodesd.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodesd_CPPFLAGS) $(CPPFLAGS) $(dennodesd_CXXFLAGS) $(CXXFLAGS) -MT dennodesd-dennodesd.o -MD -MP -MF $(DEPDIR)/dennodesd-dennodesd.Tpo -c -o dennodesd-dennodesd.o `test -f 'dennodesd.cpp' || echo '$(srcdir)/'`dennodesd.cpp
	$(AM_V_at)$(am__mv) $(DEPDIR)/dennodesd-dennodesd.Tpo $(DEPDIR)/dennodesd-dennodesd.Po
#	$(AM_V_CXX)source='dennodesd.cpp' object='dennodesd-dennodesd.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodesd_CPPFLAGS) $(CPPFLAGS) $(dennodesd_CXXFLAGS) $(CXXFLAGS) -c -o dennodesd-dennodesd.o `test -f 'dennodesd.cpp' || echo '$(srcdir)/'`dennodesd.cpp

dennodesd-dennodesd.obj: dennodesd.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodesd_CPPFLAGS) $(CPPFLAGS) $(dennodesd_CXXFLAGS) $(CXXFLAGS) -MT dennodesd-dennodesd.obj -MD -MP -MF $(DEPDIR)/dennodesd-dennodesd.Tpo -c -o dennodesd-dennodesd.obj `if test -f 'dennodesd.cpp'; then $(CYGPATH_W) 'dennodesd.cpp'; else $(CYGPATH_W) '$(srcdir)/dennodesd.cpp'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/dennodesd-dennodesd.Tpo $(DEPDIR)/dennodesd-dennodesd.Po
#	$(AM_V_CXX)source='dennodesd.cpp' object='dennodesd-dennodesd.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(dennodesd_CPPFLAGS) $(CPPFLAGS) $(dennodesd_CXXFLAGS) $(CXXFLAGS) -c -o dennodesd-dennodesd.obj `if test -f 'dennodesd.cpp'; then $(CYGPATH_W) 'dennodesd.cpp'; else $(CYGPATH_W) '$(srcdir)/dennodesd.cpp'; fi`

qt/qt_dennodes_qt-dennodes.o: qt/dennodes.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_dennodes_qt-dennodes.o -MD -MP -MF qt/$(DEPDIR)/qt_dennodes_qt-dennodes.Tpo -c -o qt/qt_dennodes_qt-dennodes.o `test -f 'qt/dennodes.cpp' || echo '$(srcdir)/'`qt/dennodes.cpp
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_dennodes_qt-dennodes.Tpo qt/$(DEPDIR)/qt_dennodes_qt-dennodes.Po
#	$(AM_V_CXX)source='qt/dennodes.cpp' object='qt/qt_dennodes_qt-dennodes.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_dennodes_qt-dennodes.o `test -f 'qt/dennodes.cpp' || echo '$(srcdir)/'`qt/dennodes.cpp

qt/qt_dennodes_qt-dennodes.obj: qt/dennodes.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/qt_dennodes_qt-dennodes.obj -MD -MP -MF qt/$(DEPDIR)/qt_dennodes_qt-dennodes.Tpo -c -o qt/qt_dennodes_qt-dennodes.obj `if test -f 'qt/dennodes.cpp'; then $(CYGPATH_W) 'qt/dennodes.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/dennodes.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_dennodes_qt-dennodes.Tpo qt/$(DEPDIR)/qt_dennodes_qt-dennodes.Po
#	$(AM_V_CXX)source='qt/dennodes.cpp' object='qt/qt_dennodes_qt-dennodes.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/qt_dennodes_qt-dennodes.obj `if test -f 'qt/dennodes.cpp'; then $(CYGPATH_W) 'qt/dennodes.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/dennodes.cpp'; fi`

qt/test/qt_test_test_dennodes_qt-test_main.o: qt/test/test_main.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/test/qt_test_test_dennodes_qt-test_main.o -MD -MP -MF qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-test_main.Tpo -c -o qt/test/qt_test_test_dennodes_qt-test_main.o `test -f 'qt/test/test_main.cpp' || echo '$(srcdir)/'`qt/test/test_main.cpp
	$(AM_V_at)$(am__mv) qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-test_main.Tpo qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-test_main.Po
#	$(AM_V_CXX)source='qt/test/test_main.cpp' object='qt/test/qt_test_test_dennodes_qt-test_main.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/test/qt_test_test_dennodes_qt-test_main.o `test -f 'qt/test/test_main.cpp' || echo '$(srcdir)/'`qt/test/test_main.cpp

qt/test/qt_test_test_dennodes_qt-test_main.obj: qt/test/test_main.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/test/qt_test_test_dennodes_qt-test_main.obj -MD -MP -MF qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-test_main.Tpo -c -o qt/test/qt_test_test_dennodes_qt-test_main.obj `if test -f 'qt/test/test_main.cpp'; then $(CYGPATH_W) 'qt/test/test_main.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/test/test_main.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-test_main.Tpo qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-test_main.Po
#	$(AM_V_CXX)source='qt/test/test_main.cpp' object='qt/test/qt_test_test_dennodes_qt-test_main.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/test/qt_test_test_dennodes_qt-test_main.obj `if test -f 'qt/test/test_main.cpp'; then $(CYGPATH_W) 'qt/test/test_main.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/test/test_main.cpp'; fi`

qt/test/qt_test_test_dennodes_qt-uritests.o: qt/test/uritests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/test/qt_test_test_dennodes_qt-uritests.o -MD -MP -MF qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-uritests.Tpo -c -o qt/test/qt_test_test_dennodes_qt-uritests.o `test -f 'qt/test/uritests.cpp' || echo '$(srcdir)/'`qt/test/uritests.cpp
	$(AM_V_at)$(am__mv) qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-uritests.Tpo qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-uritests.Po
#	$(AM_V_CXX)source='qt/test/uritests.cpp' object='qt/test/qt_test_test_dennodes_qt-uritests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/test/qt_test_test_dennodes_qt-uritests.o `test -f 'qt/test/uritests.cpp' || echo '$(srcdir)/'`qt/test/uritests.cpp

qt/test/qt_test_test_dennodes_qt-uritests.obj: qt/test/uritests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/test/qt_test_test_dennodes_qt-uritests.obj -MD -MP -MF qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-uritests.Tpo -c -o qt/test/qt_test_test_dennodes_qt-uritests.obj `if test -f 'qt/test/uritests.cpp'; then $(CYGPATH_W) 'qt/test/uritests.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/test/uritests.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-uritests.Tpo qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-uritests.Po
#	$(AM_V_CXX)source='qt/test/uritests.cpp' object='qt/test/qt_test_test_dennodes_qt-uritests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/test/qt_test_test_dennodes_qt-uritests.obj `if test -f 'qt/test/uritests.cpp'; then $(CYGPATH_W) 'qt/test/uritests.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/test/uritests.cpp'; fi`

qt/test/qt_test_test_dennodes_qt-paymentservertests.o: qt/test/paymentservertests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/test/qt_test_test_dennodes_qt-paymentservertests.o -MD -MP -MF qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-paymentservertests.Tpo -c -o qt/test/qt_test_test_dennodes_qt-paymentservertests.o `test -f 'qt/test/paymentservertests.cpp' || echo '$(srcdir)/'`qt/test/paymentservertests.cpp
	$(AM_V_at)$(am__mv) qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-paymentservertests.Tpo qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-paymentservertests.Po
#	$(AM_V_CXX)source='qt/test/paymentservertests.cpp' object='qt/test/qt_test_test_dennodes_qt-paymentservertests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/test/qt_test_test_dennodes_qt-paymentservertests.o `test -f 'qt/test/paymentservertests.cpp' || echo '$(srcdir)/'`qt/test/paymentservertests.cpp

qt/test/qt_test_test_dennodes_qt-paymentservertests.obj: qt/test/paymentservertests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/test/qt_test_test_dennodes_qt-paymentservertests.obj -MD -MP -MF qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-paymentservertests.Tpo -c -o qt/test/qt_test_test_dennodes_qt-paymentservertests.obj `if test -f 'qt/test/paymentservertests.cpp'; then $(CYGPATH_W) 'qt/test/paymentservertests.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/test/paymentservertests.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-paymentservertests.Tpo qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-paymentservertests.Po
#	$(AM_V_CXX)source='qt/test/paymentservertests.cpp' object='qt/test/qt_test_test_dennodes_qt-paymentservertests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/test/qt_test_test_dennodes_qt-paymentservertests.obj `if test -f 'qt/test/paymentservertests.cpp'; then $(CYGPATH_W) 'qt/test/paymentservertests.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/test/paymentservertests.cpp'; fi`

qt/test/qt_test_test_dennodes_qt-moc_uritests.o: qt/test/moc_uritests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/test/qt_test_test_dennodes_qt-moc_uritests.o -MD -MP -MF qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_uritests.Tpo -c -o qt/test/qt_test_test_dennodes_qt-moc_uritests.o `test -f 'qt/test/moc_uritests.cpp' || echo '$(srcdir)/'`qt/test/moc_uritests.cpp
	$(AM_V_at)$(am__mv) qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_uritests.Tpo qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_uritests.Po
#	$(AM_V_CXX)source='qt/test/moc_uritests.cpp' object='qt/test/qt_test_test_dennodes_qt-moc_uritests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/test/qt_test_test_dennodes_qt-moc_uritests.o `test -f 'qt/test/moc_uritests.cpp' || echo '$(srcdir)/'`qt/test/moc_uritests.cpp

qt/test/qt_test_test_dennodes_qt-moc_uritests.obj: qt/test/moc_uritests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/test/qt_test_test_dennodes_qt-moc_uritests.obj -MD -MP -MF qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_uritests.Tpo -c -o qt/test/qt_test_test_dennodes_qt-moc_uritests.obj `if test -f 'qt/test/moc_uritests.cpp'; then $(CYGPATH_W) 'qt/test/moc_uritests.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/test/moc_uritests.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_uritests.Tpo qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_uritests.Po
#	$(AM_V_CXX)source='qt/test/moc_uritests.cpp' object='qt/test/qt_test_test_dennodes_qt-moc_uritests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/test/qt_test_test_dennodes_qt-moc_uritests.obj `if test -f 'qt/test/moc_uritests.cpp'; then $(CYGPATH_W) 'qt/test/moc_uritests.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/test/moc_uritests.cpp'; fi`

qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.o: qt/test/moc_paymentservertests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.o -MD -MP -MF qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_paymentservertests.Tpo -c -o qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.o `test -f 'qt/test/moc_paymentservertests.cpp' || echo '$(srcdir)/'`qt/test/moc_paymentservertests.cpp
	$(AM_V_at)$(am__mv) qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_paymentservertests.Tpo qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_paymentservertests.Po
#	$(AM_V_CXX)source='qt/test/moc_paymentservertests.cpp' object='qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.o `test -f 'qt/test/moc_paymentservertests.cpp' || echo '$(srcdir)/'`qt/test/moc_paymentservertests.cpp

qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.obj: qt/test/moc_paymentservertests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -MT qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.obj -MD -MP -MF qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_paymentservertests.Tpo -c -o qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.obj `if test -f 'qt/test/moc_paymentservertests.cpp'; then $(CYGPATH_W) 'qt/test/moc_paymentservertests.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/test/moc_paymentservertests.cpp'; fi`
	$(AM_V_at)$(am__mv) qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_paymentservertests.Tpo qt/test/$(DEPDIR)/qt_test_test_dennodes_qt-moc_paymentservertests.Po
#	$(AM_V_CXX)source='qt/test/moc_paymentservertests.cpp' object='qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_test_test_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(qt_test_test_dennodes_qt_CXXFLAGS) $(CXXFLAGS) -c -o qt/test/qt_test_test_dennodes_qt-moc_paymentservertests.obj `if test -f 'qt/test/moc_paymentservertests.cpp'; then $(CYGPATH_W) 'qt/test/moc_paymentservertests.cpp'; else $(CYGPATH_W) '$(srcdir)/qt/test/moc_paymentservertests.cpp'; fi`

test/test_test_dennodes-test_dennodes.o: test/test_dennodes.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-test_dennodes.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-test_dennodes.Tpo -c -o test/test_test_dennodes-test_dennodes.o `test -f 'test/test_dennodes.cpp' || echo '$(srcdir)/'`test/test_dennodes.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-test_dennodes.Tpo test/$(DEPDIR)/test_test_dennodes-test_dennodes.Po
#	$(AM_V_CXX)source='test/test_dennodes.cpp' object='test/test_test_dennodes-test_dennodes.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-test_dennodes.o `test -f 'test/test_dennodes.cpp' || echo '$(srcdir)/'`test/test_dennodes.cpp

test/test_test_dennodes-test_dennodes.obj: test/test_dennodes.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-test_dennodes.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-test_dennodes.Tpo -c -o test/test_test_dennodes-test_dennodes.obj `if test -f 'test/test_dennodes.cpp'; then $(CYGPATH_W) 'test/test_dennodes.cpp'; else $(CYGPATH_W) '$(srcdir)/test/test_dennodes.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-test_dennodes.Tpo test/$(DEPDIR)/test_test_dennodes-test_dennodes.Po
#	$(AM_V_CXX)source='test/test_dennodes.cpp' object='test/test_test_dennodes-test_dennodes.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-test_dennodes.obj `if test -f 'test/test_dennodes.cpp'; then $(CYGPATH_W) 'test/test_dennodes.cpp'; else $(CYGPATH_W) '$(srcdir)/test/test_dennodes.cpp'; fi`

test/test_test_dennodes-zerocoin_implementation_tests.o: test/zerocoin_implementation_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-zerocoin_implementation_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-zerocoin_implementation_tests.Tpo -c -o test/test_test_dennodes-zerocoin_implementation_tests.o `test -f 'test/zerocoin_implementation_tests.cpp' || echo '$(srcdir)/'`test/zerocoin_implementation_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-zerocoin_implementation_tests.Tpo test/$(DEPDIR)/test_test_dennodes-zerocoin_implementation_tests.Po
#	$(AM_V_CXX)source='test/zerocoin_implementation_tests.cpp' object='test/test_test_dennodes-zerocoin_implementation_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-zerocoin_implementation_tests.o `test -f 'test/zerocoin_implementation_tests.cpp' || echo '$(srcdir)/'`test/zerocoin_implementation_tests.cpp

test/test_test_dennodes-zerocoin_implementation_tests.obj: test/zerocoin_implementation_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-zerocoin_implementation_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-zerocoin_implementation_tests.Tpo -c -o test/test_test_dennodes-zerocoin_implementation_tests.obj `if test -f 'test/zerocoin_implementation_tests.cpp'; then $(CYGPATH_W) 'test/zerocoin_implementation_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/zerocoin_implementation_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-zerocoin_implementation_tests.Tpo test/$(DEPDIR)/test_test_dennodes-zerocoin_implementation_tests.Po
#	$(AM_V_CXX)source='test/zerocoin_implementation_tests.cpp' object='test/test_test_dennodes-zerocoin_implementation_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-zerocoin_implementation_tests.obj `if test -f 'test/zerocoin_implementation_tests.cpp'; then $(CYGPATH_W) 'test/zerocoin_implementation_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/zerocoin_implementation_tests.cpp'; fi`

test/test_test_dennodes-zerocoin_denomination_tests.o: test/zerocoin_denomination_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-zerocoin_denomination_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-zerocoin_denomination_tests.Tpo -c -o test/test_test_dennodes-zerocoin_denomination_tests.o `test -f 'test/zerocoin_denomination_tests.cpp' || echo '$(srcdir)/'`test/zerocoin_denomination_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-zerocoin_denomination_tests.Tpo test/$(DEPDIR)/test_test_dennodes-zerocoin_denomination_tests.Po
#	$(AM_V_CXX)source='test/zerocoin_denomination_tests.cpp' object='test/test_test_dennodes-zerocoin_denomination_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-zerocoin_denomination_tests.o `test -f 'test/zerocoin_denomination_tests.cpp' || echo '$(srcdir)/'`test/zerocoin_denomination_tests.cpp

test/test_test_dennodes-zerocoin_denomination_tests.obj: test/zerocoin_denomination_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-zerocoin_denomination_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-zerocoin_denomination_tests.Tpo -c -o test/test_test_dennodes-zerocoin_denomination_tests.obj `if test -f 'test/zerocoin_denomination_tests.cpp'; then $(CYGPATH_W) 'test/zerocoin_denomination_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/zerocoin_denomination_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-zerocoin_denomination_tests.Tpo test/$(DEPDIR)/test_test_dennodes-zerocoin_denomination_tests.Po
#	$(AM_V_CXX)source='test/zerocoin_denomination_tests.cpp' object='test/test_test_dennodes-zerocoin_denomination_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-zerocoin_denomination_tests.obj `if test -f 'test/zerocoin_denomination_tests.cpp'; then $(CYGPATH_W) 'test/zerocoin_denomination_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/zerocoin_denomination_tests.cpp'; fi`

test/test_test_dennodes-zerocoin_transactions_tests.o: test/zerocoin_transactions_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-zerocoin_transactions_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-zerocoin_transactions_tests.Tpo -c -o test/test_test_dennodes-zerocoin_transactions_tests.o `test -f 'test/zerocoin_transactions_tests.cpp' || echo '$(srcdir)/'`test/zerocoin_transactions_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-zerocoin_transactions_tests.Tpo test/$(DEPDIR)/test_test_dennodes-zerocoin_transactions_tests.Po
#	$(AM_V_CXX)source='test/zerocoin_transactions_tests.cpp' object='test/test_test_dennodes-zerocoin_transactions_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-zerocoin_transactions_tests.o `test -f 'test/zerocoin_transactions_tests.cpp' || echo '$(srcdir)/'`test/zerocoin_transactions_tests.cpp

test/test_test_dennodes-zerocoin_transactions_tests.obj: test/zerocoin_transactions_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-zerocoin_transactions_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-zerocoin_transactions_tests.Tpo -c -o test/test_test_dennodes-zerocoin_transactions_tests.obj `if test -f 'test/zerocoin_transactions_tests.cpp'; then $(CYGPATH_W) 'test/zerocoin_transactions_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/zerocoin_transactions_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-zerocoin_transactions_tests.Tpo test/$(DEPDIR)/test_test_dennodes-zerocoin_transactions_tests.Po
#	$(AM_V_CXX)source='test/zerocoin_transactions_tests.cpp' object='test/test_test_dennodes-zerocoin_transactions_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-zerocoin_transactions_tests.obj `if test -f 'test/zerocoin_transactions_tests.cpp'; then $(CYGPATH_W) 'test/zerocoin_transactions_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/zerocoin_transactions_tests.cpp'; fi`

test/test_test_dennodes-zerocoin_coinspend_tests.o: test/zerocoin_coinspend_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-zerocoin_coinspend_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-zerocoin_coinspend_tests.Tpo -c -o test/test_test_dennodes-zerocoin_coinspend_tests.o `test -f 'test/zerocoin_coinspend_tests.cpp' || echo '$(srcdir)/'`test/zerocoin_coinspend_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-zerocoin_coinspend_tests.Tpo test/$(DEPDIR)/test_test_dennodes-zerocoin_coinspend_tests.Po
#	$(AM_V_CXX)source='test/zerocoin_coinspend_tests.cpp' object='test/test_test_dennodes-zerocoin_coinspend_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-zerocoin_coinspend_tests.o `test -f 'test/zerocoin_coinspend_tests.cpp' || echo '$(srcdir)/'`test/zerocoin_coinspend_tests.cpp

test/test_test_dennodes-zerocoin_coinspend_tests.obj: test/zerocoin_coinspend_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-zerocoin_coinspend_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-zerocoin_coinspend_tests.Tpo -c -o test/test_test_dennodes-zerocoin_coinspend_tests.obj `if test -f 'test/zerocoin_coinspend_tests.cpp'; then $(CYGPATH_W) 'test/zerocoin_coinspend_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/zerocoin_coinspend_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-zerocoin_coinspend_tests.Tpo test/$(DEPDIR)/test_test_dennodes-zerocoin_coinspend_tests.Po
#	$(AM_V_CXX)source='test/zerocoin_coinspend_tests.cpp' object='test/test_test_dennodes-zerocoin_coinspend_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-zerocoin_coinspend_tests.obj `if test -f 'test/zerocoin_coinspend_tests.cpp'; then $(CYGPATH_W) 'test/zerocoin_coinspend_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/zerocoin_coinspend_tests.cpp'; fi`

test/test_test_dennodes-zerocoin_bignum_tests.o: test/zerocoin_bignum_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-zerocoin_bignum_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-zerocoin_bignum_tests.Tpo -c -o test/test_test_dennodes-zerocoin_bignum_tests.o `test -f 'test/zerocoin_bignum_tests.cpp' || echo '$(srcdir)/'`test/zerocoin_bignum_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-zerocoin_bignum_tests.Tpo test/$(DEPDIR)/test_test_dennodes-zerocoin_bignum_tests.Po
#	$(AM_V_CXX)source='test/zerocoin_bignum_tests.cpp' object='test/test_test_dennodes-zerocoin_bignum_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-zerocoin_bignum_tests.o `test -f 'test/zerocoin_bignum_tests.cpp' || echo '$(srcdir)/'`test/zerocoin_bignum_tests.cpp

test/test_test_dennodes-zerocoin_bignum_tests.obj: test/zerocoin_bignum_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-zerocoin_bignum_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-zerocoin_bignum_tests.Tpo -c -o test/test_test_dennodes-zerocoin_bignum_tests.obj `if test -f 'test/zerocoin_bignum_tests.cpp'; then $(CYGPATH_W) 'test/zerocoin_bignum_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/zerocoin_bignum_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-zerocoin_bignum_tests.Tpo test/$(DEPDIR)/test_test_dennodes-zerocoin_bignum_tests.Po
#	$(AM_V_CXX)source='test/zerocoin_bignum_tests.cpp' object='test/test_test_dennodes-zerocoin_bignum_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-zerocoin_bignum_tests.obj `if test -f 'test/zerocoin_bignum_tests.cpp'; then $(CYGPATH_W) 'test/zerocoin_bignum_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/zerocoin_bignum_tests.cpp'; fi`

test/test_test_dennodes-benchmark_zerocoin.o: test/benchmark_zerocoin.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-benchmark_zerocoin.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-benchmark_zerocoin.Tpo -c -o test/test_test_dennodes-benchmark_zerocoin.o `test -f 'test/benchmark_zerocoin.cpp' || echo '$(srcdir)/'`test/benchmark_zerocoin.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-benchmark_zerocoin.Tpo test/$(DEPDIR)/test_test_dennodes-benchmark_zerocoin.Po
#	$(AM_V_CXX)source='test/benchmark_zerocoin.cpp' object='test/test_test_dennodes-benchmark_zerocoin.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-benchmark_zerocoin.o `test -f 'test/benchmark_zerocoin.cpp' || echo '$(srcdir)/'`test/benchmark_zerocoin.cpp

test/test_test_dennodes-benchmark_zerocoin.obj: test/benchmark_zerocoin.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-benchmark_zerocoin.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-benchmark_zerocoin.Tpo -c -o test/test_test_dennodes-benchmark_zerocoin.obj `if test -f 'test/benchmark_zerocoin.cpp'; then $(CYGPATH_W) 'test/benchmark_zerocoin.cpp'; else $(CYGPATH_W) '$(srcdir)/test/benchmark_zerocoin.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-benchmark_zerocoin.Tpo test/$(DEPDIR)/test_test_dennodes-benchmark_zerocoin.Po
#	$(AM_V_CXX)source='test/benchmark_zerocoin.cpp' object='test/test_test_dennodes-benchmark_zerocoin.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-benchmark_zerocoin.obj `if test -f 'test/benchmark_zerocoin.cpp'; then $(CYGPATH_W) 'test/benchmark_zerocoin.cpp'; else $(CYGPATH_W) '$(srcdir)/test/benchmark_zerocoin.cpp'; fi`

test/test_test_dennodes-tutorial_zerocoin.o: test/tutorial_zerocoin.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-tutorial_zerocoin.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-tutorial_zerocoin.Tpo -c -o test/test_test_dennodes-tutorial_zerocoin.o `test -f 'test/tutorial_zerocoin.cpp' || echo '$(srcdir)/'`test/tutorial_zerocoin.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-tutorial_zerocoin.Tpo test/$(DEPDIR)/test_test_dennodes-tutorial_zerocoin.Po
#	$(AM_V_CXX)source='test/tutorial_zerocoin.cpp' object='test/test_test_dennodes-tutorial_zerocoin.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-tutorial_zerocoin.o `test -f 'test/tutorial_zerocoin.cpp' || echo '$(srcdir)/'`test/tutorial_zerocoin.cpp

test/test_test_dennodes-tutorial_zerocoin.obj: test/tutorial_zerocoin.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-tutorial_zerocoin.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-tutorial_zerocoin.Tpo -c -o test/test_test_dennodes-tutorial_zerocoin.obj `if test -f 'test/tutorial_zerocoin.cpp'; then $(CYGPATH_W) 'test/tutorial_zerocoin.cpp'; else $(CYGPATH_W) '$(srcdir)/test/tutorial_zerocoin.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-tutorial_zerocoin.Tpo test/$(DEPDIR)/test_test_dennodes-tutorial_zerocoin.Po
#	$(AM_V_CXX)source='test/tutorial_zerocoin.cpp' object='test/test_test_dennodes-tutorial_zerocoin.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-tutorial_zerocoin.obj `if test -f 'test/tutorial_zerocoin.cpp'; then $(CYGPATH_W) 'test/tutorial_zerocoin.cpp'; else $(CYGPATH_W) '$(srcdir)/test/tutorial_zerocoin.cpp'; fi`

test/test_test_dennodes-libzerocoin_tests.o: test/libzerocoin_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-libzerocoin_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-libzerocoin_tests.Tpo -c -o test/test_test_dennodes-libzerocoin_tests.o `test -f 'test/libzerocoin_tests.cpp' || echo '$(srcdir)/'`test/libzerocoin_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-libzerocoin_tests.Tpo test/$(DEPDIR)/test_test_dennodes-libzerocoin_tests.Po
#	$(AM_V_CXX)source='test/libzerocoin_tests.cpp' object='test/test_test_dennodes-libzerocoin_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-libzerocoin_tests.o `test -f 'test/libzerocoin_tests.cpp' || echo '$(srcdir)/'`test/libzerocoin_tests.cpp

test/test_test_dennodes-libzerocoin_tests.obj: test/libzerocoin_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-libzerocoin_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-libzerocoin_tests.Tpo -c -o test/test_test_dennodes-libzerocoin_tests.obj `if test -f 'test/libzerocoin_tests.cpp'; then $(CYGPATH_W) 'test/libzerocoin_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/libzerocoin_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-libzerocoin_tests.Tpo test/$(DEPDIR)/test_test_dennodes-libzerocoin_tests.Po
#	$(AM_V_CXX)source='test/libzerocoin_tests.cpp' object='test/test_test_dennodes-libzerocoin_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-libzerocoin_tests.obj `if test -f 'test/libzerocoin_tests.cpp'; then $(CYGPATH_W) 'test/libzerocoin_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/libzerocoin_tests.cpp'; fi`

test/test_test_dennodes-addrman_tests.o: test/addrman_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-addrman_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-addrman_tests.Tpo -c -o test/test_test_dennodes-addrman_tests.o `test -f 'test/addrman_tests.cpp' || echo '$(srcdir)/'`test/addrman_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-addrman_tests.Tpo test/$(DEPDIR)/test_test_dennodes-addrman_tests.Po
#	$(AM_V_CXX)source='test/addrman_tests.cpp' object='test/test_test_dennodes-addrman_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-addrman_tests.o `test -f 'test/addrman_tests.cpp' || echo '$(srcdir)/'`test/addrman_tests.cpp

test/test_test_dennodes-addrman_tests.obj: test/addrman_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-addrman_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-addrman_tests.Tpo -c -o test/test_test_dennodes-addrman_tests.obj `if test -f 'test/addrman_tests.cpp'; then $(CYGPATH_W) 'test/addrman_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/addrman_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-addrman_tests.Tpo test/$(DEPDIR)/test_test_dennodes-addrman_tests.Po
#	$(AM_V_CXX)source='test/addrman_tests.cpp' object='test/test_test_dennodes-addrman_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-addrman_tests.obj `if test -f 'test/addrman_tests.cpp'; then $(CYGPATH_W) 'test/addrman_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/addrman_tests.cpp'; fi`

test/test_test_dennodes-allocator_tests.o: test/allocator_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-allocator_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-allocator_tests.Tpo -c -o test/test_test_dennodes-allocator_tests.o `test -f 'test/allocator_tests.cpp' || echo '$(srcdir)/'`test/allocator_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-allocator_tests.Tpo test/$(DEPDIR)/test_test_dennodes-allocator_tests.Po
#	$(AM_V_CXX)source='test/allocator_tests.cpp' object='test/test_test_dennodes-allocator_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-allocator_tests.o `test -f 'test/allocator_tests.cpp' || echo '$(srcdir)/'`test/allocator_tests.cpp

test/test_test_dennodes-allocator_tests.obj: test/allocator_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-allocator_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-allocator_tests.Tpo -c -o test/test_test_dennodes-allocator_tests.obj `if test -f 'test/allocator_tests.cpp'; then $(CYGPATH_W) 'test/allocator_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/allocator_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-allocator_tests.Tpo test/$(DEPDIR)/test_test_dennodes-allocator_tests.Po
#	$(AM_V_CXX)source='test/allocator_tests.cpp' object='test/test_test_dennodes-allocator_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-allocator_tests.obj `if test -f 'test/allocator_tests.cpp'; then $(CYGPATH_W) 'test/allocator_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/allocator_tests.cpp'; fi`

test/test_test_dennodes-base32_tests.o: test/base32_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-base32_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-base32_tests.Tpo -c -o test/test_test_dennodes-base32_tests.o `test -f 'test/base32_tests.cpp' || echo '$(srcdir)/'`test/base32_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-base32_tests.Tpo test/$(DEPDIR)/test_test_dennodes-base32_tests.Po
#	$(AM_V_CXX)source='test/base32_tests.cpp' object='test/test_test_dennodes-base32_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-base32_tests.o `test -f 'test/base32_tests.cpp' || echo '$(srcdir)/'`test/base32_tests.cpp

test/test_test_dennodes-base32_tests.obj: test/base32_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-base32_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-base32_tests.Tpo -c -o test/test_test_dennodes-base32_tests.obj `if test -f 'test/base32_tests.cpp'; then $(CYGPATH_W) 'test/base32_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/base32_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-base32_tests.Tpo test/$(DEPDIR)/test_test_dennodes-base32_tests.Po
#	$(AM_V_CXX)source='test/base32_tests.cpp' object='test/test_test_dennodes-base32_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-base32_tests.obj `if test -f 'test/base32_tests.cpp'; then $(CYGPATH_W) 'test/base32_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/base32_tests.cpp'; fi`

test/test_test_dennodes-base58_tests.o: test/base58_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-base58_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-base58_tests.Tpo -c -o test/test_test_dennodes-base58_tests.o `test -f 'test/base58_tests.cpp' || echo '$(srcdir)/'`test/base58_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-base58_tests.Tpo test/$(DEPDIR)/test_test_dennodes-base58_tests.Po
#	$(AM_V_CXX)source='test/base58_tests.cpp' object='test/test_test_dennodes-base58_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-base58_tests.o `test -f 'test/base58_tests.cpp' || echo '$(srcdir)/'`test/base58_tests.cpp

test/test_test_dennodes-base58_tests.obj: test/base58_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-base58_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-base58_tests.Tpo -c -o test/test_test_dennodes-base58_tests.obj `if test -f 'test/base58_tests.cpp'; then $(CYGPATH_W) 'test/base58_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/base58_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-base58_tests.Tpo test/$(DEPDIR)/test_test_dennodes-base58_tests.Po
#	$(AM_V_CXX)source='test/base58_tests.cpp' object='test/test_test_dennodes-base58_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-base58_tests.obj `if test -f 'test/base58_tests.cpp'; then $(CYGPATH_W) 'test/base58_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/base58_tests.cpp'; fi`

test/test_test_dennodes-base64_tests.o: test/base64_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-base64_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-base64_tests.Tpo -c -o test/test_test_dennodes-base64_tests.o `test -f 'test/base64_tests.cpp' || echo '$(srcdir)/'`test/base64_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-base64_tests.Tpo test/$(DEPDIR)/test_test_dennodes-base64_tests.Po
#	$(AM_V_CXX)source='test/base64_tests.cpp' object='test/test_test_dennodes-base64_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-base64_tests.o `test -f 'test/base64_tests.cpp' || echo '$(srcdir)/'`test/base64_tests.cpp

test/test_test_dennodes-base64_tests.obj: test/base64_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-base64_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-base64_tests.Tpo -c -o test/test_test_dennodes-base64_tests.obj `if test -f 'test/base64_tests.cpp'; then $(CYGPATH_W) 'test/base64_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/base64_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-base64_tests.Tpo test/$(DEPDIR)/test_test_dennodes-base64_tests.Po
#	$(AM_V_CXX)source='test/base64_tests.cpp' object='test/test_test_dennodes-base64_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-base64_tests.obj `if test -f 'test/base64_tests.cpp'; then $(CYGPATH_W) 'test/base64_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/base64_tests.cpp'; fi`

test/test_test_dennodes-budget_tests.o: test/budget_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-budget_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-budget_tests.Tpo -c -o test/test_test_dennodes-budget_tests.o `test -f 'test/budget_tests.cpp' || echo '$(srcdir)/'`test/budget_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-budget_tests.Tpo test/$(DEPDIR)/test_test_dennodes-budget_tests.Po
#	$(AM_V_CXX)source='test/budget_tests.cpp' object='test/test_test_dennodes-budget_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-budget_tests.o `test -f 'test/budget_tests.cpp' || echo '$(srcdir)/'`test/budget_tests.cpp

test/test_test_dennodes-budget_tests.obj: test/budget_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-budget_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-budget_tests.Tpo -c -o test/test_test_dennodes-budget_tests.obj `if test -f 'test/budget_tests.cpp'; then $(CYGPATH_W) 'test/budget_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/budget_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-budget_tests.Tpo test/$(DEPDIR)/test_test_dennodes-budget_tests.Po
#	$(AM_V_CXX)source='test/budget_tests.cpp' object='test/test_test_dennodes-budget_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-budget_tests.obj `if test -f 'test/budget_tests.cpp'; then $(CYGPATH_W) 'test/budget_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/budget_tests.cpp'; fi`

test/test_test_dennodes-checkblock_tests.o: test/checkblock_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-checkblock_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-checkblock_tests.Tpo -c -o test/test_test_dennodes-checkblock_tests.o `test -f 'test/checkblock_tests.cpp' || echo '$(srcdir)/'`test/checkblock_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-checkblock_tests.Tpo test/$(DEPDIR)/test_test_dennodes-checkblock_tests.Po
#	$(AM_V_CXX)source='test/checkblock_tests.cpp' object='test/test_test_dennodes-checkblock_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-checkblock_tests.o `test -f 'test/checkblock_tests.cpp' || echo '$(srcdir)/'`test/checkblock_tests.cpp

test/test_test_dennodes-checkblock_tests.obj: test/checkblock_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-checkblock_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-checkblock_tests.Tpo -c -o test/test_test_dennodes-checkblock_tests.obj `if test -f 'test/checkblock_tests.cpp'; then $(CYGPATH_W) 'test/checkblock_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/checkblock_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-checkblock_tests.Tpo test/$(DEPDIR)/test_test_dennodes-checkblock_tests.Po
#	$(AM_V_CXX)source='test/checkblock_tests.cpp' object='test/test_test_dennodes-checkblock_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-checkblock_tests.obj `if test -f 'test/checkblock_tests.cpp'; then $(CYGPATH_W) 'test/checkblock_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/checkblock_tests.cpp'; fi`

test/test_test_dennodes-Checkpoints_tests.o: test/Checkpoints_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-Checkpoints_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-Checkpoints_tests.Tpo -c -o test/test_test_dennodes-Checkpoints_tests.o `test -f 'test/Checkpoints_tests.cpp' || echo '$(srcdir)/'`test/Checkpoints_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-Checkpoints_tests.Tpo test/$(DEPDIR)/test_test_dennodes-Checkpoints_tests.Po
#	$(AM_V_CXX)source='test/Checkpoints_tests.cpp' object='test/test_test_dennodes-Checkpoints_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-Checkpoints_tests.o `test -f 'test/Checkpoints_tests.cpp' || echo '$(srcdir)/'`test/Checkpoints_tests.cpp

test/test_test_dennodes-Checkpoints_tests.obj: test/Checkpoints_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-Checkpoints_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-Checkpoints_tests.Tpo -c -o test/test_test_dennodes-Checkpoints_tests.obj `if test -f 'test/Checkpoints_tests.cpp'; then $(CYGPATH_W) 'test/Checkpoints_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/Checkpoints_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-Checkpoints_tests.Tpo test/$(DEPDIR)/test_test_dennodes-Checkpoints_tests.Po
#	$(AM_V_CXX)source='test/Checkpoints_tests.cpp' object='test/test_test_dennodes-Checkpoints_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-Checkpoints_tests.obj `if test -f 'test/Checkpoints_tests.cpp'; then $(CYGPATH_W) 'test/Checkpoints_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/Checkpoints_tests.cpp'; fi`

test/test_test_dennodes-coins_tests.o: test/coins_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-coins_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-coins_tests.Tpo -c -o test/test_test_dennodes-coins_tests.o `test -f 'test/coins_tests.cpp' || echo '$(srcdir)/'`test/coins_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-coins_tests.Tpo test/$(DEPDIR)/test_test_dennodes-coins_tests.Po
#	$(AM_V_CXX)source='test/coins_tests.cpp' object='test/test_test_dennodes-coins_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-coins_tests.o `test -f 'test/coins_tests.cpp' || echo '$(srcdir)/'`test/coins_tests.cpp

test/test_test_dennodes-coins_tests.obj: test/coins_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-coins_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-coins_tests.Tpo -c -o test/test_test_dennodes-coins_tests.obj `if test -f 'test/coins_tests.cpp'; then $(CYGPATH_W) 'test/coins_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/coins_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-coins_tests.Tpo test/$(DEPDIR)/test_test_dennodes-coins_tests.Po
#	$(AM_V_CXX)source='test/coins_tests.cpp' object='test/test_test_dennodes-coins_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-coins_tests.obj `if test -f 'test/coins_tests.cpp'; then $(CYGPATH_W) 'test/coins_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/coins_tests.cpp'; fi`

test/test_test_dennodes-compress_tests.o: test/compress_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-compress_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-compress_tests.Tpo -c -o test/test_test_dennodes-compress_tests.o `test -f 'test/compress_tests.cpp' || echo '$(srcdir)/'`test/compress_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-compress_tests.Tpo test/$(DEPDIR)/test_test_dennodes-compress_tests.Po
#	$(AM_V_CXX)source='test/compress_tests.cpp' object='test/test_test_dennodes-compress_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-compress_tests.o `test -f 'test/compress_tests.cpp' || echo '$(srcdir)/'`test/compress_tests.cpp

test/test_test_dennodes-compress_tests.obj: test/compress_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-compress_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-compress_tests.Tpo -c -o test/test_test_dennodes-compress_tests.obj `if test -f 'test/compress_tests.cpp'; then $(CYGPATH_W) 'test/compress_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/compress_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-compress_tests.Tpo test/$(DEPDIR)/test_test_dennodes-compress_tests.Po
#	$(AM_V_CXX)source='test/compress_tests.cpp' object='test/test_test_dennodes-compress_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-compress_tests.obj `if test -f 'test/compress_tests.cpp'; then $(CYGPATH_W) 'test/compress_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/compress_tests.cpp'; fi`

test/test_test_dennodes-crypto_tests.o: test/crypto_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-crypto_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-crypto_tests.Tpo -c -o test/test_test_dennodes-crypto_tests.o `test -f 'test/crypto_tests.cpp' || echo '$(srcdir)/'`test/crypto_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-crypto_tests.Tpo test/$(DEPDIR)/test_test_dennodes-crypto_tests.Po
#	$(AM_V_CXX)source='test/crypto_tests.cpp' object='test/test_test_dennodes-crypto_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-crypto_tests.o `test -f 'test/crypto_tests.cpp' || echo '$(srcdir)/'`test/crypto_tests.cpp

test/test_test_dennodes-crypto_tests.obj: test/crypto_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-crypto_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-crypto_tests.Tpo -c -o test/test_test_dennodes-crypto_tests.obj `if test -f 'test/crypto_tests.cpp'; then $(CYGPATH_W) 'test/crypto_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/crypto_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-crypto_tests.Tpo test/$(DEPDIR)/test_test_dennodes-crypto_tests.Po
#	$(AM_V_CXX)source='test/crypto_tests.cpp' object='test/test_test_dennodes-crypto_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-crypto_tests.obj `if test -f 'test/crypto_tests.cpp'; then $(CYGPATH_W) 'test/crypto_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/crypto_tests.cpp'; fi`

test/test_test_dennodes-DoS_tests.o: test/DoS_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-DoS_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-DoS_tests.Tpo -c -o test/test_test_dennodes-DoS_tests.o `test -f 'test/DoS_tests.cpp' || echo '$(srcdir)/'`test/DoS_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-DoS_tests.Tpo test/$(DEPDIR)/test_test_dennodes-DoS_tests.Po
#	$(AM_V_CXX)source='test/DoS_tests.cpp' object='test/test_test_dennodes-DoS_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-DoS_tests.o `test -f 'test/DoS_tests.cpp' || echo '$(srcdir)/'`test/DoS_tests.cpp

test/test_test_dennodes-DoS_tests.obj: test/DoS_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-DoS_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-DoS_tests.Tpo -c -o test/test_test_dennodes-DoS_tests.obj `if test -f 'test/DoS_tests.cpp'; then $(CYGPATH_W) 'test/DoS_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/DoS_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-DoS_tests.Tpo test/$(DEPDIR)/test_test_dennodes-DoS_tests.Po
#	$(AM_V_CXX)source='test/DoS_tests.cpp' object='test/test_test_dennodes-DoS_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-DoS_tests.obj `if test -f 'test/DoS_tests.cpp'; then $(CYGPATH_W) 'test/DoS_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/DoS_tests.cpp'; fi`

test/test_test_dennodes-getarg_tests.o: test/getarg_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-getarg_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-getarg_tests.Tpo -c -o test/test_test_dennodes-getarg_tests.o `test -f 'test/getarg_tests.cpp' || echo '$(srcdir)/'`test/getarg_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-getarg_tests.Tpo test/$(DEPDIR)/test_test_dennodes-getarg_tests.Po
#	$(AM_V_CXX)source='test/getarg_tests.cpp' object='test/test_test_dennodes-getarg_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-getarg_tests.o `test -f 'test/getarg_tests.cpp' || echo '$(srcdir)/'`test/getarg_tests.cpp

test/test_test_dennodes-getarg_tests.obj: test/getarg_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-getarg_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-getarg_tests.Tpo -c -o test/test_test_dennodes-getarg_tests.obj `if test -f 'test/getarg_tests.cpp'; then $(CYGPATH_W) 'test/getarg_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/getarg_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-getarg_tests.Tpo test/$(DEPDIR)/test_test_dennodes-getarg_tests.Po
#	$(AM_V_CXX)source='test/getarg_tests.cpp' object='test/test_test_dennodes-getarg_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-getarg_tests.obj `if test -f 'test/getarg_tests.cpp'; then $(CYGPATH_W) 'test/getarg_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/getarg_tests.cpp'; fi`

test/test_test_dennodes-hash_tests.o: test/hash_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-hash_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-hash_tests.Tpo -c -o test/test_test_dennodes-hash_tests.o `test -f 'test/hash_tests.cpp' || echo '$(srcdir)/'`test/hash_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-hash_tests.Tpo test/$(DEPDIR)/test_test_dennodes-hash_tests.Po
#	$(AM_V_CXX)source='test/hash_tests.cpp' object='test/test_test_dennodes-hash_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-hash_tests.o `test -f 'test/hash_tests.cpp' || echo '$(srcdir)/'`test/hash_tests.cpp

test/test_test_dennodes-hash_tests.obj: test/hash_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-hash_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-hash_tests.Tpo -c -o test/test_test_dennodes-hash_tests.obj `if test -f 'test/hash_tests.cpp'; then $(CYGPATH_W) 'test/hash_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/hash_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-hash_tests.Tpo test/$(DEPDIR)/test_test_dennodes-hash_tests.Po
#	$(AM_V_CXX)source='test/hash_tests.cpp' object='test/test_test_dennodes-hash_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-hash_tests.obj `if test -f 'test/hash_tests.cpp'; then $(CYGPATH_W) 'test/hash_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/hash_tests.cpp'; fi`

test/test_test_dennodes-key_tests.o: test/key_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-key_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-key_tests.Tpo -c -o test/test_test_dennodes-key_tests.o `test -f 'test/key_tests.cpp' || echo '$(srcdir)/'`test/key_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-key_tests.Tpo test/$(DEPDIR)/test_test_dennodes-key_tests.Po
#	$(AM_V_CXX)source='test/key_tests.cpp' object='test/test_test_dennodes-key_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-key_tests.o `test -f 'test/key_tests.cpp' || echo '$(srcdir)/'`test/key_tests.cpp

test/test_test_dennodes-key_tests.obj: test/key_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-key_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-key_tests.Tpo -c -o test/test_test_dennodes-key_tests.obj `if test -f 'test/key_tests.cpp'; then $(CYGPATH_W) 'test/key_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/key_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-key_tests.Tpo test/$(DEPDIR)/test_test_dennodes-key_tests.Po
#	$(AM_V_CXX)source='test/key_tests.cpp' object='test/test_test_dennodes-key_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-key_tests.obj `if test -f 'test/key_tests.cpp'; then $(CYGPATH_W) 'test/key_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/key_tests.cpp'; fi`

test/test_test_dennodes-main_tests.o: test/main_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-main_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-main_tests.Tpo -c -o test/test_test_dennodes-main_tests.o `test -f 'test/main_tests.cpp' || echo '$(srcdir)/'`test/main_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-main_tests.Tpo test/$(DEPDIR)/test_test_dennodes-main_tests.Po
#	$(AM_V_CXX)source='test/main_tests.cpp' object='test/test_test_dennodes-main_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-main_tests.o `test -f 'test/main_tests.cpp' || echo '$(srcdir)/'`test/main_tests.cpp

test/test_test_dennodes-main_tests.obj: test/main_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-main_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-main_tests.Tpo -c -o test/test_test_dennodes-main_tests.obj `if test -f 'test/main_tests.cpp'; then $(CYGPATH_W) 'test/main_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/main_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-main_tests.Tpo test/$(DEPDIR)/test_test_dennodes-main_tests.Po
#	$(AM_V_CXX)source='test/main_tests.cpp' object='test/test_test_dennodes-main_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-main_tests.obj `if test -f 'test/main_tests.cpp'; then $(CYGPATH_W) 'test/main_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/main_tests.cpp'; fi`

test/test_test_dennodes-mempool_tests.o: test/mempool_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-mempool_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-mempool_tests.Tpo -c -o test/test_test_dennodes-mempool_tests.o `test -f 'test/mempool_tests.cpp' || echo '$(srcdir)/'`test/mempool_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-mempool_tests.Tpo test/$(DEPDIR)/test_test_dennodes-mempool_tests.Po
#	$(AM_V_CXX)source='test/mempool_tests.cpp' object='test/test_test_dennodes-mempool_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-mempool_tests.o `test -f 'test/mempool_tests.cpp' || echo '$(srcdir)/'`test/mempool_tests.cpp

test/test_test_dennodes-mempool_tests.obj: test/mempool_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-mempool_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-mempool_tests.Tpo -c -o test/test_test_dennodes-mempool_tests.obj `if test -f 'test/mempool_tests.cpp'; then $(CYGPATH_W) 'test/mempool_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/mempool_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-mempool_tests.Tpo test/$(DEPDIR)/test_test_dennodes-mempool_tests.Po
#	$(AM_V_CXX)source='test/mempool_tests.cpp' object='test/test_test_dennodes-mempool_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-mempool_tests.obj `if test -f 'test/mempool_tests.cpp'; then $(CYGPATH_W) 'test/mempool_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/mempool_tests.cpp'; fi`

test/test_test_dennodes-mruset_tests.o: test/mruset_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-mruset_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-mruset_tests.Tpo -c -o test/test_test_dennodes-mruset_tests.o `test -f 'test/mruset_tests.cpp' || echo '$(srcdir)/'`test/mruset_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-mruset_tests.Tpo test/$(DEPDIR)/test_test_dennodes-mruset_tests.Po
#	$(AM_V_CXX)source='test/mruset_tests.cpp' object='test/test_test_dennodes-mruset_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-mruset_tests.o `test -f 'test/mruset_tests.cpp' || echo '$(srcdir)/'`test/mruset_tests.cpp

test/test_test_dennodes-mruset_tests.obj: test/mruset_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-mruset_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-mruset_tests.Tpo -c -o test/test_test_dennodes-mruset_tests.obj `if test -f 'test/mruset_tests.cpp'; then $(CYGPATH_W) 'test/mruset_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/mruset_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-mruset_tests.Tpo test/$(DEPDIR)/test_test_dennodes-mruset_tests.Po
#	$(AM_V_CXX)source='test/mruset_tests.cpp' object='test/test_test_dennodes-mruset_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-mruset_tests.obj `if test -f 'test/mruset_tests.cpp'; then $(CYGPATH_W) 'test/mruset_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/mruset_tests.cpp'; fi`

test/test_test_dennodes-multisig_tests.o: test/multisig_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-multisig_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-multisig_tests.Tpo -c -o test/test_test_dennodes-multisig_tests.o `test -f 'test/multisig_tests.cpp' || echo '$(srcdir)/'`test/multisig_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-multisig_tests.Tpo test/$(DEPDIR)/test_test_dennodes-multisig_tests.Po
#	$(AM_V_CXX)source='test/multisig_tests.cpp' object='test/test_test_dennodes-multisig_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-multisig_tests.o `test -f 'test/multisig_tests.cpp' || echo '$(srcdir)/'`test/multisig_tests.cpp

test/test_test_dennodes-multisig_tests.obj: test/multisig_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-multisig_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-multisig_tests.Tpo -c -o test/test_test_dennodes-multisig_tests.obj `if test -f 'test/multisig_tests.cpp'; then $(CYGPATH_W) 'test/multisig_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/multisig_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-multisig_tests.Tpo test/$(DEPDIR)/test_test_dennodes-multisig_tests.Po
#	$(AM_V_CXX)source='test/multisig_tests.cpp' object='test/test_test_dennodes-multisig_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-multisig_tests.obj `if test -f 'test/multisig_tests.cpp'; then $(CYGPATH_W) 'test/multisig_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/multisig_tests.cpp'; fi`

test/test_test_dennodes-netbase_tests.o: test/netbase_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-netbase_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-netbase_tests.Tpo -c -o test/test_test_dennodes-netbase_tests.o `test -f 'test/netbase_tests.cpp' || echo '$(srcdir)/'`test/netbase_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-netbase_tests.Tpo test/$(DEPDIR)/test_test_dennodes-netbase_tests.Po
#	$(AM_V_CXX)source='test/netbase_tests.cpp' object='test/test_test_dennodes-netbase_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-netbase_tests.o `test -f 'test/netbase_tests.cpp' || echo '$(srcdir)/'`test/netbase_tests.cpp

test/test_test_dennodes-netbase_tests.obj: test/netbase_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-netbase_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-netbase_tests.Tpo -c -o test/test_test_dennodes-netbase_tests.obj `if test -f 'test/netbase_tests.cpp'; then $(CYGPATH_W) 'test/netbase_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/netbase_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-netbase_tests.Tpo test/$(DEPDIR)/test_test_dennodes-netbase_tests.Po
#	$(AM_V_CXX)source='test/netbase_tests.cpp' object='test/test_test_dennodes-netbase_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-netbase_tests.obj `if test -f 'test/netbase_tests.cpp'; then $(CYGPATH_W) 'test/netbase_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/netbase_tests.cpp'; fi`

test/test_test_dennodes-pmt_tests.o: test/pmt_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-pmt_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-pmt_tests.Tpo -c -o test/test_test_dennodes-pmt_tests.o `test -f 'test/pmt_tests.cpp' || echo '$(srcdir)/'`test/pmt_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-pmt_tests.Tpo test/$(DEPDIR)/test_test_dennodes-pmt_tests.Po
#	$(AM_V_CXX)source='test/pmt_tests.cpp' object='test/test_test_dennodes-pmt_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-pmt_tests.o `test -f 'test/pmt_tests.cpp' || echo '$(srcdir)/'`test/pmt_tests.cpp

test/test_test_dennodes-pmt_tests.obj: test/pmt_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-pmt_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-pmt_tests.Tpo -c -o test/test_test_dennodes-pmt_tests.obj `if test -f 'test/pmt_tests.cpp'; then $(CYGPATH_W) 'test/pmt_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/pmt_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-pmt_tests.Tpo test/$(DEPDIR)/test_test_dennodes-pmt_tests.Po
#	$(AM_V_CXX)source='test/pmt_tests.cpp' object='test/test_test_dennodes-pmt_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-pmt_tests.obj `if test -f 'test/pmt_tests.cpp'; then $(CYGPATH_W) 'test/pmt_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/pmt_tests.cpp'; fi`

test/test_test_dennodes-reverselock_tests.o: test/reverselock_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-reverselock_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-reverselock_tests.Tpo -c -o test/test_test_dennodes-reverselock_tests.o `test -f 'test/reverselock_tests.cpp' || echo '$(srcdir)/'`test/reverselock_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-reverselock_tests.Tpo test/$(DEPDIR)/test_test_dennodes-reverselock_tests.Po
#	$(AM_V_CXX)source='test/reverselock_tests.cpp' object='test/test_test_dennodes-reverselock_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-reverselock_tests.o `test -f 'test/reverselock_tests.cpp' || echo '$(srcdir)/'`test/reverselock_tests.cpp

test/test_test_dennodes-reverselock_tests.obj: test/reverselock_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-reverselock_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-reverselock_tests.Tpo -c -o test/test_test_dennodes-reverselock_tests.obj `if test -f 'test/reverselock_tests.cpp'; then $(CYGPATH_W) 'test/reverselock_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/reverselock_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-reverselock_tests.Tpo test/$(DEPDIR)/test_test_dennodes-reverselock_tests.Po
#	$(AM_V_CXX)source='test/reverselock_tests.cpp' object='test/test_test_dennodes-reverselock_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-reverselock_tests.obj `if test -f 'test/reverselock_tests.cpp'; then $(CYGPATH_W) 'test/reverselock_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/reverselock_tests.cpp'; fi`

test/test_test_dennodes-rpc_tests.o: test/rpc_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-rpc_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-rpc_tests.Tpo -c -o test/test_test_dennodes-rpc_tests.o `test -f 'test/rpc_tests.cpp' || echo '$(srcdir)/'`test/rpc_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-rpc_tests.Tpo test/$(DEPDIR)/test_test_dennodes-rpc_tests.Po
#	$(AM_V_CXX)source='test/rpc_tests.cpp' object='test/test_test_dennodes-rpc_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-rpc_tests.o `test -f 'test/rpc_tests.cpp' || echo '$(srcdir)/'`test/rpc_tests.cpp

test/test_test_dennodes-rpc_tests.obj: test/rpc_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-rpc_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-rpc_tests.Tpo -c -o test/test_test_dennodes-rpc_tests.obj `if test -f 'test/rpc_tests.cpp'; then $(CYGPATH_W) 'test/rpc_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/rpc_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-rpc_tests.Tpo test/$(DEPDIR)/test_test_dennodes-rpc_tests.Po
#	$(AM_V_CXX)source='test/rpc_tests.cpp' object='test/test_test_dennodes-rpc_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-rpc_tests.obj `if test -f 'test/rpc_tests.cpp'; then $(CYGPATH_W) 'test/rpc_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/rpc_tests.cpp'; fi`

test/test_test_dennodes-sanity_tests.o: test/sanity_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-sanity_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-sanity_tests.Tpo -c -o test/test_test_dennodes-sanity_tests.o `test -f 'test/sanity_tests.cpp' || echo '$(srcdir)/'`test/sanity_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-sanity_tests.Tpo test/$(DEPDIR)/test_test_dennodes-sanity_tests.Po
#	$(AM_V_CXX)source='test/sanity_tests.cpp' object='test/test_test_dennodes-sanity_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-sanity_tests.o `test -f 'test/sanity_tests.cpp' || echo '$(srcdir)/'`test/sanity_tests.cpp

test/test_test_dennodes-sanity_tests.obj: test/sanity_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-sanity_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-sanity_tests.Tpo -c -o test/test_test_dennodes-sanity_tests.obj `if test -f 'test/sanity_tests.cpp'; then $(CYGPATH_W) 'test/sanity_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/sanity_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-sanity_tests.Tpo test/$(DEPDIR)/test_test_dennodes-sanity_tests.Po
#	$(AM_V_CXX)source='test/sanity_tests.cpp' object='test/test_test_dennodes-sanity_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-sanity_tests.obj `if test -f 'test/sanity_tests.cpp'; then $(CYGPATH_W) 'test/sanity_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/sanity_tests.cpp'; fi`

test/test_test_dennodes-scheduler_tests.o: test/scheduler_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-scheduler_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-scheduler_tests.Tpo -c -o test/test_test_dennodes-scheduler_tests.o `test -f 'test/scheduler_tests.cpp' || echo '$(srcdir)/'`test/scheduler_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-scheduler_tests.Tpo test/$(DEPDIR)/test_test_dennodes-scheduler_tests.Po
#	$(AM_V_CXX)source='test/scheduler_tests.cpp' object='test/test_test_dennodes-scheduler_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-scheduler_tests.o `test -f 'test/scheduler_tests.cpp' || echo '$(srcdir)/'`test/scheduler_tests.cpp

test/test_test_dennodes-scheduler_tests.obj: test/scheduler_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-scheduler_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-scheduler_tests.Tpo -c -o test/test_test_dennodes-scheduler_tests.obj `if test -f 'test/scheduler_tests.cpp'; then $(CYGPATH_W) 'test/scheduler_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/scheduler_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-scheduler_tests.Tpo test/$(DEPDIR)/test_test_dennodes-scheduler_tests.Po
#	$(AM_V_CXX)source='test/scheduler_tests.cpp' object='test/test_test_dennodes-scheduler_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-scheduler_tests.obj `if test -f 'test/scheduler_tests.cpp'; then $(CYGPATH_W) 'test/scheduler_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/scheduler_tests.cpp'; fi`

test/test_test_dennodes-script_P2SH_tests.o: test/script_P2SH_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-script_P2SH_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-script_P2SH_tests.Tpo -c -o test/test_test_dennodes-script_P2SH_tests.o `test -f 'test/script_P2SH_tests.cpp' || echo '$(srcdir)/'`test/script_P2SH_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-script_P2SH_tests.Tpo test/$(DEPDIR)/test_test_dennodes-script_P2SH_tests.Po
#	$(AM_V_CXX)source='test/script_P2SH_tests.cpp' object='test/test_test_dennodes-script_P2SH_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-script_P2SH_tests.o `test -f 'test/script_P2SH_tests.cpp' || echo '$(srcdir)/'`test/script_P2SH_tests.cpp

test/test_test_dennodes-script_P2SH_tests.obj: test/script_P2SH_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-script_P2SH_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-script_P2SH_tests.Tpo -c -o test/test_test_dennodes-script_P2SH_tests.obj `if test -f 'test/script_P2SH_tests.cpp'; then $(CYGPATH_W) 'test/script_P2SH_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/script_P2SH_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-script_P2SH_tests.Tpo test/$(DEPDIR)/test_test_dennodes-script_P2SH_tests.Po
#	$(AM_V_CXX)source='test/script_P2SH_tests.cpp' object='test/test_test_dennodes-script_P2SH_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-script_P2SH_tests.obj `if test -f 'test/script_P2SH_tests.cpp'; then $(CYGPATH_W) 'test/script_P2SH_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/script_P2SH_tests.cpp'; fi`

test/test_test_dennodes-script_tests.o: test/script_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-script_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-script_tests.Tpo -c -o test/test_test_dennodes-script_tests.o `test -f 'test/script_tests.cpp' || echo '$(srcdir)/'`test/script_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-script_tests.Tpo test/$(DEPDIR)/test_test_dennodes-script_tests.Po
#	$(AM_V_CXX)source='test/script_tests.cpp' object='test/test_test_dennodes-script_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-script_tests.o `test -f 'test/script_tests.cpp' || echo '$(srcdir)/'`test/script_tests.cpp

test/test_test_dennodes-script_tests.obj: test/script_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-script_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-script_tests.Tpo -c -o test/test_test_dennodes-script_tests.obj `if test -f 'test/script_tests.cpp'; then $(CYGPATH_W) 'test/script_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/script_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-script_tests.Tpo test/$(DEPDIR)/test_test_dennodes-script_tests.Po
#	$(AM_V_CXX)source='test/script_tests.cpp' object='test/test_test_dennodes-script_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-script_tests.obj `if test -f 'test/script_tests.cpp'; then $(CYGPATH_W) 'test/script_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/script_tests.cpp'; fi`

test/test_test_dennodes-scriptnum_tests.o: test/scriptnum_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-scriptnum_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-scriptnum_tests.Tpo -c -o test/test_test_dennodes-scriptnum_tests.o `test -f 'test/scriptnum_tests.cpp' || echo '$(srcdir)/'`test/scriptnum_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-scriptnum_tests.Tpo test/$(DEPDIR)/test_test_dennodes-scriptnum_tests.Po
#	$(AM_V_CXX)source='test/scriptnum_tests.cpp' object='test/test_test_dennodes-scriptnum_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-scriptnum_tests.o `test -f 'test/scriptnum_tests.cpp' || echo '$(srcdir)/'`test/scriptnum_tests.cpp

test/test_test_dennodes-scriptnum_tests.obj: test/scriptnum_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-scriptnum_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-scriptnum_tests.Tpo -c -o test/test_test_dennodes-scriptnum_tests.obj `if test -f 'test/scriptnum_tests.cpp'; then $(CYGPATH_W) 'test/scriptnum_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/scriptnum_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-scriptnum_tests.Tpo test/$(DEPDIR)/test_test_dennodes-scriptnum_tests.Po
#	$(AM_V_CXX)source='test/scriptnum_tests.cpp' object='test/test_test_dennodes-scriptnum_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-scriptnum_tests.obj `if test -f 'test/scriptnum_tests.cpp'; then $(CYGPATH_W) 'test/scriptnum_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/scriptnum_tests.cpp'; fi`

test/test_test_dennodes-serialize_tests.o: test/serialize_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-serialize_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-serialize_tests.Tpo -c -o test/test_test_dennodes-serialize_tests.o `test -f 'test/serialize_tests.cpp' || echo '$(srcdir)/'`test/serialize_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-serialize_tests.Tpo test/$(DEPDIR)/test_test_dennodes-serialize_tests.Po
#	$(AM_V_CXX)source='test/serialize_tests.cpp' object='test/test_test_dennodes-serialize_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-serialize_tests.o `test -f 'test/serialize_tests.cpp' || echo '$(srcdir)/'`test/serialize_tests.cpp

test/test_test_dennodes-serialize_tests.obj: test/serialize_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-serialize_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-serialize_tests.Tpo -c -o test/test_test_dennodes-serialize_tests.obj `if test -f 'test/serialize_tests.cpp'; then $(CYGPATH_W) 'test/serialize_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/serialize_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-serialize_tests.Tpo test/$(DEPDIR)/test_test_dennodes-serialize_tests.Po
#	$(AM_V_CXX)source='test/serialize_tests.cpp' object='test/test_test_dennodes-serialize_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-serialize_tests.obj `if test -f 'test/serialize_tests.cpp'; then $(CYGPATH_W) 'test/serialize_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/serialize_tests.cpp'; fi`

test/test_test_dennodes-sighash_tests.o: test/sighash_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-sighash_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-sighash_tests.Tpo -c -o test/test_test_dennodes-sighash_tests.o `test -f 'test/sighash_tests.cpp' || echo '$(srcdir)/'`test/sighash_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-sighash_tests.Tpo test/$(DEPDIR)/test_test_dennodes-sighash_tests.Po
#	$(AM_V_CXX)source='test/sighash_tests.cpp' object='test/test_test_dennodes-sighash_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-sighash_tests.o `test -f 'test/sighash_tests.cpp' || echo '$(srcdir)/'`test/sighash_tests.cpp

test/test_test_dennodes-sighash_tests.obj: test/sighash_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-sighash_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-sighash_tests.Tpo -c -o test/test_test_dennodes-sighash_tests.obj `if test -f 'test/sighash_tests.cpp'; then $(CYGPATH_W) 'test/sighash_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/sighash_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-sighash_tests.Tpo test/$(DEPDIR)/test_test_dennodes-sighash_tests.Po
#	$(AM_V_CXX)source='test/sighash_tests.cpp' object='test/test_test_dennodes-sighash_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-sighash_tests.obj `if test -f 'test/sighash_tests.cpp'; then $(CYGPATH_W) 'test/sighash_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/sighash_tests.cpp'; fi`

test/test_test_dennodes-sigopcount_tests.o: test/sigopcount_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-sigopcount_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-sigopcount_tests.Tpo -c -o test/test_test_dennodes-sigopcount_tests.o `test -f 'test/sigopcount_tests.cpp' || echo '$(srcdir)/'`test/sigopcount_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-sigopcount_tests.Tpo test/$(DEPDIR)/test_test_dennodes-sigopcount_tests.Po
#	$(AM_V_CXX)source='test/sigopcount_tests.cpp' object='test/test_test_dennodes-sigopcount_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-sigopcount_tests.o `test -f 'test/sigopcount_tests.cpp' || echo '$(srcdir)/'`test/sigopcount_tests.cpp

test/test_test_dennodes-sigopcount_tests.obj: test/sigopcount_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-sigopcount_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-sigopcount_tests.Tpo -c -o test/test_test_dennodes-sigopcount_tests.obj `if test -f 'test/sigopcount_tests.cpp'; then $(CYGPATH_W) 'test/sigopcount_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/sigopcount_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-sigopcount_tests.Tpo test/$(DEPDIR)/test_test_dennodes-sigopcount_tests.Po
#	$(AM_V_CXX)source='test/sigopcount_tests.cpp' object='test/test_test_dennodes-sigopcount_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-sigopcount_tests.obj `if test -f 'test/sigopcount_tests.cpp'; then $(CYGPATH_W) 'test/sigopcount_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/sigopcount_tests.cpp'; fi`

test/test_test_dennodes-skiplist_tests.o: test/skiplist_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-skiplist_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-skiplist_tests.Tpo -c -o test/test_test_dennodes-skiplist_tests.o `test -f 'test/skiplist_tests.cpp' || echo '$(srcdir)/'`test/skiplist_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-skiplist_tests.Tpo test/$(DEPDIR)/test_test_dennodes-skiplist_tests.Po
#	$(AM_V_CXX)source='test/skiplist_tests.cpp' object='test/test_test_dennodes-skiplist_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-skiplist_tests.o `test -f 'test/skiplist_tests.cpp' || echo '$(srcdir)/'`test/skiplist_tests.cpp

test/test_test_dennodes-skiplist_tests.obj: test/skiplist_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-skiplist_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-skiplist_tests.Tpo -c -o test/test_test_dennodes-skiplist_tests.obj `if test -f 'test/skiplist_tests.cpp'; then $(CYGPATH_W) 'test/skiplist_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/skiplist_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-skiplist_tests.Tpo test/$(DEPDIR)/test_test_dennodes-skiplist_tests.Po
#	$(AM_V_CXX)source='test/skiplist_tests.cpp' object='test/test_test_dennodes-skiplist_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-skiplist_tests.obj `if test -f 'test/skiplist_tests.cpp'; then $(CYGPATH_W) 'test/skiplist_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/skiplist_tests.cpp'; fi`

test/test_test_dennodes-timedata_tests.o: test/timedata_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-timedata_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-timedata_tests.Tpo -c -o test/test_test_dennodes-timedata_tests.o `test -f 'test/timedata_tests.cpp' || echo '$(srcdir)/'`test/timedata_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-timedata_tests.Tpo test/$(DEPDIR)/test_test_dennodes-timedata_tests.Po
#	$(AM_V_CXX)source='test/timedata_tests.cpp' object='test/test_test_dennodes-timedata_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-timedata_tests.o `test -f 'test/timedata_tests.cpp' || echo '$(srcdir)/'`test/timedata_tests.cpp

test/test_test_dennodes-timedata_tests.obj: test/timedata_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-timedata_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-timedata_tests.Tpo -c -o test/test_test_dennodes-timedata_tests.obj `if test -f 'test/timedata_tests.cpp'; then $(CYGPATH_W) 'test/timedata_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/timedata_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-timedata_tests.Tpo test/$(DEPDIR)/test_test_dennodes-timedata_tests.Po
#	$(AM_V_CXX)source='test/timedata_tests.cpp' object='test/test_test_dennodes-timedata_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-timedata_tests.obj `if test -f 'test/timedata_tests.cpp'; then $(CYGPATH_W) 'test/timedata_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/timedata_tests.cpp'; fi`

test/test_test_dennodes-torcontrol_tests.o: test/torcontrol_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-torcontrol_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-torcontrol_tests.Tpo -c -o test/test_test_dennodes-torcontrol_tests.o `test -f 'test/torcontrol_tests.cpp' || echo '$(srcdir)/'`test/torcontrol_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-torcontrol_tests.Tpo test/$(DEPDIR)/test_test_dennodes-torcontrol_tests.Po
#	$(AM_V_CXX)source='test/torcontrol_tests.cpp' object='test/test_test_dennodes-torcontrol_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-torcontrol_tests.o `test -f 'test/torcontrol_tests.cpp' || echo '$(srcdir)/'`test/torcontrol_tests.cpp

test/test_test_dennodes-torcontrol_tests.obj: test/torcontrol_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-torcontrol_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-torcontrol_tests.Tpo -c -o test/test_test_dennodes-torcontrol_tests.obj `if test -f 'test/torcontrol_tests.cpp'; then $(CYGPATH_W) 'test/torcontrol_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/torcontrol_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-torcontrol_tests.Tpo test/$(DEPDIR)/test_test_dennodes-torcontrol_tests.Po
#	$(AM_V_CXX)source='test/torcontrol_tests.cpp' object='test/test_test_dennodes-torcontrol_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-torcontrol_tests.obj `if test -f 'test/torcontrol_tests.cpp'; then $(CYGPATH_W) 'test/torcontrol_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/torcontrol_tests.cpp'; fi`

test/test_test_dennodes-transaction_tests.o: test/transaction_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-transaction_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-transaction_tests.Tpo -c -o test/test_test_dennodes-transaction_tests.o `test -f 'test/transaction_tests.cpp' || echo '$(srcdir)/'`test/transaction_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-transaction_tests.Tpo test/$(DEPDIR)/test_test_dennodes-transaction_tests.Po
#	$(AM_V_CXX)source='test/transaction_tests.cpp' object='test/test_test_dennodes-transaction_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-transaction_tests.o `test -f 'test/transaction_tests.cpp' || echo '$(srcdir)/'`test/transaction_tests.cpp

test/test_test_dennodes-transaction_tests.obj: test/transaction_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-transaction_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-transaction_tests.Tpo -c -o test/test_test_dennodes-transaction_tests.obj `if test -f 'test/transaction_tests.cpp'; then $(CYGPATH_W) 'test/transaction_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/transaction_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-transaction_tests.Tpo test/$(DEPDIR)/test_test_dennodes-transaction_tests.Po
#	$(AM_V_CXX)source='test/transaction_tests.cpp' object='test/test_test_dennodes-transaction_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-transaction_tests.obj `if test -f 'test/transaction_tests.cpp'; then $(CYGPATH_W) 'test/transaction_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/transaction_tests.cpp'; fi`

test/test_test_dennodes-uint256_tests.o: test/uint256_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-uint256_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-uint256_tests.Tpo -c -o test/test_test_dennodes-uint256_tests.o `test -f 'test/uint256_tests.cpp' || echo '$(srcdir)/'`test/uint256_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-uint256_tests.Tpo test/$(DEPDIR)/test_test_dennodes-uint256_tests.Po
#	$(AM_V_CXX)source='test/uint256_tests.cpp' object='test/test_test_dennodes-uint256_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-uint256_tests.o `test -f 'test/uint256_tests.cpp' || echo '$(srcdir)/'`test/uint256_tests.cpp

test/test_test_dennodes-uint256_tests.obj: test/uint256_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-uint256_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-uint256_tests.Tpo -c -o test/test_test_dennodes-uint256_tests.obj `if test -f 'test/uint256_tests.cpp'; then $(CYGPATH_W) 'test/uint256_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/uint256_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-uint256_tests.Tpo test/$(DEPDIR)/test_test_dennodes-uint256_tests.Po
#	$(AM_V_CXX)source='test/uint256_tests.cpp' object='test/test_test_dennodes-uint256_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-uint256_tests.obj `if test -f 'test/uint256_tests.cpp'; then $(CYGPATH_W) 'test/uint256_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/uint256_tests.cpp'; fi`

test/test_test_dennodes-univalue_tests.o: test/univalue_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-univalue_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-univalue_tests.Tpo -c -o test/test_test_dennodes-univalue_tests.o `test -f 'test/univalue_tests.cpp' || echo '$(srcdir)/'`test/univalue_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-univalue_tests.Tpo test/$(DEPDIR)/test_test_dennodes-univalue_tests.Po
#	$(AM_V_CXX)source='test/univalue_tests.cpp' object='test/test_test_dennodes-univalue_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-univalue_tests.o `test -f 'test/univalue_tests.cpp' || echo '$(srcdir)/'`test/univalue_tests.cpp

test/test_test_dennodes-univalue_tests.obj: test/univalue_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-univalue_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-univalue_tests.Tpo -c -o test/test_test_dennodes-univalue_tests.obj `if test -f 'test/univalue_tests.cpp'; then $(CYGPATH_W) 'test/univalue_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/univalue_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-univalue_tests.Tpo test/$(DEPDIR)/test_test_dennodes-univalue_tests.Po
#	$(AM_V_CXX)source='test/univalue_tests.cpp' object='test/test_test_dennodes-univalue_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-univalue_tests.obj `if test -f 'test/univalue_tests.cpp'; then $(CYGPATH_W) 'test/univalue_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/univalue_tests.cpp'; fi`

test/test_test_dennodes-util_tests.o: test/util_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-util_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-util_tests.Tpo -c -o test/test_test_dennodes-util_tests.o `test -f 'test/util_tests.cpp' || echo '$(srcdir)/'`test/util_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-util_tests.Tpo test/$(DEPDIR)/test_test_dennodes-util_tests.Po
#	$(AM_V_CXX)source='test/util_tests.cpp' object='test/test_test_dennodes-util_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-util_tests.o `test -f 'test/util_tests.cpp' || echo '$(srcdir)/'`test/util_tests.cpp

test/test_test_dennodes-util_tests.obj: test/util_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-util_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-util_tests.Tpo -c -o test/test_test_dennodes-util_tests.obj `if test -f 'test/util_tests.cpp'; then $(CYGPATH_W) 'test/util_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/util_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-util_tests.Tpo test/$(DEPDIR)/test_test_dennodes-util_tests.Po
#	$(AM_V_CXX)source='test/util_tests.cpp' object='test/test_test_dennodes-util_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-util_tests.obj `if test -f 'test/util_tests.cpp'; then $(CYGPATH_W) 'test/util_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/util_tests.cpp'; fi`

test/test_test_dennodes-accounting_tests.o: test/accounting_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-accounting_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-accounting_tests.Tpo -c -o test/test_test_dennodes-accounting_tests.o `test -f 'test/accounting_tests.cpp' || echo '$(srcdir)/'`test/accounting_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-accounting_tests.Tpo test/$(DEPDIR)/test_test_dennodes-accounting_tests.Po
#	$(AM_V_CXX)source='test/accounting_tests.cpp' object='test/test_test_dennodes-accounting_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-accounting_tests.o `test -f 'test/accounting_tests.cpp' || echo '$(srcdir)/'`test/accounting_tests.cpp

test/test_test_dennodes-accounting_tests.obj: test/accounting_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-accounting_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-accounting_tests.Tpo -c -o test/test_test_dennodes-accounting_tests.obj `if test -f 'test/accounting_tests.cpp'; then $(CYGPATH_W) 'test/accounting_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/accounting_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-accounting_tests.Tpo test/$(DEPDIR)/test_test_dennodes-accounting_tests.Po
#	$(AM_V_CXX)source='test/accounting_tests.cpp' object='test/test_test_dennodes-accounting_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-accounting_tests.obj `if test -f 'test/accounting_tests.cpp'; then $(CYGPATH_W) 'test/accounting_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/accounting_tests.cpp'; fi`

wallet/test/test_test_dennodes-wallet_tests.o: wallet/test/wallet_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT wallet/test/test_test_dennodes-wallet_tests.o -MD -MP -MF wallet/test/$(DEPDIR)/test_test_dennodes-wallet_tests.Tpo -c -o wallet/test/test_test_dennodes-wallet_tests.o `test -f 'wallet/test/wallet_tests.cpp' || echo '$(srcdir)/'`wallet/test/wallet_tests.cpp
	$(AM_V_at)$(am__mv) wallet/test/$(DEPDIR)/test_test_dennodes-wallet_tests.Tpo wallet/test/$(DEPDIR)/test_test_dennodes-wallet_tests.Po
#	$(AM_V_CXX)source='wallet/test/wallet_tests.cpp' object='wallet/test/test_test_dennodes-wallet_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o wallet/test/test_test_dennodes-wallet_tests.o `test -f 'wallet/test/wallet_tests.cpp' || echo '$(srcdir)/'`wallet/test/wallet_tests.cpp

wallet/test/test_test_dennodes-wallet_tests.obj: wallet/test/wallet_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT wallet/test/test_test_dennodes-wallet_tests.obj -MD -MP -MF wallet/test/$(DEPDIR)/test_test_dennodes-wallet_tests.Tpo -c -o wallet/test/test_test_dennodes-wallet_tests.obj `if test -f 'wallet/test/wallet_tests.cpp'; then $(CYGPATH_W) 'wallet/test/wallet_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/wallet/test/wallet_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) wallet/test/$(DEPDIR)/test_test_dennodes-wallet_tests.Tpo wallet/test/$(DEPDIR)/test_test_dennodes-wallet_tests.Po
#	$(AM_V_CXX)source='wallet/test/wallet_tests.cpp' object='wallet/test/test_test_dennodes-wallet_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o wallet/test/test_test_dennodes-wallet_tests.obj `if test -f 'wallet/test/wallet_tests.cpp'; then $(CYGPATH_W) 'wallet/test/wallet_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/wallet/test/wallet_tests.cpp'; fi`

test/test_test_dennodes-rpc_wallet_tests.o: test/rpc_wallet_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-rpc_wallet_tests.o -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-rpc_wallet_tests.Tpo -c -o test/test_test_dennodes-rpc_wallet_tests.o `test -f 'test/rpc_wallet_tests.cpp' || echo '$(srcdir)/'`test/rpc_wallet_tests.cpp
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-rpc_wallet_tests.Tpo test/$(DEPDIR)/test_test_dennodes-rpc_wallet_tests.Po
#	$(AM_V_CXX)source='test/rpc_wallet_tests.cpp' object='test/test_test_dennodes-rpc_wallet_tests.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-rpc_wallet_tests.o `test -f 'test/rpc_wallet_tests.cpp' || echo '$(srcdir)/'`test/rpc_wallet_tests.cpp

test/test_test_dennodes-rpc_wallet_tests.obj: test/rpc_wallet_tests.cpp
	$(AM_V_CXX)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -MT test/test_test_dennodes-rpc_wallet_tests.obj -MD -MP -MF test/$(DEPDIR)/test_test_dennodes-rpc_wallet_tests.Tpo -c -o test/test_test_dennodes-rpc_wallet_tests.obj `if test -f 'test/rpc_wallet_tests.cpp'; then $(CYGPATH_W) 'test/rpc_wallet_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/rpc_wallet_tests.cpp'; fi`
	$(AM_V_at)$(am__mv) test/$(DEPDIR)/test_test_dennodes-rpc_wallet_tests.Tpo test/$(DEPDIR)/test_test_dennodes-rpc_wallet_tests.Po
#	$(AM_V_CXX)source='test/rpc_wallet_tests.cpp' object='test/test_test_dennodes-rpc_wallet_tests.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CXXDEPMODE) $(depcomp) \
#	$(AM_V_CXX_no)$(CXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(test_test_dennodes_CPPFLAGS) $(CPPFLAGS) $(test_test_dennodes_CXXFLAGS) $(CXXFLAGS) -c -o test/test_test_dennodes-rpc_wallet_tests.obj `if test -f 'test/rpc_wallet_tests.cpp'; then $(CYGPATH_W) 'test/rpc_wallet_tests.cpp'; else $(CYGPATH_W) '$(srcdir)/test/rpc_wallet_tests.cpp'; fi`
...
qt/qt_dennodes_qt-macdockiconhandler.o: qt/macdockiconhandler.mm
	$(AM_V_OBJCXX)$(OBJCXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(AM_OBJCXXFLAGS) $(OBJCXXFLAGS) -MT qt/qt_dennodes_qt-macdockiconhandler.o -MD -MP -MF qt/$(DEPDIR)/qt_dennodes_qt-macdockiconhandler.Tpo -c -o qt/qt_dennodes_qt-macdockiconhandler.o `test -f 'qt/macdockiconhandler.mm' || echo '$(srcdir)/'`qt/macdockiconhandler.mm
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_dennodes_qt-macdockiconhandler.Tpo qt/$(DEPDIR)/qt_dennodes_qt-macdockiconhandler.Po
#	$(AM_V_OBJCXX)source='qt/macdockiconhandler.mm' object='qt/qt_dennodes_qt-macdockiconhandler.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(OBJCXXDEPMODE) $(depcomp) \
#	$(AM_V_OBJCXX_no)$(OBJCXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(AM_OBJCXXFLAGS) $(OBJCXXFLAGS) -c -o qt/qt_dennodes_qt-macdockiconhandler.o `test -f 'qt/macdockiconhandler.mm' || echo '$(srcdir)/'`qt/macdockiconhandler.mm

qt/qt_dennodes_qt-macdockiconhandler.obj: qt/macdockiconhandler.mm
	$(AM_V_OBJCXX)$(OBJCXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(AM_OBJCXXFLAGS) $(OBJCXXFLAGS) -MT qt/qt_dennodes_qt-macdockiconhandler.obj -MD -MP -MF qt/$(DEPDIR)/qt_dennodes_qt-macdockiconhandler.Tpo -c -o qt/qt_dennodes_qt-macdockiconhandler.obj `if test -f 'qt/macdockiconhandler.mm'; then $(CYGPATH_W) 'qt/macdockiconhandler.mm'; else $(CYGPATH_W) '$(srcdir)/qt/macdockiconhandler.mm'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_dennodes_qt-macdockiconhandler.Tpo qt/$(DEPDIR)/qt_dennodes_qt-macdockiconhandler.Po
#	$(AM_V_OBJCXX)source='qt/macdockiconhandler.mm' object='qt/qt_dennodes_qt-macdockiconhandler.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(OBJCXXDEPMODE) $(depcomp) \
#	$(AM_V_OBJCXX_no)$(OBJCXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(AM_OBJCXXFLAGS) $(OBJCXXFLAGS) -c -o qt/qt_dennodes_qt-macdockiconhandler.obj `if test -f 'qt/macdockiconhandler.mm'; then $(CYGPATH_W) 'qt/macdockiconhandler.mm'; else $(CYGPATH_W) '$(srcdir)/qt/macdockiconhandler.mm'; fi`

qt/qt_dennodes_qt-macnotificationhandler.o: qt/macnotificationhandler.mm
	$(AM_V_OBJCXX)$(OBJCXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(AM_OBJCXXFLAGS) $(OBJCXXFLAGS) -MT qt/qt_dennodes_qt-macnotificationhandler.o -MD -MP -MF qt/$(DEPDIR)/qt_dennodes_qt-macnotificationhandler.Tpo -c -o qt/qt_dennodes_qt-macnotificationhandler.o `test -f 'qt/macnotificationhandler.mm' || echo '$(srcdir)/'`qt/macnotificationhandler.mm
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_dennodes_qt-macnotificationhandler.Tpo qt/$(DEPDIR)/qt_dennodes_qt-macnotificationhandler.Po
#	$(AM_V_OBJCXX)source='qt/macnotificationhandler.mm' object='qt/qt_dennodes_qt-macnotificationhandler.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(OBJCXXDEPMODE) $(depcomp) \
#	$(AM_V_OBJCXX_no)$(OBJCXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(AM_OBJCXXFLAGS) $(OBJCXXFLAGS) -c -o qt/qt_dennodes_qt-macnotificationhandler.o `test -f 'qt/macnotificationhandler.mm' || echo '$(srcdir)/'`qt/macnotificationhandler.mm

qt/qt_dennodes_qt-macnotificationhandler.obj: qt/macnotificationhandler.mm
	$(AM_V_OBJCXX)$(OBJCXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(AM_OBJCXXFLAGS) $(OBJCXXFLAGS) -MT qt/qt_dennodes_qt-macnotificationhandler.obj -MD -MP -MF qt/$(DEPDIR)/qt_dennodes_qt-macnotificationhandler.Tpo -c -o qt/qt_dennodes_qt-macnotificationhandler.obj `if test -f 'qt/macnotificationhandler.mm'; then $(CYGPATH_W) 'qt/macnotificationhandler.mm'; else $(CYGPATH_W) '$(srcdir)/qt/macnotificationhandler.mm'; fi`
	$(AM_V_at)$(am__mv) qt/$(DEPDIR)/qt_dennodes_qt-macnotificationhandler.Tpo qt/$(DEPDIR)/qt_dennodes_qt-macnotificationhandler.Po
#	$(AM_V_OBJCXX)source='qt/macnotificationhandler.mm' object='qt/qt_dennodes_qt-macnotificationhandler.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(OBJCXXDEPMODE) $(depcomp) \
#	$(AM_V_OBJCXX_no)$(OBJCXX) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(qt_dennodes_qt_CPPFLAGS) $(CPPFLAGS) $(AM_OBJCXXFLAGS) $(OBJCXXFLAGS) -c -o qt/qt_dennodes_qt-macnotificationhandler.obj `if test -f 'qt/macnotificationhandler.mm'; then $(CYGPATH_W) 'qt/macnotificationhandler.mm'; else $(CYGPATH_W) '$(srcdir)/qt/macnotificationhandler.mm'; fi`
...
recheck: all 
	...
	$(MAKE) $(AM_MAKEFLAGS) $(TEST_SUITE_LOG) \
	        ...
	        TEST_LOGS="$$log_list"; \
	exit $$?
qt/test/test_dennodes-qt.log: qt/test/test_dennodes-qt$(EXEEXT)
	@p='qt/test/test_dennodes-qt$(EXEEXT)'; \
	b='qt/test/test_dennodes-qt'; \
...
distclean-generic:
	...
	-rm -f zden/$(DEPDIR)/$(am__dirstamp)
	-rm -f zden/$(am__dirstamp)
...
distclean: distclean-recursive
	-rm -rf ./$(DEPDIR) compat/$(DEPDIR) crypto/$(DEPDIR) leveldb/db/$(DEPDIR) leveldb/helpers/memenv/$(DEPDIR) leveldb/port/$(DEPDIR) leveldb/table/$(DEPDIR) leveldb/util/$(DEPDIR) libzerocoin/$(DEPDIR) primitives/$(DEPDIR) qt/$(DEPDIR) qt/test/$(DEPDIR) rpc/$(DEPDIR) script/$(DEPDIR) support/$(DEPDIR) test/$(DEPDIR) wallet/$(DEPDIR) wallet/test/$(DEPDIR) zden/$(DEPDIR) zmq/$(DEPDIR)
	-rm -f Makefile
...
config/dennodes-config.h: config/stamp-h1
	@$(MAKE) -C $(top_builddir) $(subdir)/$(@)
config/stamp-h1: $(top_srcdir)/$(subdir)/config/dennodes-config.h.in $(top_builddir)/config.status
	$(AM_V_at)$(MAKE) -C $(top_builddir) $(subdir)/$(@)
$(top_srcdir)/$(subdir)/config/dennodes-config.h.in:  $(am__configure_deps)
	$(AM_V_at)$(MAKE) -C $(top_srcdir) $(subdir)/config/dennodes-config.h.in
...
#dennodes_test: $(TEST_BINARY)

#dennodes_test_check: $(TEST_BINARY) FORCE
#	$(MAKE) check-TESTS TESTS=$^

#dennodes_test_clean : FORCE
#	rm -f $(CLEAN_BITCOIN_TEST) $(test_test_dennodes_OBJECTS) $(TEST_BINARY)
...
$(QT_MOC): $(QT_FORMS_H)
$(qt_libbitcoinqt_a_OBJECTS) $(qt_dennodes_qt_OBJECTS) : | $(QT_MOC)
...
$(srcdir)/qt/dennodesstrings.cpp: $(libbitcoin_server_a_SOURCES) $(libbitcoin_wallet_a_SOURCES) $(libbitcoin_common_a_SOURCES) $(libbitcoin_zmq_a_SOURCES) $(libbitcoin_util_a_SOURCES)
	@test -n $(XGETTEXT) || echo "xgettext is required for updating translations"
	$(AM_V_GEN) cd $(srcdir); XGETTEXT=$(XGETTEXT) PACKAGE_NAME="$(PACKAGE_NAME)" $(PYTHON) ../share/qt/extract_strings_qt.py $^

translate: $(srcdir)/qt/dennodesstrings.cpp $(QT_FORMS_UI) $(QT_FORMS_UI) $(BITCOIN_QT_BASE_CPP) qt/dennodes.cpp $(BITCOIN_QT_WINDOWS_CPP) $(BITCOIN_QT_WALLET_CPP) $(BITCOIN_QT_H) $(BITCOIN_MM)
	@test -n $(LUPDATE) || echo "lupdate is required for updating translations"
	$(AM_V_GEN) QT_SELECT=$(QT_SELECT) $(LUPDATE) $^ -locations relative -no-obsolete -ts $(srcdir)/qt/locale/dennodes_en.ts

$(QT_QRC_LOCALE_CPP): $(QT_QRC_LOCALE) $(QT_QM)
	@test -f $(RCC)
	@cp -f $< $(@D)/temp_$(<F)
	$(AM_V_GEN) QT_SELECT=$(QT_SELECT) $(RCC) -name dennodes_locale $(@D)/temp_$(<F) | \
	  $(SED) -e '/^\*\*.*Created:/d' -e '/^\*\*.*by:/d' > $@
	@rm $(@D)/temp_$(<F)

$(QT_QRC_CPP): $(QT_QRC) $(QT_FORMS_H) $(RES_ICONS) $(RES_IMAGES) $(RES_CSS) $(RES_MOVIES) $(PROTOBUF_H)
	@test -f $(RCC)
	$(AM_V_GEN) QT_SELECT=$(QT_SELECT) $(RCC) -name dennodes $< | \
	  $(SED) -e '/^\*\*.*Created:/d' -e '/^\*\*.*by:/d' > $@

dennodes_qt_clean: FORCE
	rm -f $(CLEAN_QT) $(qt_libbitcoinqt_a_OBJECTS) $(qt_dennodes_qt_OBJECTS) qt/dennodes-qt$(EXEEXT) $(LIBBITCOINQT)

dennodes_qt : qt/dennodes-qt$(EXEEXT)
...
#test_dennodes_qt : qt/test/test_dennodes-qt$(EXEEXT)

#test_dennodes_qt_check : qt/test/test_dennodes-qt$(EXEEXT) FORCE
#	$(MAKE) check-TESTS TESTS=$^

#test_dennodes_qt_clean: FORCE
#	rm -f $(CLEAN_BITCOIN_QT_TEST) $(qt_test_test_dennodes_qt_OBJECTS)
