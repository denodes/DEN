...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DENNODES server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "DENNODES server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DENNODES features */
        {"dennodes", "listmasternodes", &listmasternodes, true, true, false},
        {"dennodes", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dennodes", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dennodes", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"dennodes", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"dennodes", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"dennodes", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dennodes", "masternodedebug", &masternodedebug, true, true, false},
        {"dennodes", "startmasternode", &startmasternode, true, true, false},
        {"dennodes", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dennodes", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dennodes", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dennodes", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dennodes", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dennodes", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dennodes", "preparebudget", &preparebudget, true, true, false},
        {"dennodes", "submitbudget", &submitbudget, true, true, false},
        {"dennodes", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dennodes", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dennodes", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dennodes", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dennodes", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dennodes", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dennodes", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dennodes", "checkbudgets", &checkbudgets, true, true, false},
        {"dennodes", "mnsync", &mnsync, true, true, false},
        {"dennodes", "spork", &spork, true, true, false},
        {"dennodes", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzdenseed", &getzdenseed, false, false, true},
        {"zerocoin", "setzdenseed", &setzdenseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzden", &searchdzden, false, false, true},
        {"zerocoin", "dzdenstate", &dzdenstate, false, false, true},
...
{
    return "> dennodes-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10205/\n";
}
