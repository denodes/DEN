                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDENPathCustom = GetArg("-zdenbackuppath", "");
    ...
    if(!strzDENPathCustom.empty()) {
        ui->wallet_customzdenbackuppath->setText(QString::fromStdString(strzDENPathCustom));
        ui->wallet_customzdenbackuppath_label->setVisible(true);
        ui->wallet_customzdenbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDENPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DENNODES RPC console.") + "<br>" +
