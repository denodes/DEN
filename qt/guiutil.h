...
/** Utility functions used by the DENNODES Qt UI.
 */
namespace GUIUtil
{
...
// Render DENNODES addresses in monospace font
...
// Parse "dennodes:" URI into recipient object, return true on successful parsing
