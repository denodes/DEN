...
/* DENNODES GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DENNODES"
#define QAPP_ORG_DOMAIN "dennodes.org"
#define QAPP_APP_NAME_DEFAULT "DENNODES-Qt"
#define QAPP_APP_NAME_TESTNET "DENNODES-Qt-testnet"
