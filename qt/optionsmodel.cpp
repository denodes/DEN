...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::DEN);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeDENNODESAmount"))
        SoftSetArg("-anonymizedennodesamount", settings.value("nAnonymizeDENNODESAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in dennodes.cpp during shotdown to also remove the window positions
