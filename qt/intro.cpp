...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DENNODES Core"),
     ...
     * override -datadir in the dennodes.conf file in the default data directory
     * (to be consistent with dennodesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
