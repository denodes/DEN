...
#ifndef DENNODES_ZDENTRACKER_H
#define DENNODES_ZDENTRACKER_H
...
public:
    CzDENTracker(std::string strWalletFile);
    ~CzDENTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzDENWallet* zDENWallet = NULL);
