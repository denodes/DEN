...
#ifndef DENNODES_ZDENWALLET_H
#define DENNODES_ZDENWALLET_H
...
public:
    CzDENWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZDEN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZDEN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
